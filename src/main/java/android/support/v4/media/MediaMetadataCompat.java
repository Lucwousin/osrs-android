...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public final class Builder {
        ...
        public Builder putBitmap(String arg3, Bitmap arg4) {
            if(MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(arg3)) {
                if(MediaMetadataCompat.METADATA_KEYS_TYPE.get(arg3).intValue() == 2) {
                }
                else {
        ...
        public Builder putLong(String arg2, long arg3) {
            if(MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(arg2)) {
                if(MediaMetadataCompat.METADATA_KEYS_TYPE.get(arg2).intValue() == 0) {
                }
                else {
        ...
        public Builder putRating(String arg3, RatingCompat arg4) {
            if(MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(arg3)) {
                if(MediaMetadataCompat.METADATA_KEYS_TYPE.get(arg3).intValue() == 3) {
                }
                else {
                    StringBuilder v0 = new StringBuilder();
                    v0.append("The ");
        ...
        public Builder putString(String arg3, String arg4) {
            if(MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(arg3)) {
                if(MediaMetadataCompat.METADATA_KEYS_TYPE.get(arg3).intValue() == 1) {
                }
                else {
                    StringBuilder v0 = new StringBuilder();
                    v0.append("The ");
    ...
    MediaMetadataCompat(Parcel arg2) {
        super();
        this.mBundle = arg2.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public Bitmap getBitmap(String arg3) {
        Parcelable v3_1;
        try {
            v3_1 = this.mBundle.getParcelable(arg3);
        }
        catch(Exception v3) {
    ...
    public RatingCompat getRating(String arg3) {
        ...
        try {
            ...
            v3_2 = this.mBundle.getParcelable(arg3);
        }
        catch(Exception v3) {
