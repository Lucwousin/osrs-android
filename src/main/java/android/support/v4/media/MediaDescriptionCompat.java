...
public final class MediaDescriptionCompat implements Parcelable {
    ...
    MediaDescriptionCompat(Parcel arg3) {
        ...
        this.mIcon = arg3.readParcelable(v0);
        this.mIconUri = arg3.readParcelable(v0);
        this.mExtras = arg3.readBundle(v0);
        this.mMediaUri = arg3.readParcelable(v0);
    }
    ...
    public static MediaDescriptionCompat fromMediaDescription(Object arg6) {
        ...
        if(arg6 != null && Build$VERSION.SDK_INT >= 21) {
            ...
            if(v2 != null) {
                MediaSessionCompat.ensureClassLoader(v2);
