...
public final class MediaBrowserCompat {
            ...
            if(this.mCallbacksMessengerRef != null && this.mCallbacksMessengerRef.get() != null) {
                if(this.mCallbackImplRef.get() == null) {
                    ...
                    try {
                        ...
                        Log.w(v0_1, "Unhandled message: " + arg11 + "\n  Client version: " + 1 + "\n  Service version: " + arg11.arg1);
                        return;
                    label_35:
                        ((MediaBrowserServiceCallbackImpl)v1).onConnectionFailed(((Messenger)v8));
                        return;
                    label_37:
                        Bundle v2_1 = v0.getBundle("data_root_hints");
                        MediaSessionCompat.ensureClassLoader(v2_1);
                        ((MediaBrowserServiceCallbackImpl)v1).onServiceConnected(((Messenger)v8), v0.getString("data_media_item_id"), v0.getParcelable("data_media_session_token"), v2_1);
                        return;
                    label_21:
                        Bundle v6 = v0.getBundle("data_options");
                        MediaSessionCompat.ensureClassLoader(v6);
                        Bundle v7 = v0.getBundle("data_notify_children_changed_options");
                        MediaSessionCompat.ensureClassLoader(v7);
                        v1.onLoadChildren(v8, v0.getString("data_media_item_id"), v0.getParcelableArrayList("data_media_item_list"), v6, v7);
                    }
    ...
    class ItemReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int arg1, Bundle arg2) {
            MediaSessionCompat.ensureClassLoader(arg2);
            if(arg1 == 0 && arg2 != null) {
                if(!arg2.containsKey("media_item")) {
                    ...
                    if(v1 == null || ((v1 instanceof MediaItem))) {
                        this.mCallback.onItemLoaded(((MediaItem)v1));
                    }
                    else {
    ...
    interface MediaBrowserImpl {
        ...
        void subscribe(@NonNull String arg1, @Nullable Bundle arg2, @NonNull SubscriptionCallback arg3);
    ...
    @RequiresApi(value=21) class MediaBrowserImplApi21 implements ConnectionCallbackInternal, MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        MediaBrowserImplApi21(Context arg3, ComponentName arg4, ConnectionCallback arg5, Bundle arg6) {
            super();
            this.mHandler = new CallbackHandler(((MediaBrowserServiceCallbackImpl)this));
            this.mSubscriptions = new ArrayMap();
            this.mContext = arg3;
            Bundle v0 = arg6 != null ? new Bundle(arg6) : new Bundle();
            this.mRootHints = v0;
        ...
        public void onConnected() {
            ...
            this.mServiceVersion = v0.getInt("extra_service_version", 0);
        ...
        public void onLoadChildren(Messenger arg2, String arg3, List arg4, Bundle arg5, Bundle arg6) {
            ...
            SubscriptionCallback v2_1 = ((Subscription)v2).getCallback(arg5);
            if(v2_1 != null) {
                Bundle v0 = null;
                if(arg5 == null) {
                    if(arg4 == null) {
                        ...
                        this.mNotifyChildrenChangedOptions = arg6;
                        v2_1.onChildrenLoaded(arg3, arg4);
                        this.mNotifyChildrenChangedOptions = v0;
                    }
                }
                else if(arg4 == null) {
        ...
        public void sendCustomAction(@NonNull String arg5, Bundle arg6, @Nullable CustomActionCallback arg7) {
            if(this.isConnected()) {
                ...
                CustomActionResultReceiver v0 = new CustomActionResultReceiver(arg5, arg6, arg7, this.mHandler);
                try {
                    this.mServiceBinderWrapper.sendCustomAction(arg5, arg6, ((ResultReceiver)v0), this.mCallbacksMessenger);
                }
                catch(RemoteException v0_1) {
                    Log.i("MediaBrowserCompat", "Remote error sending a custom action: action=" + arg5 + ", extras=" + arg6, ((Throwable)v0_1));
                    if(arg7 == null) {
                        return;
                    }
            ...
            v0_2.append("Cannot send a custom action (");
            v0_2.append(arg5);
            v0_2.append(") with ");
            v0_2.append("extras ");
            v0_2.append(arg6);
            v0_2.append(" because the browser is not connected to the ");
            v0_2.append("service.");
        ...
        public void subscribe(@NonNull String arg3, Bundle arg4, @NonNull SubscriptionCallback arg5) {
            ...
            arg5.setSubscription(((Subscription)v0));
            arg4 = arg4 == null ? null : new Bundle(arg4);
            ((Subscription)v0).putCallback(arg4, arg5);
            if(this.mServiceBinderWrapper == null) {
    ...
    @RequiresApi(value=23) class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        MediaBrowserImplApi23(Context arg1, ComponentName arg2, ConnectionCallback arg3, Bundle arg4) {
    ...
    @RequiresApi(value=26) class MediaBrowserImplApi26 extends MediaBrowserImplApi23 {
        MediaBrowserImplApi26(Context arg1, ComponentName arg2, ConnectionCallback arg3, Bundle arg4) {
            super(arg1, arg2, arg3, arg4);
        }

        public void subscribe(@NonNull String arg3, @Nullable Bundle arg4, @NonNull SubscriptionCallback arg5) {
            if(this.mServiceBinderWrapper != null && this.mServiceVersion >= 2) {
                super.subscribe(arg3, arg4, arg5);
            }
            else if(arg4 == null) {
                MediaBrowserCompatApi21.subscribe(this.mBrowserObj, arg3, arg5.mSubscriptionCallbackObj);
            }
            else {
                MediaBrowserCompatApi26.subscribe(this.mBrowserObj, arg3, arg4, arg5.mSubscriptionCallbackObj);
            }
        }

        public void unsubscribe(@NonNull String arg3, SubscriptionCallback arg4) {
            if(this.mServiceBinderWrapper != null && this.mServiceVersion >= 2) {
                super.unsubscribe(arg3, arg4);
            }
            else if(arg4 == null) {
                MediaBrowserCompatApi21.unsubscribe(this.mBrowserObj, arg3);
            }
            else {
                MediaBrowserCompatApi26.unsubscribe(this.mBrowserObj, arg3, arg4.mSubscriptionCallbackObj);
            }
        }
    }
    ...
    class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void onLoadChildren(Messenger arg3, String arg4, List arg5, Bundle arg6, Bundle arg7) {
            ...
            SubscriptionCallback v3_1 = ((Subscription)v3).getCallback(arg6);
            if(v3_1 != null) {
                Bundle v0_1 = null;
                if(arg6 == null) {
                    if(arg5 == null) {
                        ...
                        this.mNotifyChildrenChangedOptions = arg7;
                        v3_1.onChildrenLoaded(arg4, arg5);
                        this.mNotifyChildrenChangedOptions = v0_1;
                    }
                }
                else if(arg5 == null) {
    ...
    class ServiceBinderWrapper {
        ...
        void registerCallbackMessenger(Context arg3, Messenger arg4) throws RemoteException {
            Bundle v0 = new Bundle();
            v0.putString("data_package_name", arg3.getPackageName());
            v0.putBundle("data_root_hints", this.mRootHints);
    ...
    class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle arg3) {
            int v0;
            for(v0 = 0; v0 < this.mOptionsList.size(); ++v0) {
                if(MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(v0), arg3)) {
                    return this.mCallbacks.get(v0);
                }
            }
    ...
    public abstract class SubscriptionCallback {
        ...
        class StubApi26 extends android.support.v4.media.MediaBrowserCompat$SubscriptionCallback$StubApi21 implements android.support.v4.media.MediaBrowserCompatApi26$SubscriptionCallback {
            StubApi26(SubscriptionCallback arg1) {
                SubscriptionCallback.this = arg1;
                super(arg1);
            }
        ...
        void setSubscription(Subscription arg2) {
    ...
    public MediaBrowserCompat(Context arg3, ComponentName arg4, ConnectionCallback arg5, Bundle arg6) {
        super();
        if(Build$VERSION.SDK_INT >= 26) {
            this.mImpl = new MediaBrowserImplApi26(arg3, arg4, arg5, arg6);
        }
    ...
    @Nullable @RestrictTo(value={Scope.LIBRARY}) public Bundle getNotifyChildrenChangedOptions() {
