...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat fromRating(Object arg4) {
        RatingCompat v0 = null;
        if(arg4 != null && Build$VERSION.SDK_INT >= 19) {
            Object v1 = arg4;
            int v2 = ((Rating)v1).getRatingStyle();
            if(((Rating)v1).isRated()) {
                switch(v2) {
                    case 1: {
                        goto label_20;
                    }
                ...
                return v0;
            label_17:
                v0 = RatingCompat.newThumbRating(((Rating)v1).isThumbUp());
                goto label_24;
            label_20:
                v0 = RatingCompat.newHeartRating(((Rating)v1).hasHeart());
                goto label_24;
            label_11:
                v0 = RatingCompat.newPercentageRating(((Rating)v1).getPercentRating());
                goto label_24;
            label_14:
                v0 = RatingCompat.newStarRating(v2, ((Rating)v1).getStarRating());
            }
            else {
                v0 = RatingCompat.newUnratedRating(v2);
            }
