...
public interface IMediaSession extends IInterface {
    public abstract class Stub extends Binder implements IMediaSession {
        class Proxy implements IMediaSession {
            ...
            public PendingIntent getLaunchPendingIntent() throws RemoteException {
                ...
                try {
                    ...
                    v1.readException();
                    if(v1.readInt() != 0) {
                        v2_1 = PendingIntent.CREATOR.createFromParcel(v1);
                    }
                    else {
                        goto label_14;
                    }
            ...
            public CharSequence getQueueTitle() throws RemoteException {
                ...
                try {
                    ...
                    v1.readException();
                    if(v1.readInt() != 0) {
                        Object v2_1 = TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(v1);
                    }
                    else {
                        goto label_14;
                    }
            ...
            public void setShuffleModeEnabledRemoved(boolean arg5) throws RemoteException {
                Parcel v0 = Parcel.obtain();
                Parcel v1 = Parcel.obtain();
                try {
                    v0.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
        ...
        label_385:
            ...
            this.sendCommand(v4_3, ((Bundle)v7), ((ResultReceiverWrapper)v1));
            arg6.writeNoException();
            return 1;
        label_257:
            arg5.enforceInterface("android.support.v4.media.session.IMediaSession");
        ...
        label_73:
            ...
            this.setShuffleModeEnabledRemoved(v0);
            arg6.writeNoException();
            return 1;
        label_332:
            arg5.enforceInterface("android.support.v4.media.session.IMediaSession");
        ...
        label_87:
            arg5.enforceInterface("android.support.v4.media.session.IMediaSession");
            v4 = this.isShuffleModeEnabledRemoved();
            arg6.writeNoException();
            arg6.writeInt(((int)v4));
            return 1;
        label_348:
        ...
        label_405:
            ...
            this.rateWithExtras(v4_12, ((Bundle)v1));
            arg6.writeNoException();
            return 1;
        }
    }
