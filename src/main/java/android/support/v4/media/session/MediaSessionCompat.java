...
public class MediaSessionCompat {
    public abstract class Callback {
        class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message arg3) {
                if(arg3.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending(arg3.obj);
                }
            }
        }
        ...
        @RequiresApi(value=21) class StubApi21 implements android.support.v4.media.session.MediaSessionCompatApi21$Callback {
            ...
            public void onCommand(String arg4, Bundle arg5, ResultReceiver arg6) {
                ...
                try {
                    ...
                    if(arg4.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER")) {
                        v4 = Callback.this.mSessionImpl.get();
                        if(v4 == null) {
                            return;
                        }

                        arg5 = new Bundle();
                        Token v4_1 = ((MediaSessionImplApi21)v4).getSessionToken();
                        IMediaSession v0 = v4_1.getExtraBinder();
                        String v2 = "android.support.v4.media.session.EXTRA_BINDER";
                        if(v0 == null) {
                        }
                        else {
                            v1 = v0.asBinder();
                        ...
                        BundleCompat.putBinder(arg5, v2, v1);
                        arg5.putBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE", v4_1.getSessionToken2Bundle());
                        arg6.send(0, arg5);
                        return;
                    }

                    if(arg4.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM")) {
                        Callback.this.onAddQueueItem(arg5.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"));
                        return;
                    }

                    if(arg4.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT")) {
                    ...
                    if(arg4.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM")) {
                        Callback.this.onRemoveQueueItem(arg5.getParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"));
                        return;
                    }

                    if(arg4.equals("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT")) {
                        v4 = Callback.this.mSessionImpl.get();
                        if(v4 == null) {
                            return;
                        }

                        if(((MediaSessionImplApi21)v4).mQueue == null) {
                            return;
                        }

                        int v5 = arg5.getInt("android.support.v4.media.session.command.ARGUMENT_INDEX", -1);
                        if(v5 >= 0 && v5 < ((MediaSessionImplApi21)v4).mQueue.size()) {
                            v1_1 = ((MediaSessionImplApi21)v4).mQueue.get(v5);
                        }
                        ...
                        Callback.this.onRemoveQueueItem(((QueueItem)v1_1).getDescription());
                        return;
                    }
            ...
            public void onCustomAction(String arg3, Bundle arg4) {
                Bundle v0 = arg4.getBundle("android.support.v4.media.session.action.ARGUMENT_EXTRAS");
                MediaSessionCompat.ensureClassLoader(v0);
                if(arg3.equals("android.support.v4.media.session.action.PLAY_FROM_URI")) {
                    Callback.this.onPlayFromUri(arg4.getParcelable("android.support.v4.media.session.action.ARGUMENT_URI"), v0);
                }
                else if(arg3.equals("android.support.v4.media.session.action.PREPARE")) {
                    Callback.this.onPrepare();
                }
                else if(arg3.equals("android.support.v4.media.session.action.PREPARE_FROM_MEDIA_ID")) {
                    Callback.this.onPrepareFromMediaId(arg4.getString("android.support.v4.media.session.action.ARGUMENT_MEDIA_ID"), v0);
                }
                else if(arg3.equals("android.support.v4.media.session.action.PREPARE_FROM_SEARCH")) {
                    Callback.this.onPrepareFromSearch(arg4.getString("android.support.v4.media.session.action.ARGUMENT_QUERY"), v0);
                }
                else if(arg3.equals("android.support.v4.media.session.action.PREPARE_FROM_URI")) {
                    Callback.this.onPrepareFromUri(arg4.getParcelable("android.support.v4.media.session.action.ARGUMENT_URI"), v0);
                }
                else if(arg3.equals("android.support.v4.media.session.action.SET_CAPTIONING_ENABLED")) {
                    Callback.this.onSetCaptioningEnabled(arg4.getBoolean("android.support.v4.media.session.action.ARGUMENT_CAPTIONING_ENABLED"));
                }
                else if(arg3.equals("android.support.v4.media.session.action.SET_REPEAT_MODE")) {
                    Callback.this.onSetRepeatMode(arg4.getInt("android.support.v4.media.session.action.ARGUMENT_REPEAT_MODE"));
                }
                else if(arg3.equals("android.support.v4.media.session.action.SET_SHUFFLE_MODE")) {
                    Callback.this.onSetShuffleMode(arg4.getInt("android.support.v4.media.session.action.ARGUMENT_SHUFFLE_MODE"));
                }
                else if(arg3.equals("android.support.v4.media.session.action.SET_RATING")) {
                    Callback.this.onSetRating(arg4.getParcelable("android.support.v4.media.session.action.ARGUMENT_RATING"), v0);
                }
                else {
                    Callback.this.onCustomAction(arg3, arg4);
                }
            }
            ...
            public void onSetRating(Object arg1, Bundle arg2) {
            }
        ...
        void handleMediaPlayPauseKeySingleTapIfPending(RemoteUserInfo arg12) {
            ...
            PlaybackStateCompat v3 = ((MediaSessionImpl)v1).getPlaybackState();
            long v4 = 0;
            long v6 = v3 == null ? v4 : v3.getActions();
            int v3_1 = v3 == null || v3.getState() != 3 ? 0 : 1;
            int v8 = (0x204 & v6) != v4 ? 1 : 0;
            if((v6 & 0x202) != v4) {
                v0 = 1;
            }

            ((MediaSessionImpl)v1).setCurrentControllerInfo(arg12);
            if(v3_1 != 0 && v0 != 0) {
                this.onPause();
            }
            else if(v3_1 == 0 && v8 != 0) {
            ...
            ((MediaSessionImpl)v1).setCurrentControllerInfo(null);
        }
        ...
        public boolean onMediaButtonEvent(Intent arg9) {
            ...
            if(v0 != null) {
                if(this.mCallbackHandler == null) {
                    ...
                    Parcelable v9 = arg9.getParcelableExtra("android.intent.extra.KEY_EVENT");
                    if(v9 != null) {
                        if(((KeyEvent)v9).getAction() != 0) {
                        }
                        else {
                            RemoteUserInfo v2 = ((MediaSessionImpl)v0).getCurrentControllerInfo();
                            int v3 = ((KeyEvent)v9).getKeyCode();
                            if(v3 != 0x4F && v3 != 85) {
                                this.handleMediaPlayPauseKeySingleTapIfPending(v2);
                                return 0;
                            }

                            if(((KeyEvent)v9).getRepeatCount() > 0) {
                                this.handleMediaPlayPauseKeySingleTapIfPending(v2);
                            }
                            else if(this.mMediaPlayPauseKeyPending) {
                                this.mCallbackHandler.removeMessages(1);
                                this.mMediaPlayPauseKeyPending = false;
                                PlaybackStateCompat v9_1 = ((MediaSessionImpl)v0).getPlaybackState();
                                long v0_1 = 0;
                                long v4 = v9_1 == null ? v0_1 : v9_1.getActions();
                                if((v4 & 0x20) == v0_1) {
                                    return 1;
                                }
                                ...
                                this.mCallbackHandler.sendMessageDelayed(this.mCallbackHandler.obtainMessage(1, v2), ((long)ViewConfiguration.getDoubleTapTimeout()));
                            }
        ...
        void setSessionImpl(MediaSessionImpl arg2, Handler arg3) {
    ...
    @RequiresApi(value=18) class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        int getRccTransportControlFlagsFromActions(long arg4) {
            int v0 = super.getRccTransportControlFlagsFromActions(arg4);
            if((arg4 & 0x100) != 0) {
                v0 |= 0x100;
            }
        ...
        public void setCallback(Callback arg1, Handler arg2) {
            ...
            if(arg1 == null) {
                ...
                this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient$OnPlaybackPositionUpdateListener() {
                    public void onPlaybackPositionUpdate(long arg7) {
                        MediaSessionImplApi18.this.postToHandler(18, -1, -1, Long.valueOf(arg7), null);
                    }
                });
            }
        }
    ...
    @RequiresApi(value=19) class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        RemoteControlClient$MetadataEditor buildRccMetadata(Bundle arg9) {
            RemoteControlClient$MetadataEditor v0 = super.buildRccMetadata(arg9);
            long v2 = 0;
            long v4 = this.mState == null ? v2 : this.mState.getActions();
            int v1 = 0x10000001;
            if((v4 & 0x80) != v2) {
                v0.addEditableKey(v1);
            }
            ...
            if(arg9.containsKey("android.media.metadata.YEAR")) {
                v0.putLong(8, arg9.getLong("android.media.metadata.YEAR"));
            }

            if(arg9.containsKey("android.media.metadata.RATING")) {
                ((MediaMetadataEditor)v0).putObject(101, arg9.getParcelable("android.media.metadata.RATING"));
            }

            if(arg9.containsKey("android.media.metadata.USER_RATING")) {
                ((MediaMetadataEditor)v0).putObject(v1, arg9.getParcelable("android.media.metadata.USER_RATING"));
            }
        ...
        public void setCallback(Callback arg1, Handler arg2) {
            ...
            if(arg1 == null) {
                ...
                this.mRcc.setMetadataUpdateListener(new RemoteControlClient$OnMetadataUpdateListener() {
                    public void onMetadataUpdate(int arg7, Object arg8) {
                        if(arg7 == 0x10000001 && ((arg8 instanceof Rating))) {
                            MediaSessionImplApi19.this.postToHandler(19, -1, -1, RatingCompat.fromRating(arg8), null);
                        }
                    }
                });
            }
    ...
    @RequiresApi(value=21) class MediaSessionImplApi21 implements MediaSessionImpl {
        class ExtraSession extends Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback arg5) {
                if(!MediaSessionImplApi21.this.mDestroyed) {
                    String v0 = MediaSessionImplApi21.this.getCallingPackage();
                    if(v0 == null) {
                        v0 = "android.media.session.MediaController";
                    }

                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(((IInterface)arg5), new RemoteUserInfo(v0, ExtraSession.getCallingPid(), ExtraSession.getCallingUid()));
                }
            }
            ...
            public void setShuffleModeEnabledRemoved(boolean arg1) throws RemoteException {
            }
        ...
        MediaSessionImplApi21(Context arg2, String arg3, Bundle arg4) {
            super();
            ...
            this.mToken = new Token(MediaSessionCompatApi21.getSessionToken(this.mSessionObj), new ExtraSession(this), arg4);
        }

        MediaSessionImplApi21(Object arg3) {
            super();
            this.mDestroyed = false;
            this.mExtraControllerCallbacks = new RemoteCallbackList();
        ...
        public void setCurrentControllerInfo(RemoteUserInfo arg1) {
        }
        ...
        public void setQueue(List arg3) {
            ...
            MediaSessionCompatApi21.setQueue(this.mSessionObj, v0_1);
        }
    ...
    @RequiresApi(value=28) class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        MediaSessionImplApi28(Context arg1, String arg2, Bundle arg3) {
            super(arg1, arg2, arg3);
        }

        MediaSessionImplApi28(Object arg1) {
            super(arg1);
        }

        @NonNull public final RemoteUserInfo getCurrentControllerInfo() {
            return new RemoteUserInfo(this.mSessionObj.getCurrentControllerInfo());
        }
    ...
    class MediaSessionImplBase implements MediaSessionImpl {
        class android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase$1 extends androidx.media.VolumeProviderCompat$Callback {
        ...
        class MediaSessionStub extends Stub {
            ...
            public void playFromMediaId(String arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(8, arg2, arg3);
            }

            public void playFromSearch(String arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(9, arg2, arg3);
            }

            public void playFromUri(Uri arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(10, arg2, arg3);
            }

            void postToHandler(int arg7, Object arg8) {
                MediaSessionImplBase.this.postToHandler(arg7, 0, 0, arg8, null);
            }

            void postToHandler(int arg7, Object arg8, int arg9) {
                MediaSessionImplBase.this.postToHandler(arg7, arg9, 0, arg8, null);
            }

            void postToHandler(int arg7) {
                MediaSessionImplBase.this.postToHandler(arg7, 0, 0, null, null);
            }

            void postToHandler(int arg7, Object arg8, Bundle arg9) {
                MediaSessionImplBase.this.postToHandler(arg7, 0, 0, arg8, arg9);
            }

            void postToHandler(int arg7, int arg8) {
                MediaSessionImplBase.this.postToHandler(arg7, arg8, 0, null, null);
            }
            ...
            public void prepareFromMediaId(String arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(4, arg2, arg3);
            }

            public void prepareFromSearch(String arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(5, arg2, arg3);
            }

            public void prepareFromUri(Uri arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(6, arg2, arg3);
            }
            ...
            public void rate(RatingCompat arg2) throws RemoteException {
                this.postToHandler(19, arg2);
            }

            public void rateWithExtras(RatingCompat arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(0x1F, arg2, arg3);
            }

            public void registerCallbackListener(IMediaControllerCallback arg5) {
                if(MediaSessionImplBase.this.mDestroyed) {
                    try {
                        arg5.onSessionDestroyed();
                        return;
                    }
                    catch(Exception ) {
                        return;
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(((IInterface)arg5), new RemoteUserInfo("android.media.session.MediaController", MediaSessionStub.getCallingPid(), MediaSessionStub.getCallingUid()));
            }

            public void removeQueueItem(MediaDescriptionCompat arg2) {
                this.postToHandler(27, arg2);
            }

            public void removeQueueItemAt(int arg2) {
                this.postToHandler(28, arg2);
            }
            ...
            public void seekTo(long arg1) throws RemoteException {
                this.postToHandler(18, Long.valueOf(arg1));
            }

            public void sendCommand(String arg2, Bundle arg3, ResultReceiverWrapper arg4) {
                this.postToHandler(1, new Command(arg2, arg3, arg4.mResultReceiver));
            }

            public void sendCustomAction(String arg2, Bundle arg3) throws RemoteException {
                this.postToHandler(20, arg2, arg3);
            }

            public boolean sendMediaButton(KeyEvent arg3) {
                boolean v1 = true;
                ...
                if(v1) {
                    this.postToHandler(21, arg3);
                }

                return v1;
            }

            public void setCaptioningEnabled(boolean arg2) throws RemoteException {
                this.postToHandler(29, Boolean.valueOf(arg2));
            }

            public void setRepeatMode(int arg2) throws RemoteException {
                this.postToHandler(23, arg2);
            }

            public void setShuffleMode(int arg2) throws RemoteException {
                this.postToHandler(30, arg2);
            }
            ...
            public void skipToQueueItem(long arg1) {
                this.postToHandler(11, Long.valueOf(arg1));
            }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message arg8) {
                ...
                Bundle v1 = arg8.getData();
                MediaSessionCompat.ensureClassLoader(v1);
                MediaSessionImplBase.this.setCurrentControllerInfo(new RemoteUserInfo(v1.getString("data_calling_pkg"), v1.getInt("data_calling_pid"), v1.getInt("data_calling_uid")));
                v1 = v1.getBundle("data_extras");
                MediaSessionCompat.ensureClassLoader(v1);
                RemoteUserInfo v2 = null;
                try {
                    switch(arg8.what) {
                        case 1: {
                            v0.onCommand(arg8.obj.command, arg8.obj.extras, arg8.obj.stub);
                            goto label_138;
                        }
                        case 2: {
                            MediaSessionImplBase.this.adjustVolume(arg8.arg1, 0);
                            goto label_138;
                        }
                        case 3: {
                            v0.onPrepare();
                        ...
                        case 4: {
                            v0.onPrepareFromMediaId(arg8.obj, v1);
                            goto label_138;
                        }
                        case 5: {
                            v0.onPrepareFromSearch(arg8.obj, v1);
                            goto label_138;
                        }
                        case 6: {
                            v0.onPrepareFromUri(arg8.obj, v1);
                            goto label_138;
                        }
                        case 7: {
                            v0.onPlay();
                        ...
                        case 8: {
                            v0.onPlayFromMediaId(arg8.obj, v1);
                            goto label_138;
                        }
                        case 9: {
                            v0.onPlayFromSearch(arg8.obj, v1);
                            goto label_138;
                        }
                        case 10: {
                            v0.onPlayFromUri(arg8.obj, v1);
                            goto label_138;
                        }
                        case 11: {
                            v0.onSkipToQueueItem(arg8.obj.longValue());
                            goto label_138;
                        }
                        case 12: {
                            v0.onPause();
                        ...
                        case 15: {
                            v0.onSkipToPrevious();
                            goto label_138;
                            MediaSessionImplBase.this.setCurrentControllerInfo(v2);
                            throw v8;
                        }
                        case 16: {
                            v0.onFastForward();
                        ...
                        case 18: {
                            v0.onSeekTo(arg8.obj.longValue());
                            goto label_138;
                        }
                        case 19: {
                            v0.onSetRating(arg8.obj);
                            goto label_138;
                        }
                        case 20: {
                            v0.onCustomAction(arg8.obj, v1);
                            goto label_138;
                        }
                        case 21: {
                            v8_1 = arg8.obj;
                            Intent v1_1 = new Intent("android.intent.action.MEDIA_BUTTON");
                            v1_1.putExtra("android.intent.extra.KEY_EVENT", ((Parcelable)v8_1));
                            if(v0.onMediaButtonEvent(v1_1)) {
                                goto label_138;
                            }

                            this.onMediaButtonEvent(((KeyEvent)v8_1), v0);
                            goto label_138;
                        }
                        case 22: {
                            MediaSessionImplBase.this.setVolumeTo(arg8.arg1, 0);
                            goto label_138;
                        }
                        case 23: {
                            v0.onSetRepeatMode(arg8.arg1);
                            goto label_138;
                        }
                        case 25: {
                            v0.onAddQueueItem(arg8.obj);
                            goto label_138;
                        }
                        case 26: {
                            v0.onAddQueueItem(arg8.obj, arg8.arg1);
                            goto label_138;
                        }
                        case 27: {
                            v0.onRemoveQueueItem(arg8.obj);
                            goto label_138;
                        }
                        case 28: {
                            ...
                            v8_1 = arg8.arg1 < 0 || arg8.arg1 >= MediaSessionImplBase.this.mQueue.size() ? v2 : MediaSessionImplBase.this.mQueue.get(arg8.arg1);
                            if(v8_1 == null) {
                                goto label_138;
                            }

                            v0.onRemoveQueueItem(((QueueItem)v8_1).getDescription());
                            goto label_138;
                        }
                        case 29: {
                            v0.onSetCaptioningEnabled(arg8.obj.booleanValue());
                            goto label_138;
                        }
                        case 30: {
                            v0.onSetShuffleMode(arg8.arg1);
                            goto label_138;
                        }
                        case 31: {
                            v0.onSetRating(arg8.obj, v1);
                            goto label_138;
                        }
                        default: {
                            goto label_138;
            ...
            private void onMediaButtonEvent(KeyEvent arg8, Callback arg9) {
                if(arg8 != null) {
                    if(arg8.getAction() != 0) {
                    }
                    else {
        ...
        int getRccTransportControlFlagsFromActions(long arg7) {
            long v2 = 0;
            int v0 = (1 & arg7) != v2 ? 0x20 : 0;
            if((2 & arg7) != v2) {
                v0 |= 16;
            }
        ...
        void postToHandler(int arg3, int arg4, int arg5, Object arg6, Bundle arg7) {
            Object v0 = this.mLock;
            __monitor_enter(v0);
            try {
                if(this.mHandler != null) {
                    Message v3_1 = this.mHandler.obtainMessage(arg3, arg4, arg5, arg6);
                    Bundle v4 = new Bundle();
                    v4.putString("data_calling_pkg", "android.media.session.MediaController");
                    v4.putInt("data_calling_pid", Binder.getCallingPid());
                    v4.putInt("data_calling_uid", Binder.getCallingUid());
                    if(arg7 != null) {
                        v4.putBundle("data_extras", arg7);
                    }
        ...
        public void setCurrentControllerInfo(RemoteUserInfo arg2) {
            Object v0 = this.mLock;
            __monitor_enter(v0);
            try {
                this.mRemoteUserInfo = arg2;
                __monitor_exit(v0);
                return;
            label_6:
                __monitor_exit(v0);
    ...
    public final class QueueItem implements Parcelable {
        ...
        private QueueItem(Object arg3, MediaDescriptionCompat arg4, long arg5) {
            super();
            if(arg4 != null) {
                if(arg5 != -1) {
    ...
    @RestrictTo(value={Scope.LIBRARY}) public final class ResultReceiverWrapper implements Parcelable {
    ...
    public final class Token implements Parcelable {
        ...
        Token(Object arg1, IMediaSession arg2, Bundle arg3) {
            super();
            this.mInner = arg1;
            this.mExtraBinder = arg2;
            this.mSessionToken2Bundle = arg3;
        }

        Token(Object arg2, IMediaSession arg3) {
            this(arg2, arg3, null);
        }
        ...
        @RestrictTo(value={Scope.LIBRARY_GROUP}) public static Token fromBundle(Bundle arg4) {
            Token v0 = null;
            if(arg4 == null) {
                return v0;
            }

            IMediaSession v1 = Stub.asInterface(BundleCompat.getBinder(arg4, "android.support.v4.media.session.EXTRA_BINDER"));
            Bundle v2 = arg4.getBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE");
            Parcelable v4 = arg4.getParcelable("android.support.v4.media.session.TOKEN");
            if(v4 == null) {
            }
            else {
                v0 = new Token(((Token)v4).mInner, v1, v2);
            }
        ...
        @RestrictTo(value={Scope.LIBRARY_GROUP}) public Bundle getSessionToken2Bundle() {
        ...
        @RestrictTo(value={Scope.LIBRARY_GROUP}) public void setExtraBinder(IMediaSession arg1) {
            this.mExtraBinder = arg1;
        }

        @RestrictTo(value={Scope.LIBRARY_GROUP}) public void setSessionToken2Bundle(Bundle arg1) {
            this.mSessionToken2Bundle = arg1;
        }

        @RestrictTo(value={Scope.LIBRARY_GROUP}) public Bundle toBundle() {
            Bundle v0 = new Bundle();
            v0.putParcelable("android.support.v4.media.session.TOKEN", ((Parcelable)this));
            if(this.mExtraBinder != null) {
                BundleCompat.putBinder(v0, "android.support.v4.media.session.EXTRA_BINDER", this.mExtraBinder.asBinder());
            }

            if(this.mSessionToken2Bundle != null) {
                v0.putBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE", this.mSessionToken2Bundle);
            }
    ...
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_CAPTIONING_ENABLED = "android.support.v4.media.session.action.ARGUMENT_CAPTIONING_ENABLED";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_EXTRAS = "android.support.v4.media.session.action.ARGUMENT_EXTRAS";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_MEDIA_ID = "android.support.v4.media.session.action.ARGUMENT_MEDIA_ID";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_QUERY = "android.support.v4.media.session.action.ARGUMENT_QUERY";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_RATING = "android.support.v4.media.session.action.ARGUMENT_RATING";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_REPEAT_MODE = "android.support.v4.media.session.action.ARGUMENT_REPEAT_MODE";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_SHUFFLE_MODE = "android.support.v4.media.session.action.ARGUMENT_SHUFFLE_MODE";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_ARGUMENT_URI = "android.support.v4.media.session.action.ARGUMENT_URI";
    public static final String ACTION_FLAG_AS_INAPPROPRIATE = "android.support.v4.media.session.action.FLAG_AS_INAPPROPRIATE";
    public static final String ACTION_FOLLOW = "android.support.v4.media.session.action.FOLLOW";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_PLAY_FROM_URI = "android.support.v4.media.session.action.PLAY_FROM_URI";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_PREPARE = "android.support.v4.media.session.action.PREPARE";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_PREPARE_FROM_MEDIA_ID = "android.support.v4.media.session.action.PREPARE_FROM_MEDIA_ID";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_PREPARE_FROM_SEARCH = "android.support.v4.media.session.action.PREPARE_FROM_SEARCH";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_PREPARE_FROM_URI = "android.support.v4.media.session.action.PREPARE_FROM_URI";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_SET_CAPTIONING_ENABLED = "android.support.v4.media.session.action.SET_CAPTIONING_ENABLED";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_SET_RATING = "android.support.v4.media.session.action.SET_RATING";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_SET_REPEAT_MODE = "android.support.v4.media.session.action.SET_REPEAT_MODE";
    @RestrictTo(value={Scope.LIBRARY}) public static final String ACTION_SET_SHUFFLE_MODE = "android.support.v4.media.session.action.SET_SHUFFLE_MODE";
    ...
    @RestrictTo(value={Scope.LIBRARY}) public static final String KEY_EXTRA_BINDER = "android.support.v4.media.session.EXTRA_BINDER";
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public static final String KEY_SESSION_TOKEN2_BUNDLE = "android.support.v4.media.session.SESSION_TOKEN2_BUNDLE";
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public static final String KEY_TOKEN = "android.support.v4.media.session.TOKEN";
    ...
    public MediaSessionCompat(Context arg7, String arg8, ComponentName arg9, PendingIntent arg10) {
        this(arg7, arg8, arg9, arg10, null);
    }

    private MediaSessionCompat(Context arg3, String arg4, ComponentName arg5, PendingIntent arg6, Bundle arg7) {
        super();
        this.mActiveListeners = new ArrayList();
        if(arg3 != null) {
            if(!TextUtils.isEmpty(((CharSequence)arg4))) {
                ...
                if(Build$VERSION.SDK_INT >= 28) {
                    this.mImpl = new MediaSessionImplApi28(arg3, arg4, arg7);
                    this.setCallback(new Callback() {
                    });
                    this.mImpl.setMediaButtonReceiver(arg6);
                }
                else if(Build$VERSION.SDK_INT >= 21) {
                    this.mImpl = new MediaSessionImplApi21(arg3, arg4, arg7);
                    this.setCallback(new Callback() {
                    });
                    this.mImpl.setMediaButtonReceiver(arg6);
                }
                ...
                if(MediaSessionCompat.sMaxBitmapSize == 0) {
                    MediaSessionCompat.sMaxBitmapSize = ((int)(TypedValue.applyDimension(1, 320f, arg3.getResources().getDisplayMetrics()) + 0.5f));
                }
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public MediaSessionCompat(Context arg7, String arg8, Bundle arg9) {
        this(arg7, arg8, null, null, arg9);
    }
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public static void ensureClassLoader(@Nullable Bundle arg1) {
        if(arg1 != null) {
    ...
    static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat arg14, MediaMetadataCompat arg15) {
        long v9;
        if(arg14 != null) {
            long v2 = -1;
            if(arg14.getPosition() == v2) {
                ...
                if(arg14.getState() == 3 || arg14.getState() == 4 || arg14.getState() == 5) {
                    ...
                    if(v0 > v4) {
                        ...
                        v0 = (((long)(arg14.getPlaybackSpeed() * (((float)(v12 - v0)))))) + arg14.getPosition();
