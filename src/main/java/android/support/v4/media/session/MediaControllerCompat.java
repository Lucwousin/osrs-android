...
public final class MediaControllerCompat {
    public abstract class Callback implements IBinder$DeathRecipient {
            ...
            public void handleMessage(Message arg3) {
                ...
                switch(arg3.what) {
                    case 1: {
                        ...
                        Callback.this.onSessionEvent(arg3.obj, v0);
                        break;
                    }
                    case 2: {
                    ...
                    case 7: {
                        Object v3 = arg3.obj;
                        MediaSessionCompat.ensureClassLoader(((Bundle)v3));
                        Callback.this.onExtrasChanged(((Bundle)v3));
                        break;
                    }
                    case 8: {
        ...
        class StubApi21 implements android.support.v4.media.session.MediaControllerCompatApi21$Callback {
            ...
            public void onPlaybackStateChanged(Object arg3) {
                Object v0 = this.mCallback.get();
                if(v0 != null) {
                    if(((Callback)v0).mIControllerCallback != null) {
                    }
                    else {
            ...
            public void onSessionEvent(String arg4, Bundle arg5) {
                Object v0 = this.mCallback.get();
                if(v0 != null && (((Callback)v0).mIControllerCallback == null || Build$VERSION.SDK_INT >= 23)) {
        ...
        class StubCompat extends Stub {
            ...
            public void onSessionReady() throws RemoteException {
                Object v0 = this.mCallback.get();
                if(v0 != null) {
                    ((Callback)v0).postToHandler(13, null, null);
                }
            }
            ...
            public void onShuffleModeChangedRemoved(boolean arg1) throws RemoteException {
            }
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo arg10) throws RemoteException {
                ...
                if(v0 != null) {
                    Bundle v1 = null;
                    if(arg10 != null) {
                        v8 = new PlaybackInfo(arg10.volumeType, arg10.audioStream, arg10.controlType, arg10.maxVolume, arg10.currentVolume);
                    }
                    else {
                        Object v8_1 = v1;
                    }

                    ((Callback)v0).postToHandler(4, v8, v1);
                }
            }
        }
        ...
        public Callback() {
            ...
            if(Build$VERSION.SDK_INT >= 21) {
                ...
                StubCompat v0 = new StubCompat(this);
                this.mIControllerCallback = ((IMediaControllerCallback)v0);
        ...
        @RestrictTo(value={Scope.LIBRARY}) public IMediaControllerCallback getIControllerCallback() {
    ...
    @RequiresApi(value=21) class MediaControllerImplApi21 implements MediaControllerImpl {
        class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            ExtraBinderRequestResultReceiver(MediaControllerImplApi21 arg2) {
                super(null);
                this.mMediaControllerImpl = new WeakReference(arg2);
            }

            protected void onReceiveResult(int arg4, Bundle arg5) {
                Object v4 = this.mMediaControllerImpl.get();
                if(v4 != null) {
                    if(arg5 == null) {
                    }
                    else {
                        Object v0 = ((MediaControllerImplApi21)v4).mLock;
                        __monitor_enter(v0);
                        try {
                            ((MediaControllerImplApi21)v4).mSessionToken.setExtraBinder(android.support.v4.media.session.IMediaSession$Stub.asInterface(BundleCompat.getBinder(arg5, "android.support.v4.media.session.EXTRA_BINDER")));
                            ((MediaControllerImplApi21)v4).mSessionToken.setSessionToken2Bundle(arg5.getBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE"));
                            ((MediaControllerImplApi21)v4).processPendingCallbacksLocked();
                            __monitor_exit(v0);
                            return;
                        label_20:
                            __monitor_exit(v0);
        ...
        final Object mLock;
        @GuardedBy(value="mLock") private final List mPendingCallbacks;
        ...
        public MediaControllerImplApi21(Context arg2, Token arg3) throws RemoteException {
            ...
            this.mSessionToken = arg3;
            this.mControllerObj = MediaControllerCompatApi21.fromToken(arg2, this.mSessionToken.getToken());
        ...
        public void addQueueItem(MediaDescriptionCompat arg5) {
            if((this.getFlags() & 4) != 0) {
                ...
                v0.putParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION", ((Parcelable)arg5));
        ...
        public void addQueueItem(MediaDescriptionCompat arg5, int arg6) {
            if((this.getFlags() & 4) != 0) {
                Bundle v0 = new Bundle();
                v0.putParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION", ((Parcelable)arg5));
                v0.putInt("android.support.v4.media.session.command.ARGUMENT_INDEX", arg6);
        ...
        public boolean isSessionReady() {
            boolean v0 = this.mSessionToken.getExtraBinder() != null ? true : false;
            return v0;
        }

        @GuardedBy(value="mLock") void processPendingCallbacksLocked() {
            if(this.mSessionToken.getExtraBinder() == null) {
                return;
            }

            Iterator v0 = this.mPendingCallbacks.iterator();
            while(v0.hasNext()) {
                Object v1 = v0.next();
                ExtraCallback v2 = new ExtraCallback(((Callback)v1));
                this.mCallbackMap.put(v1, v2);
                ((Callback)v1).mIControllerCallback = ((IMediaControllerCallback)v2);
                try {
                    this.mSessionToken.getExtraBinder().registerCallbackListener(((IMediaControllerCallback)v2));
                }
                ...
                ((Callback)v1).postToHandler(13, null, null);
            }
        ...
        public final void registerCallback(Callback arg4, Handler arg5) {
            ...
            try {
                ...
                ExtraCallback v0 = new ExtraCallback(arg4);
                this.mCallbackMap.put(arg4, v0);
                arg4.mIControllerCallback = ((IMediaControllerCallback)v0);
                try {
                    this.mSessionToken.getExtraBinder().registerCallbackListener(((IMediaControllerCallback)v0));
                    arg4.postToHandler(13, v1, ((Bundle)v1));
                    goto label_28;
                }
                catch(RemoteException v4_1) {
                    try {
                        Log.e("MediaControllerCompat", "Dead object in registerCallback.", ((Throwable)v4_1));
                        goto label_28;
                    label_25:
                        arg4.mIControllerCallback = ((IMediaControllerCallback)v1);
        ...
        public final void unregisterCallback(Callback arg4) {
            ...
            try {
                ...
                try {
                    Object v1 = this.mCallbackMap.remove(arg4);
                    if(v1 == null) {
                        goto label_24;
                    }

                    arg4.mIControllerCallback = null;
                    this.mSessionToken.getExtraBinder().unregisterCallbackListener(((IMediaControllerCallback)v1));
                    goto label_24;
                }
                catch(RemoteException v4_1) {
                    try {
                        Log.e("MediaControllerCompat", "Dead object in unregisterCallback.", ((Throwable)v4_1));
                        goto label_24;
                    label_22:
    ...
    class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public void addQueueItem(MediaDescriptionCompat arg5) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in addQueueItem.", ((Throwable)v5));
            }
        }
        ...
        public void addQueueItem(MediaDescriptionCompat arg5, int arg6) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in addQueueItemAt.", ((Throwable)v5));
            }
        }
        ...
        public void removeQueueItem(MediaDescriptionCompat arg5) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in removeQueueItem.", ((Throwable)v5));
            }
        }
    ...
    @RestrictTo(value={Scope.LIBRARY}) public static final String COMMAND_ADD_QUEUE_ITEM = "android.support.v4.media.session.command.ADD_QUEUE_ITEM";
    @RestrictTo(value={Scope.LIBRARY}) public static final String COMMAND_ADD_QUEUE_ITEM_AT = "android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT";
    @RestrictTo(value={Scope.LIBRARY}) public static final String COMMAND_ARGUMENT_INDEX = "android.support.v4.media.session.command.ARGUMENT_INDEX";
    @RestrictTo(value={Scope.LIBRARY}) public static final String COMMAND_ARGUMENT_MEDIA_DESCRIPTION = "android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION";
    @RestrictTo(value={Scope.LIBRARY}) public static final String COMMAND_GET_EXTRA_BINDER = "android.support.v4.media.session.command.GET_EXTRA_BINDER";
    @RestrictTo(value={Scope.LIBRARY}) public static final String COMMAND_REMOVE_QUEUE_ITEM = "android.support.v4.media.session.command.REMOVE_QUEUE_ITEM";
    @RestrictTo(value={Scope.LIBRARY}) public static final String COMMAND_REMOVE_QUEUE_ITEM_AT = "android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT";
    ...
    public MediaControllerCompat(Context arg3, @NonNull Token arg4) throws RemoteException {
        ...
        if(arg4 != null) {
            ...
            if(Build$VERSION.SDK_INT >= 24) {
                ...
                this.mImpl = new MediaControllerImplBase(arg4);
            }
    ...
    public MediaControllerCompat(Context arg3, @NonNull MediaSessionCompat arg4) {
        MediaControllerImplBase v4_2;
        MediaControllerImplApi21 v0_2;
        super();
        this.mRegisteredCallbacks = new HashSet();
        if(arg4 != null) {
            this.mToken = arg4.getSessionToken();
            MediaControllerImpl v4 = null;
            try {
                if(Build$VERSION.SDK_INT >= 24) {
                    MediaControllerImplApi24 v0 = new MediaControllerImplApi24(arg3, this.mToken);
                }
                else if(Build$VERSION.SDK_INT >= 23) {
                    MediaControllerImplApi23 v0_1 = new MediaControllerImplApi23(arg3, this.mToken);
                }
                else if(Build$VERSION.SDK_INT >= 21) {
                    v0_2 = new MediaControllerImplApi21(arg3, this.mToken);
                }
                else {
                    goto label_30;
                }

                MediaControllerImplApi24 v4_1 = ((MediaControllerImplApi24)v0_2);
                goto label_39;
            label_30:
                v4_2 = new MediaControllerImplBase(this.mToken);
            }
            catch(RemoteException v3) {
                Log.w("MediaControllerCompat", "Failed to create MediaControllerImpl.", ((Throwable)v3));
            }

        label_39:
            this.mImpl = ((MediaControllerImpl)v4_2);
            return;
        }
    ...
    public static MediaControllerCompat getMediaController(@NonNull Activity arg3) {
        ...
        if((arg3 instanceof ComponentActivity)) {
            ExtraData v3 = ((ComponentActivity)arg3).getExtraData(MediaControllerExtraData.class);
            if(v3 != null) {
    ...
    @Nullable @RestrictTo(value={Scope.LIBRARY_GROUP}) public Bundle getSessionToken2Bundle() {
    ...
    public static void setMediaController(@NonNull Activity arg2, MediaControllerCompat arg3) {
        if((arg2 instanceof ComponentActivity)) {
    ...
    static void validateCustomAction(String arg3, Bundle arg4) {
        if(arg3 == null) {
            return;
        }
