...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public final class CustomAction implements Parcelable {
        ...
        CustomAction(Parcel arg2) {
            ...
            this.mExtras = arg2.readBundle(MediaSessionCompat.class.getClassLoader());
        }
    ...
    public static final long ACTION_SET_SHUFFLE_MODE = 0x200000;
    @Deprecated public static final long ACTION_SET_SHUFFLE_MODE_ENABLED = 0x80000;
    ...
    PlaybackStateCompat(Parcel arg3) {
        ...
        this.mExtras = arg3.readBundle(MediaSessionCompat.class.getClassLoader());
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public long getCurrentPosition(Long arg8) {
        long v0 = this.mPosition;
        float v2 = this.mSpeed;
        long v3 = arg8 != null ? arg8.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime;
        return Math.max(0, v0 + (((long)(v2 * (((float)v3))))));
    }
