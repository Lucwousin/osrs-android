...
@KeepForSdk @ParametersAreNonnullByDefault public class AdvertisingIdClient {
    ...
    @Nullable @GuardedBy(value="this") private BlockingServiceConnection zze;
    @Nullable @GuardedBy(value="this") private zze zzf;
    @GuardedBy(value="this") private boolean zzg;
    private final Object zzh;
    @Nullable @GuardedBy(value="mAutoDisconnectTaskLock") private zza zzi;
    ...
    @KeepForSdk public static Info getAdvertisingIdInfo(Context arg13) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        Info v13_1;
    ...
    @KeepForSdk public Info getInfo() throws IOException {
        Info v0_4;
        Object v0_1;
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        __monitor_enter(this);
    ...
    @KeepForSdk public static boolean getIsAdIdFakeForDebugLogging(Context arg9) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        boolean v9_1;
        zzb v0 = new zzb(arg9);
    ...
    @KeepForSdk public void start() throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        this.zza(true);
    }

    @VisibleForTesting private final void zza(boolean arg3) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        __monitor_enter(this);
        try {
            if(this.zzg) {
    ...
    private static BlockingServiceConnection zza(Context arg3, boolean arg4) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        try {
    ...
    @VisibleForTesting private static zze zza(Context arg2, BlockingServiceConnection arg3) throws IOException {
        long v0 = 10000;
        try {
