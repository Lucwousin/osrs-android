...
@KeepForSdk public final class ObjectWrapper extends Stub {
    ...
    @KeepForSdk public static Object unwrap(IObjectWrapper arg7) {
        if((arg7 instanceof ObjectWrapper)) {
            return ((ObjectWrapper)arg7).zzhz;
        }
