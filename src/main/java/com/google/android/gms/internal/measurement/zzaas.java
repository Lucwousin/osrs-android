...
final class zzaas {
    static String zza(zzaaq arg2, String arg3) {
    ...
    private static void zza(zzaaq arg12, StringBuilder arg13, int arg14) {
        boolean v4_4;
        zzzb v4_3;
        String v8;
        String v6_1;
        ...
        while(v2_1.hasNext()) {
            ...
            if((v4_1.endsWith("List")) && !v4_1.endsWith("OrBuilderList") && !v4_1.equals("List")) {
                ...
                zzaas.zzb(arg13, arg14, zzaas.zzfp(v6_1), zzzv.zza(((Method)v8_1), arg12, new Object[0]));
                continue;
            }
        ...
        label_70:
            if((v4_1.endsWith("Map")) && !v4_1.equals("Map")) {
                ...
                zzaas.zzb(arg13, arg14, zzaas.zzfp(v6_1), zzzv.zza(((Method)v3_1), arg12, new Object[0]));
                continue;
            }
        ...
        label_107:
            ...
            v6_2 = zzzv.zza(((Method)v6_2), arg12, new Object[0]);
            if(v4_2 == null) {
            ...
            label_220:
                ...
                v4_4 = zzzv.zza(((Method)v4_2), arg12, new Object[0]).booleanValue();
            }
        ...
        label_228:
            ...
            zzaas.zzb(arg13, arg14, zzaas.zzfp(v3_2), v6_2);
        }

        if((arg12 instanceof zza)) {
            Iterator v13 = arg12.zzbui.iterator();
            if(!v13.hasNext()) {
            }
            else {
                v13.next().getKey();
    ...
    static final void zzb(StringBuilder arg4, int arg5, String arg6, Object arg7) {
        ...
        if((arg7 instanceof List)) {
            ...
            while(v7.hasNext()) {
                zzaas.zzb(arg4, arg5, arg6, v7.next());
            }
        ...
        if((arg7 instanceof String)) {
            arg4.append(": \"");
            arg4.append(zzabl.zza(zzzb.zzfn(((String)arg7))));
            arg4.append(v1_1);
            return;
        }

        if((arg7 instanceof zzzb)) {
            arg4.append(": \"");
            arg4.append(zzabl.zza(((zzzb)arg7)));
            arg4.append(v1_1);
            return;
        }

        if((arg7 instanceof zzzv)) {
            arg4.append(" {");
            zzaas.zza(((zzaaq)arg7), arg4, arg5 + 2);
            arg4.append("\n");
            goto label_55;
        }
        ...
        if((arg7 instanceof Map$Entry)) {
            arg4.append(" {");
            int v6 = arg5 + 2;
            zzaas.zzb(arg4, v6, "key", ((Map$Entry)arg7).getKey());
            zzaas.zzb(arg4, v6, "value", ((Map$Entry)arg7).getValue());
            arg4.append("\n");
        }
        else {
            arg4.append(": ");
    ...
    private static final String zzfp(String arg4) {
        StringBuilder v0 = new StringBuilder();
        int v1;
