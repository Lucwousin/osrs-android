...
@KeepForSdk public class BaseImplementation {
    @KeepForSdk public abstract class ApiMethodImpl extends BasePendingResult implements ResultHolder {
        ...
        @KeepForSdk @Deprecated protected ApiMethodImpl(@NonNull AnyClientKey arg2, @NonNull GoogleApiClient arg3) {
            super(Preconditions.checkNotNull(arg3, "GoogleApiClient must not be null"));
            this.mClientKey = Preconditions.checkNotNull(arg2);
            this.mApi = null;
        }

        @KeepForSdk protected ApiMethodImpl(@NonNull Api arg2, @NonNull GoogleApiClient arg3) {
            super(Preconditions.checkNotNull(arg3, "GoogleApiClient must not be null"));
        ...
        @VisibleForTesting @KeepForSdk protected ApiMethodImpl(@NonNull CallbackHandler arg1) {
            super(arg1);
            this.mClientKey = null;
            this.mApi = null;
        }

        @KeepForSdk protected abstract void doExecute(@NonNull AnyClient arg1) throws RemoteException;
        ...
        @KeepForSdk protected void onSetFailedResult(@NonNull Result arg1) {
        }

        @KeepForSdk public final void run(@NonNull AnyClient arg2) throws DeadObjectException {
            SimpleClient v2;
        ...
        @KeepForSdk private void setFailedResult(@NonNull RemoteException arg4) {
            this.setFailedResult(new Status(8, arg4.getLocalizedMessage(), null));
        }

        @KeepForSdk public final void setFailedResult(@NonNull Status arg3) {
