...
public final class zza extends Fragment implements LifecycleFragment {
    ...
    public final void addCallback(String arg3, @NonNull LifecycleCallback arg4) {
        if(!this.zzbe.containsKey(arg3)) {
            ...
            if(this.zzbf > 0) {
                new zze(Looper.getMainLooper()).post(new zzb(this, arg4, arg3));
            }
    ...
    public static zza zza(Activity arg3) {
        zza v0_2;
        Object v0 = zza.zzbd.get(arg3);
        if(v0 != null) {
        ...
        if(((zza)v0_1).isRemoving()) {
        label_12:
            v0_2 = new zza();
            arg3.getFragmentManager().beginTransaction().add(((Fragment)v0_2), "LifecycleFragmentImpl").commitAllowingStateLoss();
        }

        zza.zzbd.put(arg3, new WeakReference(v0_2));
        return v0_2;
    }

    static int zza(zza arg0) {
        return arg0.zzbf;
    }

    static Bundle zzb(zza arg0) {
        return arg0.zzbg;
    }
}
