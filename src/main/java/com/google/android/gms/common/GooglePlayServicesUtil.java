...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    @HideFirstParty @Deprecated public static int isGooglePlayServicesAvailable(Context arg0) {
        return GooglePlayServicesUtilLight.isGooglePlayServicesAvailable(arg0);
    }

    @KeepForSdk @Deprecated public static int isGooglePlayServicesAvailable(Context arg0, int arg1) {
        return GooglePlayServicesUtilLight.isGooglePlayServicesAvailable(arg0, arg1);
    }
    ...
    public static boolean showErrorDialogFragment(int arg2, Activity arg3, Fragment arg4, int arg5, DialogInterface$OnCancelListener arg6) {
        ...
        Dialog v2 = GoogleApiAvailability.zaa(((Context)arg3), arg2, DialogRedirect.getInstance(arg4, GoogleApiAvailability.getInstance().getErrorResolutionIntent(((Context)arg3), arg2, "d"), arg5), arg6);
        if(v2 == null) {
            return 0;
        }

        GoogleApiAvailability.zaa(arg3, v2, "GooglePlayServicesErrorDialog", arg6);
        return 1;
    }
