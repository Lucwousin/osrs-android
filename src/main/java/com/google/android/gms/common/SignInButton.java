...
public final class SignInButton extends FrameLayout implements View$OnClickListener {
    ...
    public SignInButton(Context arg2, AttributeSet arg3, int arg4) {
        ...
        this.zaat = null;
        TypedArray v2 = arg2.getTheme().obtainStyledAttributes(arg3, R$styleable.SignInButton, 0, 0);
        try {
            this.mSize = v2.getInt(R$styleable.SignInButton_buttonSize, 0);
            this.mColor = v2.getInt(R$styleable.SignInButton_colorScheme, 2);
        }
        catch(Throwable v3) {
            v2.recycle();
            throw v3;
    ...
    public final void onClick(View arg2) {
        if(this.zaat != null && arg2 == this.zaas) {
    ...
    public final void setStyle(int arg3, int arg4) {
        ...
        try {
            this.zaas = SignInButtonCreator.createView(v3, this.mSize, this.mColor);
        }
