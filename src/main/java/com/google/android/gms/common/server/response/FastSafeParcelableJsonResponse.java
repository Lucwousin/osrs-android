...
@KeepForSdk @ShowFirstParty public abstract class FastSafeParcelableJsonResponse extends FastJsonResponse implements SafeParcelable {
    @KeepForSdk public FastSafeParcelableJsonResponse() {
        super();
    }
    ...
    public boolean equals(Object arg6) {
        ...
        label_11:
            ...
            if(((FastJsonResponse)this).isFieldSet(((Field)v3))) {
                if(((FastJsonResponse)arg6).isFieldSet(((Field)v3))) {
                    if(((FastJsonResponse)this).getFieldValue(((Field)v3)).equals(((FastJsonResponse)arg6).getFieldValue(((Field)v3)))) {
                        goto label_11;
                    }
    ...
    public int hashCode() {
        ...
        int v1;
        for(v1 = 0; v0.hasNext(); v1 = v1 * 0x1F + ((FastJsonResponse)this).getFieldValue(((Field)v2)).hashCode()) {
            Object v2 = v0.next();
    ...
    @KeepForSdk public byte[] toByteArray() {
