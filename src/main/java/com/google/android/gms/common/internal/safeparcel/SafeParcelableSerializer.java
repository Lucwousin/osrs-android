...
@KeepForSdk @VisibleForTesting public final class SafeParcelableSerializer {
    public SafeParcelableSerializer() {
        super();
    }

    @KeepForSdk public static SafeParcelable deserializeFromBytes(byte[] arg3, Parcelable$Creator arg4) {
    ...
    @KeepForSdk public static SafeParcelable deserializeFromIntentExtra(Intent arg0, String arg1, Parcelable$Creator arg2) {
    ...
    @KeepForSdk public static ArrayList deserializeIterableFromIntentExtra(Intent arg3, String arg4, Parcelable$Creator arg5) {
    ...
    @KeepForSdk public static void serializeIterableToIntentExtra(Iterable arg2, Intent arg3, String arg4) {
        ArrayList v0 = new ArrayList();
        Iterator v2 = arg2.iterator();
        while(v2.hasNext()) {
            v0.add(SafeParcelableSerializer.serializeToBytes(v2.next()));
    ...
    @KeepForSdk public static byte[] serializeToBytes(SafeParcelable arg2) {
        Parcel v0 = Parcel.obtain();
    ...
    @KeepForSdk public static void serializeToIntentExtra(SafeParcelable arg0, Intent arg1, String arg2) {
