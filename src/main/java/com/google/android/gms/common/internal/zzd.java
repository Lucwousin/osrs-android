...
public final class zzd implements Parcelable$Creator {
    ...
    public final Object createFromParcel(Parcel arg17) {
        ...
        label_36:
            ...
            continue;
        label_38:
            v10_1 = SafeParcelReader.createTypedArray(v0, v2, Scope.CREATOR);
            continue;
        label_22:
            v15 = SafeParcelReader.readBoolean(v0, v2);
            continue;
        label_24:
            Object[] v14_1 = SafeParcelReader.createTypedArray(v0, v2, Feature.CREATOR);
            continue;
        label_42:
        ...
        label_44:
            ...
            continue;
        label_28:
            v13_1 = SafeParcelReader.createTypedArray(v0, v2, Feature.CREATOR);
            continue;
        label_46:
        ...
        label_48:
            ...
            continue;
        label_32:
            v12_1 = SafeParcelReader.createParcelable(v0, v2, Account.CREATOR);
        }

        SafeParcelReader.ensureAtEnd(v0, v1);
        return new GetServiceRequest(v5, v6, v7, v8, v9, ((Scope[])v10_1), v11, ((Account)v12_1), ((Feature[])v13_1), v14, v15);
    }
