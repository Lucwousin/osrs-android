...
public final class zai implements Parcelable$Creator {
    public zai() {
        super();
    }
    ...
    public final Object createFromParcel(Parcel arg6) {
        ...
        while(arg6.dataPosition() < v0) {
            ...
            continue;
        label_10:
            v2_1 = SafeParcelReader.createParcelable(arg6, v3, ResolveAccountRequest.CREATOR);
            continue;
        label_13:
        ...
        return new zah(v1, ((ResolveAccountRequest)v2_1));
    }
