...
public final class IdentityProviders {
    ...
    @Nullable public static final String getIdentityProviderForAccount(@NonNull Account arg2) {
        Preconditions.checkNotNull(arg2, "account cannot be null");
        if("com.google".equals(arg2.type)) {
            return "https://accounts.google.com";
        }

        if("com.facebook.auth.login".equals(arg2.type)) {
