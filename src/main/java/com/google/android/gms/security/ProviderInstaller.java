...
public class ProviderInstaller {
    ...
    static {
        ProviderInstaller.zziu = GoogleApiAvailabilityLight.getInstance();
        ProviderInstaller.lock = new Object();
        ProviderInstaller.zziv = null;
    }
    ...
    public static void installIfNeeded(Context arg8) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        Preconditions.checkNotNull(arg8, "Context must not be null");
        ProviderInstaller.zziu.verifyGooglePlayServicesIsAvailable(arg8, 11925000);
        int v0 = 8;
        int v1 = 6;
        try {
        ...
        throw new GooglePlayServicesNotAvailableException(v0);
    label_18:
        Object v2 = ProviderInstaller.lock;
        __monitor_enter(v2);
        try {
            if(ProviderInstaller.zziv == null) {
                ProviderInstaller.zziv = arg8.getClassLoader().loadClass("com.google.android.gms.common.security.ProviderInstallerImpl").getMethod("insertProvider", Context.class);
            }

            ProviderInstaller.zziv.invoke(null, arg8);
        }
        catch(Exception v8) {
