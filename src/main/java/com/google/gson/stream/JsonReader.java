...
public class JsonReader implements Closeable {
    ...
    label_149:
        ...
        v1 = 0x7D;
        if(v0 == v12) {
            v3 = this.nextNonWhitespace(true);
            if(v3 != v9) {
                if(v3 == v8) {
                    this.checkLenient();
                }
                                ...
                                if(v9 != 1) {
                                    if(v9 == 0) {
                                        ...
                                        if(v9 != v15) {
                                            ...
                                            long v4_1 = 10 * v11 - (((long)(v14 - 0x30)));
                                            v7 = Long.compare(v11, -922337203685477580L);
                                            if(v7 <= 0) {
                                                if(v7 == 0 && v4_1 < v11) {
                                                    goto label_61;
                                                }
    ...
    private char readEscapeCharacter() throws IOException {
        ...
        if(v0_1 == v1_1) {
            ...
            if(v0_1 != 98) {
                ...
                label_37:
                    int v3 = 4;
                    if(this.pos + v3 > this.limit) {
                        if(this.fillBuffer(v3)) {
                        }
                        else {
                            throw this.syntaxError("Unterminated escape sequence");
                        }
