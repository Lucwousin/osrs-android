...
public final class GsonBuilder {
    ...
    public Gson create() {
        ArrayList v1 = new ArrayList(this.factories.size() + this.hierarchyFactories.size() + 3);
        ((List)v1).addAll(this.factories);
        Collections.reverse(((List)v1));
        ArrayList v2 = new ArrayList(this.hierarchyFactories);
        Collections.reverse(((List)v2));
        ((List)v1).addAll(((Collection)v2));
        this.addTypeAdaptersForDate(this.datePattern, this.dateStyle, this.timeStyle, ((List)v1));
