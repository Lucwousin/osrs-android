...
public final class AsyncLayoutInflater {
    class androidx.asynclayoutinflater.view.AsyncLayoutInflater$1 implements Handler$Callback {
        androidx.asynclayoutinflater.view.AsyncLayoutInflater$1(AsyncLayoutInflater arg1) {
    ...
    public AsyncLayoutInflater(@NonNull Context arg2) {
        super();
        this.mHandlerCallback = new androidx.asynclayoutinflater.view.AsyncLayoutInflater$1(this);
