...
public abstract class Lifecycle {
    ...
    public enum State {
        ...
        public boolean isAtLeast(@NonNull State arg1) {
    ...
    @MainThread public abstract void addObserver(@NonNull LifecycleObserver arg1);

    @MainThread @NonNull public abstract State getCurrentState();

    @MainThread public abstract void removeObserver(@NonNull LifecycleObserver arg1);
}
