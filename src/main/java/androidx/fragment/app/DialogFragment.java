...
public class DialogFragment extends Fragment implements DialogInterface$OnCancelListener, DialogInterface$OnDismissListener {
    ...
    public void onActivityCreated(@Nullable Bundle arg3) {
    ...
    @NonNull public Dialog onCreateDialog(@Nullable Bundle arg3) {
    ...
    @NonNull public LayoutInflater onGetLayoutInflater(@Nullable Bundle arg2) {
        if(!this.mShowsDialog) {
    ...
    public void onSaveInstanceState(@NonNull Bundle arg3) {
    ...
    public void showNow(FragmentManager arg2, String arg3) {
        this.mDismissed = false;
        this.mShownByMe = true;
        FragmentTransaction v2 = arg2.beginTransaction();
        v2.add(((Fragment)this), arg3);
