...
public class FragmentActivity extends ComponentActivity implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator, ViewModelStoreOwner {
    class androidx.fragment.app.FragmentActivity$1 extends Handler {
        androidx.fragment.app.FragmentActivity$1(FragmentActivity arg1) {
    ...
    public FragmentActivity() {
        super();
        this.mHandler = new androidx.fragment.app.FragmentActivity$1(this);
    ...
    public void dump(String arg3, FileDescriptor arg4, PrintWriter arg5, String[] arg6) {
        ...
        if(this.getApplication() != null) {
            LoaderManager.getInstance(((LifecycleOwner)this)).dump(v0_1, arg4, arg5, arg6);
        }
    ...
    @NonNull public ViewModelStore getViewModelStore() {
        if(this.getApplication() != null) {
            if(this.mViewModelStore == null) {
                Object v0 = this.getLastNonConfigurationInstance();
                if(v0 != null) {
                    this.mViewModelStore = ((NonConfigurationInstances)v0).viewModelStore;
                }
    ...
    private static boolean markState(FragmentManager arg4, State arg5) {
        Iterator v4 = arg4.getFragments().iterator();
        int v0;
        for(v0 = 0; v4.hasNext(); v0 |= FragmentActivity.markState(v1_1, arg5)) {
            Object v1 = v4.next();
            if(v1 == null) {
                continue;
            }

            if(((Fragment)v1).getLifecycle().getCurrentState().isAtLeast(State.STARTED)) {
                ((Fragment)v1).mLifecycleRegistry.markState(arg5);
                v0 = 1;
            }

            FragmentManager v1_1 = ((Fragment)v1).peekChildFragmentManager();
            if(v1_1 == null) {
                continue;
            }
        }
    ...
    protected void onActivityResult(int arg4, int arg5, @Nullable Intent arg6) {
        ...
        PermissionCompatDelegate v0_2 = ActivityCompat.getPermissionCompatDelegate();
        if(v0_2 != null && (v0_2.onActivityResult(((Activity)this), arg4, arg5, arg6))) {
            return;
        }
    ...
    protected void onCreate(@Nullable Bundle arg7) {
        ...
        super.onCreate(arg7);
        Object v0 = this.getLastNonConfigurationInstance();
        if(v0 != null && ((NonConfigurationInstances)v0).viewModelStore != null && this.mViewModelStore == null) {
            this.mViewModelStore = ((NonConfigurationInstances)v0).viewModelStore;
        }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if(v1 == null && this.mViewModelStore == null && v0 == null) {
            return null;
        }

        NonConfigurationInstances v2 = new NonConfigurationInstances();
        v2.custom = v0;
        v2.viewModelStore = this.mViewModelStore;
        v2.fragments = v1;
        return v2;
    }
    ...
    public void startIntentSenderForResult(IntentSender arg2, int arg3, @Nullable Intent arg4, int arg5, int arg6, int arg7, Bundle arg8) throws IntentSender$SendIntentException {
        if(!this.mStartedIntentSenderFromFragment && arg3 != -1) {
            FragmentActivity.checkForValidRequestCode(arg3);
        }
    ...
    public void startIntentSenderFromFragment(Fragment arg12, IntentSender arg13, int arg14, @Nullable Intent arg15, int arg16, int arg17, int arg18, Bundle arg19) throws IntentSender$SendIntentException {
        ...
        try {
            FragmentActivity.checkForValidRequestCode(arg14);
            ActivityCompat.startIntentSenderForResult(this, arg13, (this.allocateRequestIndex(arg12) + 1 << 16) + (v0 & 0xFFFF), arg15, arg16, arg17, arg18, arg19);
        }
        catch(Throwable v0_1) {
        label_37:
            v9.mStartedIntentSenderFromFragment = false;
