...
public class NotificationCompat {
    public class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getBigContentViewLayoutResource(int arg2) {
            return arg2 <= 3 ? R$layout.notification_template_big_media_narrow_custom : R$layout.notification_template_big_media_custom;
        }

        int getContentViewLayoutResource() {
            int v0 = this.mBuilder.getContentView() != null ? R$layout.notification_template_media_custom : super.getContentViewLayoutResource();
            return v0;
        }
        ...
        private void setBackgroundColor(RemoteViews arg4) {
            int v0 = this.mBuilder.getColor() != 0 ? this.mBuilder.getColor() : this.mBuilder.mContext.getResources().getColor(R$color.notification_material_background_media_default_color);
            arg4.setInt(R$id.status_bar_latest_event_content, "setBackgroundColor", v0);
        }
    }
    ...
    public class MediaStyle extends Style {
        ...
        RemoteViews generateBigContentView() {
            ...
            v1.removeAllViews(R$id.media_actions);
            if(v0 > 0) {
                int v3;
                for(v3 = 0; v3 < v0; ++v3) {
                    v1.addView(R$id.media_actions, this.generateMediaActionButton(this.mBuilder.mActions.get(v3)));
                }
            }

            if(this.mShowCancelButton) {
                v1.setViewVisibility(R$id.cancel_action, 0);
                v1.setInt(R$id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(R$integer.cancel_button_image_alpha));
                v1.setOnClickPendingIntent(R$id.cancel_action, this.mCancelButtonIntent);
            }
            else {
                v1.setViewVisibility(R$id.cancel_action, 8);
            }
        ...
        RemoteViews generateContentView() {
            ...
            v0.removeAllViews(R$id.media_actions);
            if(v4 > 0) {
                int v5 = 0;
                while(true) {
                    if(v5 < v4) {
                        if(v5 < v3) {
                            v0.addView(R$id.media_actions, this.generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[v5])));
                            ++v5;
                            continue;
                        }
                        else {
        ...
        label_43:
            v3 = 8;
            if(this.mShowCancelButton) {
                v0.setViewVisibility(R$id.end_padder, v3);
                v0.setViewVisibility(R$id.cancel_action, 0);
                v0.setOnClickPendingIntent(R$id.cancel_action, this.mCancelButtonIntent);
                v0.setInt(R$id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(R$integer.cancel_button_image_alpha));
            }
            else {
                v0.setViewVisibility(R$id.end_padder, 0);
                v0.setViewVisibility(R$id.cancel_action, v3);
            }
        ...
        private RemoteViews generateMediaActionButton(Action arg5) {
            ...
            RemoteViews v1 = new RemoteViews(this.mBuilder.mContext.getPackageName(), R$layout.notification_media_action);
            v1.setImageViewResource(R$id.action0, arg5.getIcon());
            if(v0 == 0) {
                v1.setOnClickPendingIntent(R$id.action0, arg5.getActionIntent());
            }

            if(Build$VERSION.SDK_INT >= 15) {
                v1.setContentDescription(R$id.action0, arg5.getTitle());
            }
        ...
        int getBigContentViewLayoutResource(int arg2) {
            return arg2 <= 3 ? R$layout.notification_template_big_media_narrow : R$layout.notification_template_big_media;
        }
        ...
        public static Token getMediaSession(Notification arg2) {
            Bundle v2 = androidx.core.app.NotificationCompat.getExtras(arg2);
            if(v2 != null) {
                if(Build$VERSION.SDK_INT >= 21) {
