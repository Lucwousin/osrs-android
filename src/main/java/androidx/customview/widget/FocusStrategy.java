    ...
    private static boolean isCandidate(@NonNull Rect arg3, @NonNull Rect arg4, int arg5) {
        ...
        if(arg5 != 17) {
            if(arg5 != 33) {
                if(arg5 != 66) {
                    if(arg5 == 130) {
                        if(arg3.top >= arg4.top && arg3.bottom > arg4.top) {
                            goto label_20;
                        }
                        else if(arg3.bottom < arg4.bottom) {
                        }
                        else {
                        label_20:
                            v1 = false;
                ...
                if(arg3.left >= arg4.left && arg3.right > arg4.left) {
                    goto label_36;
                }
                else if(arg3.right < arg4.right) {
                }
                else {
                label_36:
                    v1 = false;
            ...
            if(arg3.bottom <= arg4.bottom && arg3.top < arg4.bottom) {
                goto label_48;
            }
            else if(arg3.top > arg4.top) {
            }
            else {
            label_48:
                v1 = false;
        ...
        if(arg3.right <= arg4.right && arg3.left < arg4.right) {
            goto label_60;
        }
        else if(arg3.left > arg4.left) {
        }
        else {
        label_60:
            v1 = false;
