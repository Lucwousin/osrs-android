...
public class ViewDragHelper {
    final class androidx.customview.widget.ViewDragHelper$1 implements Interpolator {
    ...
    class androidx.customview.widget.ViewDragHelper$2 implements Runnable {
        androidx.customview.widget.ViewDragHelper$2(ViewDragHelper arg1) {
    ...
    public abstract class Callback {
        ...
        public int getViewHorizontalDragRange(@NonNull View arg1) {
            return 0;
        }
        ...
        public void onViewCaptured(@NonNull View arg1, int arg2) {
        }

        public void onViewDragStateChanged(int arg1) {
        }

        public void onViewPositionChanged(@NonNull View arg1, int arg2, int arg3, @Px int arg4, @Px int arg5) {
        }

        public void onViewReleased(@NonNull View arg1, float arg2, float arg3) {
        }
    ...
    static {
        ViewDragHelper.sInterpolator = new androidx.customview.widget.ViewDragHelper$1();
    }

    private ViewDragHelper(@NonNull Context arg2, @NonNull ViewGroup arg3, @NonNull Callback arg4) {
        super();
        this.mActivePointerId = -1;
        this.mSetIdleRunnable = new androidx.customview.widget.ViewDragHelper$2(this);
        if(arg3 != null) {
            if(arg4 != null) {
    ...
    protected boolean canScroll(@NonNull View arg14, boolean arg15, int arg16, int arg17, int arg18, int arg19) {
        View v0 = arg14;
        boolean v2 = true;
        if((v0 instanceof ViewGroup)) {
            View v1 = v0;
            int v3 = arg14.getScrollX();
            int v4 = arg14.getScrollY();
            int v5;
            for(v5 = ((ViewGroup)v1).getChildCount() - 1; v5 >= 0; --v5) {
                ...
                if(v6 >= v7.getLeft() && v6 < v7.getRight()) {
                    int v8 = arg19 + v4;
                    if(v8 >= v7.getTop() && v8 < v7.getBottom() && (this.canScroll(v7, true, arg16, arg17, v6 - v7.getLeft(), v8 - v7.getTop()))) {
                        return 1;
                    }
                }
            }
        ...
        else if(!arg14.canScrollHorizontally(-arg16)) {
            if(arg14.canScrollVertically(-arg17)) {
            }
            else {
                goto label_45;
            }
    ...
    public void captureChildView(@NonNull View arg3, int arg4) {
    ...
    public static ViewDragHelper create(@NonNull ViewGroup arg1, float arg2, @NonNull Callback arg3) {
        ViewDragHelper v1 = ViewDragHelper.create(arg1, arg3);
        v1.mTouchSlop = ((int)((((float)v1.mTouchSlop)) * (1f / arg2)));
        return v1;
    }

    public static ViewDragHelper create(@NonNull ViewGroup arg2, @NonNull Callback arg3) {
    ...
    @Nullable public View findTopChildUnder(int arg4, int arg5) {
        int v0;
    ...
    public void flingCapturedView(int arg11, int arg12, int arg13, int arg14) {
        if(this.mReleaseInProgress) {
            this.mScroller.fling(this.mCapturedView.getLeft(), this.mCapturedView.getTop(), ((int)this.mVelocityTracker.getXVelocity(this.mActivePointerId)), ((int)this.mVelocityTracker.getYVelocity(this.mActivePointerId)), arg11, arg13, arg12, arg14);
            this.setDragState(2);
            return;
        }
    ...
    @Nullable public View getCapturedView() {
        return this.mCapturedView;
    }

    @Px public int getEdgeSize() {
    ...
    public boolean isViewUnder(@Nullable View arg3, int arg4, int arg5) {
        boolean v0 = false;
        if(arg3 == null) {
            return 0;
        }
    ...
    public void processTouchEvent(@NonNull MotionEvent arg10) {
        int v10_1;
        float v1_1;
        float v0_1;
    ...
    public boolean shouldInterceptTouchEvent(@NonNull MotionEvent arg17) {
        int v1_2;
        float v7;
    ...
    public boolean smoothSlideViewTo(@NonNull View arg1, int arg2, int arg3) {
