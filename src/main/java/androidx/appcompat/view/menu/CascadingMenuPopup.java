...
final class CascadingMenuPopup extends MenuPopup implements View$OnKeyListener, PopupWindow$OnDismissListener, MenuPresenter {
    class androidx.appcompat.view.menu.CascadingMenuPopup$1 implements ViewTreeObserver$OnGlobalLayoutListener {
        androidx.appcompat.view.menu.CascadingMenuPopup$1(CascadingMenuPopup arg1) {
    ...
    class androidx.appcompat.view.menu.CascadingMenuPopup$2 implements View$OnAttachStateChangeListener {
        androidx.appcompat.view.menu.CascadingMenuPopup$2(CascadingMenuPopup arg1) {
            CascadingMenuPopup.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.view.menu.CascadingMenuPopup$3 implements MenuItemHoverListener {
        androidx.appcompat.view.menu.CascadingMenuPopup$3(CascadingMenuPopup arg1) {
            CascadingMenuPopup.this = arg1;
            super();
        }

        public void onItemHoverEnter(@NonNull MenuBuilder arg6, @NonNull MenuItem arg7) {
            Object v1 = null;
            ...
            while(true) {
                ...
                else if(arg6 == CascadingMenuPopup.this.mShowingMenus.get(v2).menu) {
                }
                else {
                    ++v2;
                    continue;
        ...
        label_19:
            ...
            CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new Runnable(((CascadingMenuInfo)v1), arg7, arg6) {
                public void run() {
    ...
    static {
        CascadingMenuPopup.ITEM_LAYOUT = R$layout.abc_cascading_menu_item_layout;
    }
    ...
    public CascadingMenuPopup(@NonNull Context arg2, @NonNull View arg3, @AttrRes int arg4, @StyleRes int arg5, boolean arg6) {
        ...
        this.mMenuMaxWidth = Math.max(v2.getDisplayMetrics().widthPixels / 2, v2.getDimensionPixelSize(R$dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder arg15) {
        int v12;
        View v6;
        Object v1_1;
        LayoutInflater v0 = LayoutInflater.from(this.mContext);
        MenuAdapter v1 = new MenuAdapter(arg15, v0, this.mOverflowOnly, CascadingMenuPopup.ITEM_LAYOUT);
        if(!this.isShowing() && (this.mForceShowIcon)) {
            v1.setForceShowIcon(true);
        }
        else if(this.isShowing()) {
            v1.setForceShowIcon(MenuPopup.shouldPreserveIconSpacing(arg15));
        }
        ...
        if(this.mShowingMenus.size() > 0) {
            ...
            v6 = this.findParentViewForSubmenu(((CascadingMenuInfo)v1_1), arg15);
        }
        else {
            v1_1 = v5;
            v6 = ((View)v1_1);
        ...
        if(v6 != null) {
            ...
            if(Build$VERSION.SDK_INT >= 26) {
                ...
                if((this.mDropDownGravity & 7) == v11) {
                    v10[0] += this.mAnchorView.getWidth();
                    v8_1[0] += v6.getWidth();
                }
            ...
            if((this.mDropDownGravity & v11) == v11) {
                if(v9 != 0) {
                    v12 += v2;
                }
                else {
        ...
        this.mShowingMenus.add(new CascadingMenuInfo(v4, arg15, this.mLastPosition));
        v4.show();
        ListView v2_1 = v4.getListView();
        v2_1.setOnKeyListener(((View$OnKeyListener)this));
        if(v1_1 == null && (this.mShowTitle) && arg15.getHeaderTitle() != null) {
            View v0_1 = v0.inflate(R$layout.abc_popup_menu_header_item_layout, ((ViewGroup)v2_1), false);
            View v1_2 = ((FrameLayout)v0_1).findViewById(0x1020016);
            ((FrameLayout)v0_1).setEnabled(false);
            ((TextView)v1_2).setText(arg15.getHeaderTitle());
