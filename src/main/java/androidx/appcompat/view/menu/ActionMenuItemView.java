...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ActionMenuItemView extends AppCompatTextView implements View$OnClickListener, ItemView, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context arg4, AttributeSet arg5, int arg6) {
        ...
        TypedArray v4 = arg4.obtainStyledAttributes(arg5, R$styleable.ActionMenuItemView, arg6, 0);
        this.mMinWidth = v4.getDimensionPixelSize(R$styleable.ActionMenuItemView_android_minWidth, 0);
        v4.recycle();
