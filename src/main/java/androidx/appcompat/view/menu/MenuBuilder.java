...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class MenuBuilder implements SupportMenu {
    ...
    public MenuBuilder(Context arg3) {
        super();
    ...
    private static int getOrdering(int arg2) {
        ...
        if(v0 >= 0 && v0 < MenuBuilder.sCategoryToOrder.length) {
    ...
    public void setGroupDividerEnabled(boolean arg1) {
        this.mGroupDividerEnabled = arg1;
    }
    ...
    private void setShortcutsVisibleInner(boolean arg3) {
        boolean v0 = true;
        if(!arg3 || this.mResources.getConfiguration().keyboard == 1 || !ViewConfigurationCompat.shouldShowMenuShortcutsWhenKeyboardPresent(ViewConfiguration.get(this.mContext), this.mContext)) {
            v0 = false;
        }
        else {
        }
