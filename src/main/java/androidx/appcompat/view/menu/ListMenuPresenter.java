...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ListMenuPresenter implements AdapterView$OnItemClickListener, MenuPresenter {
    ...
    public MenuView getMenuView(ViewGroup arg4) {
        if(this.mMenuView == null) {
            this.mMenuView = this.mInflater.inflate(R$layout.abc_expanded_menu_layout, arg4, false);
            if(this.mAdapter == null) {
                this.mAdapter = new MenuAdapter(this);
            }
