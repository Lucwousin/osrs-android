...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public final class MenuItemImpl implements SupportMenuItem {
    ...
    private static void appendModifier(StringBuilder arg0, int arg1, int arg2, String arg3) {
        if((arg1 & arg2) == arg2) {
            arg0.append(arg3);
        }
    }
    ...
    String getShortcutLabel() {
        ...
        Resources v1 = this.mMenu.getContext().getResources();
        StringBuilder v2 = new StringBuilder();
        if(ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            v2.append(v1.getString(R$string.abc_prepend_shortcut_label));
        }

        int v3 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        MenuItemImpl.appendModifier(v2, v3, 0x10000, v1.getString(R$string.abc_menu_meta_shortcut_label));
        MenuItemImpl.appendModifier(v2, v3, 0x1000, v1.getString(R$string.abc_menu_ctrl_shortcut_label));
        MenuItemImpl.appendModifier(v2, v3, 2, v1.getString(R$string.abc_menu_alt_shortcut_label));
        MenuItemImpl.appendModifier(v2, v3, 1, v1.getString(R$string.abc_menu_shift_shortcut_label));
        MenuItemImpl.appendModifier(v2, v3, 4, v1.getString(R$string.abc_menu_sym_shortcut_label));
        MenuItemImpl.appendModifier(v2, v3, 8, v1.getString(R$string.abc_menu_function_shortcut_label));
        if(v0 == 8) {
            v2.append(v1.getString(R$string.abc_menu_delete_shortcut_label));
        }
        else if(v0 == 10) {
            v2.append(v1.getString(R$string.abc_menu_enter_shortcut_label));
        }
        else if(v0 != 0x20) {
            v2.append(v0);
        }
        else {
            v2.append(v1.getString(R$string.abc_menu_space_shortcut_label));
        }
