...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class SupportMenuInflater extends MenuInflater {
    ...
    class MenuState {
        ...
        public void readGroup(AttributeSet arg3) {
            TypedArray v3 = SupportMenuInflater.this.mContext.obtainStyledAttributes(arg3, R$styleable.MenuGroup);
            this.groupId = v3.getResourceId(R$styleable.MenuGroup_android_id, 0);
            this.groupCategory = v3.getInt(R$styleable.MenuGroup_android_menuCategory, 0);
            this.groupOrder = v3.getInt(R$styleable.MenuGroup_android_orderInCategory, 0);
            this.groupCheckable = v3.getInt(R$styleable.MenuGroup_android_checkableBehavior, 0);
            this.groupVisible = v3.getBoolean(R$styleable.MenuGroup_android_visible, true);
            this.groupEnabled = v3.getBoolean(R$styleable.MenuGroup_android_enabled, true);
            v3.recycle();
        }

        public void readItem(AttributeSet arg7) {
            TypedArray v7 = SupportMenuInflater.this.mContext.obtainStyledAttributes(arg7, R$styleable.MenuItem);
            this.itemId = v7.getResourceId(R$styleable.MenuItem_android_id, 0);
            this.itemCategoryOrder = v7.getInt(R$styleable.MenuItem_android_menuCategory, this.groupCategory) & 0xFFFF0000 | v7.getInt(R$styleable.MenuItem_android_orderInCategory, this.groupOrder) & 0xFFFF;
            this.itemTitle = v7.getText(R$styleable.MenuItem_android_title);
            this.itemTitleCondensed = v7.getText(R$styleable.MenuItem_android_titleCondensed);
            this.itemIconResId = v7.getResourceId(R$styleable.MenuItem_android_icon, 0);
            this.itemAlphabeticShortcut = this.getShortcut(v7.getString(R$styleable.MenuItem_android_alphabeticShortcut));
            this.itemAlphabeticModifiers = v7.getInt(R$styleable.MenuItem_alphabeticModifiers, 0x1000);
            this.itemNumericShortcut = this.getShortcut(v7.getString(R$styleable.MenuItem_android_numericShortcut));
            this.itemNumericModifiers = v7.getInt(R$styleable.MenuItem_numericModifiers, 0x1000);
            this.itemCheckable = v7.hasValue(R$styleable.MenuItem_android_checkable) ? v7.getBoolean(R$styleable.MenuItem_android_checkable, false) : this.groupCheckable;
            this.itemChecked = v7.getBoolean(R$styleable.MenuItem_android_checked, false);
            this.itemVisible = v7.getBoolean(R$styleable.MenuItem_android_visible, this.groupVisible);
            this.itemEnabled = v7.getBoolean(R$styleable.MenuItem_android_enabled, this.groupEnabled);
            int v2 = -1;
            this.itemShowAsAction = v7.getInt(R$styleable.MenuItem_showAsAction, v2);
            this.itemListenerMethodName = v7.getString(R$styleable.MenuItem_android_onClick);
            this.itemActionViewLayout = v7.getResourceId(R$styleable.MenuItem_actionLayout, 0);
            this.itemActionViewClassName = v7.getString(R$styleable.MenuItem_actionViewClass);
            this.itemActionProviderClassName = v7.getString(R$styleable.MenuItem_actionProviderClass);
            ...
            this.itemContentDescription = v7.getText(R$styleable.MenuItem_contentDescription);
            this.itemTooltipText = v7.getText(R$styleable.MenuItem_tooltipText);
            this.itemIconTintMode = v7.hasValue(R$styleable.MenuItem_iconTintMode) ? DrawableUtils.parseTintMode(v7.getInt(R$styleable.MenuItem_iconTintMode, v2), this.itemIconTintMode) : ((PorterDuff$Mode)v3);
            this.itemIconTintList = v7.hasValue(R$styleable.MenuItem_iconTint) ? v7.getColorStateList(R$styleable.MenuItem_iconTint) : ((ColorStateList)v3);
            v7.recycle();
    ...
    public void inflate(@LayoutRes int arg3, Menu arg4) {
