...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ViewPropertyAnimatorCompatSet {
    class androidx.appcompat.view.ViewPropertyAnimatorCompatSet$1 extends ViewPropertyAnimatorListenerAdapter {
        private int mProxyEndCount;
        private boolean mProxyStarted;

        androidx.appcompat.view.ViewPropertyAnimatorCompatSet$1(ViewPropertyAnimatorCompatSet arg1) {
