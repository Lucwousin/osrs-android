...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context arg7) {
        ...
        TypedArray v7 = arg7.getTheme().obtainStyledAttributes(null, R$styleable.DrawerArrowToggle, R$attr.drawerArrowStyle, R$style.Base_Widget_AppCompat_DrawerArrowToggle);
        this.setColor(v7.getColor(R$styleable.DrawerArrowToggle_color, 0));
        this.setBarThickness(v7.getDimension(R$styleable.DrawerArrowToggle_thickness, 0f));
        this.setSpinEnabled(v7.getBoolean(R$styleable.DrawerArrowToggle_spinBars, true));
        this.setGapSize(((float)Math.round(v7.getDimension(R$styleable.DrawerArrowToggle_gapBetweenBars, 0f))));
        this.mSize = v7.getDimensionPixelSize(R$styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = ((float)Math.round(v7.getDimension(R$styleable.DrawerArrowToggle_barLength, 0f)));
        this.mArrowHeadLength = ((float)Math.round(v7.getDimension(R$styleable.DrawerArrowToggle_arrowHeadLength, 0f)));
        this.mArrowShaftLength = v7.getDimension(R$styleable.DrawerArrowToggle_arrowShaftLength, 0f);
        v7.recycle();
    }
    ...
    label_16:
        ...
        int v18 = v5;
        v3_1 = ((float)Math.round(Math.cos(v10) * v13_1));
