...
public final class AppCompatResources {
    ...
    private static void addColorStateListToCache(@NonNull Context arg3, @ColorRes int arg4, @NonNull ColorStateList arg5) {
        ...
        try {
            ...
            ((SparseArray)v1).append(arg4, new ColorStateListCacheEntry(arg5, arg3.getResources().getConfiguration()));
            __monitor_exit(v0);
            return;
        label_17:
            __monitor_exit(v0);
    ...
    @Nullable private static ColorStateList inflateColorStateList(Context arg2, int arg3) {
        ...
        try {
            return ColorStateListInflaterCompat.createFromXml(v0, ((XmlPullParser)v3), arg2.getTheme());
        }
        catch(Exception v2) {
