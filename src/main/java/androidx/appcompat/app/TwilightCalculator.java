...
class TwilightCalculator {
    ...
    public void calculateTwilight(long arg17, double arg19, double arg21) {
        TwilightCalculator v0 = this;
        long v2 = 946728000000L;
        float v4 = (((float)(arg17 - v2))) / 86400000f;
        ...
        double v7_1 = ((double)(((float)(Math.acos(v10) / 6.283185))));
        v0.sunset = Math.round((v4_1 + v7_1) * 86400000) + v2;
        v0.sunrise = Math.round((v4_1 - v7_1) * 86400000) + v2;
        v0.state = v0.sunrise >= arg17 || v0.sunset <= arg17 ? 1 : 0;
    }
