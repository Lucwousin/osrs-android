...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    class androidx.appcompat.app.WindowDecorActionBar$1 extends ViewPropertyAnimatorListenerAdapter {
        androidx.appcompat.app.WindowDecorActionBar$1(WindowDecorActionBar arg1) {
    ...
    class androidx.appcompat.app.WindowDecorActionBar$2 extends ViewPropertyAnimatorListenerAdapter {
        androidx.appcompat.app.WindowDecorActionBar$2(WindowDecorActionBar arg1) {
            WindowDecorActionBar.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.app.WindowDecorActionBar$3 implements ViewPropertyAnimatorUpdateListener {
        androidx.appcompat.app.WindowDecorActionBar$3(WindowDecorActionBar arg1) {
            WindowDecorActionBar.this = arg1;
            super();
        }
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public class ActionModeImpl extends ActionMode implements Callback {
        ...
        public ActionModeImpl(WindowDecorActionBar arg1, Context arg2, androidx.appcompat.view.ActionMode$Callback arg3) {
            WindowDecorActionBar.this = arg1;
            super();
    ...
    public Context getThemedContext() {
        if(this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(R$attr.actionBarWidgetTheme, v0, true);
    ...
    private void init(View arg6) {
        this.mOverlayLayout = arg6.findViewById(R$id.decor_content_parent);
        if(this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(((ActionBarVisibilityCallback)this));
        }

        this.mDecorToolbar = this.getDecorToolbar(arg6.findViewById(R$id.action_bar));
        this.mContextView = arg6.findViewById(R$id.action_context_bar);
        this.mContainerView = arg6.findViewById(R$id.action_bar_container);
        if(this.mDecorToolbar != null && this.mContextView != null && this.mContainerView != null) {
            ...
            TypedArray v6_2 = this.mContext.obtainStyledAttributes(null, R$styleable.ActionBar, R$attr.actionBarStyle, 0);
            if(v6_2.getBoolean(R$styleable.ActionBar_hideOnContentScroll, false)) {
                this.setHideOnContentScrollEnabled(true);
            }

            int v0 = v6_2.getDimensionPixelSize(R$styleable.ActionBar_elevation, 0);
            if(v0 != 0) {
    ...
    public void setDisplayOptions(int arg3, int arg4) {
        ...
        this.mDecorToolbar.setDisplayOptions(arg3 & arg4 | ~arg4 & v0);
    }
    ...
    public ActionMode startActionMode(androidx.appcompat.view.ActionMode$Callback arg3) {
        if(this.mActionMode != null) {
