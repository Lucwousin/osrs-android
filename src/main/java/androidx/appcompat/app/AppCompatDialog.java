...
public class AppCompatDialog extends Dialog implements AppCompatCallback {
    class androidx.appcompat.app.AppCompatDialog$1 implements Component {
        androidx.appcompat.app.AppCompatDialog$1(AppCompatDialog arg1) {
            AppCompatDialog.this = arg1;
            super();
        }

        public boolean superDispatchKeyEvent(KeyEvent arg2) {
            return AppCompatDialog.this.superDispatchKeyEvent(arg2);
        }
    }
    ...
    public AppCompatDialog(Context arg1, int arg2) {
        ...
        this.mKeyDispatcher = new androidx.appcompat.app.AppCompatDialog$1(this);
    ...
    public boolean dispatchKeyEvent(KeyEvent arg3) {
        return KeyEventDispatcher.dispatchKeyEvent(this.mKeyDispatcher, this.getWindow().getDecorView(), ((Window$Callback)this), arg3);
    }
    ...
    private static int getThemeResId(Context arg2, int arg3) {
        if(arg3 == 0) {
            ...
            arg2.getTheme().resolveAttribute(R$attr.dialogTheme, v3, true);
            arg3 = v3.resourceId;
        }
