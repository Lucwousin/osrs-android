...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(R$attr.actionModeShareDrawable, v1, true);
        ...
        v0.setDefaultActionButtonContentDescription(R$string.abc_shareactionprovider_share_with_application);
        v0.setExpandActivityOverflowButtonContentDescription(R$string.abc_shareactionprovider_share_with);
        return ((View)v0);
    }
    ...
    public void onPrepareSubMenu(SubMenu arg9) {
        ...
        if(v3 < v2) {
            arg9 = arg9.addSubMenu(0, v3, v3, this.mContext.getString(R$string.abc_activity_chooser_view_see_all));
            for(v3 = 0; v3 < v2; ++v3) {
