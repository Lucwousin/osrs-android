...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    class androidx.appcompat.widget.ActivityChooserView$1 extends DataSetObserver {
        androidx.appcompat.widget.ActivityChooserView$1(ActivityChooserView arg1) {
    ...
    class androidx.appcompat.widget.ActivityChooserView$2 implements ViewTreeObserver$OnGlobalLayoutListener {
        androidx.appcompat.widget.ActivityChooserView$2(ActivityChooserView arg1) {
            ActivityChooserView.this = arg1;
            super();
        }
    ...
    class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        label_7:
            if(arg7 == null || arg7.getId() != 1) {
                arg7 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R$layout.abc_activity_chooser_view_list_item, arg8, false);
                arg7.setId(1);
                arg7.findViewById(R$id.title).setText(ActivityChooserView.this.getContext().getString(R$string.abc_activity_chooser_view_see_all));
            }

            return arg7;
        label_24:
            if(arg7 == null || arg7.getId() != R$id.list_item) {
                arg7 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R$layout.abc_activity_chooser_view_list_item, arg8, false);
            }

            PackageManager v8 = ActivityChooserView.this.getContext().getPackageManager();
            View v0 = arg7.findViewById(R$id.icon);
            Object v3 = this.getItem(arg6);
            ((ImageView)v0).setImageDrawable(((ResolveInfo)v3).loadIcon(v8));
            arg7.findViewById(R$id.title).setText(((ResolveInfo)v3).loadLabel(v8));
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public class InnerLayout extends LinearLayout {
    ...
    public ActivityChooserView(Context arg4, AttributeSet arg5, int arg6) {
        ...
        this.mModelDataSetObserver = new androidx.appcompat.widget.ActivityChooserView$1(this);
        this.mOnGlobalLayoutListener = new androidx.appcompat.widget.ActivityChooserView$2(this);
        this.mInitialActivityCount = 4;
        TypedArray v5 = arg4.obtainStyledAttributes(arg5, R$styleable.ActivityChooserView, arg6, 0);
        this.mInitialActivityCount = v5.getInt(R$styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable v6 = v5.getDrawable(R$styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        v5.recycle();
        ...
        this.mDefaultActivityButton = this.findViewById(R$id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = this.mDefaultActivityButton.findViewById(R$id.image);
        View v5_1 = this.findViewById(R$id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = ((FrameLayout)v5_1).findViewById(R$id.image);
        ...
        this.mListPopupMaxWidth = Math.max(v4.getDisplayMetrics().widthPixels / 2, v4.getDimensionPixelSize(R$dimen.abc_config_prefDialogWidth));
    }
    ...
    protected void onMeasure(int arg3, int arg4) {
        View v0 = this.mActivityChooserContent;
    ...
    void showPopupUnchecked(int arg6) {
        if(this.mAdapter.getDataModel() != null) {
            ...
            if(!v6.isShowing()) {
                ...
                v6.getListView().setContentDescription(this.getContext().getString(R$string.abc_activitychooserview_choose_application));
