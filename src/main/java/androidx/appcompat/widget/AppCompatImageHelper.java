...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet arg4, int arg5) {
        TintTypedArray v4 = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), arg4, R$styleable.AppCompatImageView, arg5, 0);
        try {
            Drawable v5_1 = this.mView.getDrawable();
            int v0 = -1;
            if(v5_1 == null) {
                int v1 = v4.getResourceId(R$styleable.AppCompatImageView_srcCompat, v0);
                if(v1 != v0) {
            ...
            if(v4.hasValue(R$styleable.AppCompatImageView_tint)) {
                ImageViewCompat.setImageTintList(this.mView, v4.getColorStateList(R$styleable.AppCompatImageView_tint));
            }

            if(v4.hasValue(R$styleable.AppCompatImageView_tintMode)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(v4.getInt(R$styleable.AppCompatImageView_tintMode, v0), null));
            }
        }
        catch(Throwable v5) {
            v4.recycle();
