...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar arg3, boolean arg4) {
        this(arg3, arg4, R$string.abc_action_bar_up_description, R$drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar arg4, boolean arg5, int arg6, int arg7) {
        ...
        TintTypedArray v4 = TintTypedArray.obtainStyledAttributes(arg4.getContext(), null, R$styleable.ActionBar, R$attr.actionBarStyle, 0);
        this.mDefaultNavigationIcon = v4.getDrawable(R$styleable.ActionBar_homeAsUpIndicator);
        if(arg5) {
            CharSequence v5 = v4.getText(R$styleable.ActionBar_title);
            if(!TextUtils.isEmpty(v5)) {
                this.setTitle(v5);
            }

            v5 = v4.getText(R$styleable.ActionBar_subtitle);
            if(!TextUtils.isEmpty(v5)) {
                this.setSubtitle(v5);
            }

            Drawable v5_1 = v4.getDrawable(R$styleable.ActionBar_logo);
            if(v5_1 != null) {
                this.setLogo(v5_1);
            }

            v5_1 = v4.getDrawable(R$styleable.ActionBar_icon);
            if(v5_1 != null) {
                this.setIcon(v5_1);
            }
            ...
            this.setDisplayOptions(v4.getInt(R$styleable.ActionBar_displayOptions, 0));
            int v5_2 = v4.getResourceId(R$styleable.ActionBar_customNavigationLayout, 0);
            if(v5_2 != 0) {
            ...
            v5_2 = v4.getLayoutDimension(R$styleable.ActionBar_height, 0);
            if(v5_2 > 0) {
            ...
            v5_2 = v4.getDimensionPixelOffset(R$styleable.ActionBar_contentInsetStart, -1);
            int v0_2 = v4.getDimensionPixelOffset(R$styleable.ActionBar_contentInsetEnd, -1);
            if(v5_2 >= 0 || v0_2 >= 0) {
                this.mToolbar.setContentInsetsRelative(Math.max(v5_2, 0), Math.max(v0_2, 0));
            }

            v5_2 = v4.getResourceId(R$styleable.ActionBar_titleTextStyle, 0);
            if(v5_2 != 0) {
                this.mToolbar.setTitleTextAppearance(this.mToolbar.getContext(), v5_2);
            }

            v5_2 = v4.getResourceId(R$styleable.ActionBar_subtitleTextStyle, 0);
            if(v5_2 != 0) {
                this.mToolbar.setSubtitleTextAppearance(this.mToolbar.getContext(), v5_2);
            }

            v5_2 = v4.getResourceId(R$styleable.ActionBar_popupTheme, 0);
            if(v5_2 == 0) {
                goto label_106;
            }
    ...
    public void setMenuCallbacks(Callback arg2, androidx.appcompat.view.menu.MenuBuilder$Callback arg3) {
    ...
    public void setNavigationContentDescription(int arg2) {
        ...
        if(arg2 == 0) {
            ...
            String v2_1 = this.getContext().getString(arg2);
        }
