...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context arg3, AttributeSet arg4, int arg5) {
        ...
        TypedArray v3 = arg3.obtainStyledAttributes(arg4, R$styleable.ViewStubCompat, arg5, 0);
        this.mInflatedId = v3.getResourceId(R$styleable.ViewStubCompat_android_inflatedId, -1);
        this.mLayoutResource = v3.getResourceId(R$styleable.ViewStubCompat_android_layout, 0);
        this.setId(v3.getResourceId(R$styleable.ViewStubCompat_android_id, -1));
        v3.recycle();
