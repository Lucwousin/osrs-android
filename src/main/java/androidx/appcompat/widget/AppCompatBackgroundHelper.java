...
class AppCompatBackgroundHelper {
    ...
    void loadFromAttributes(AttributeSet arg4, int arg5) {
        TintTypedArray v4 = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), arg4, R$styleable.ViewBackgroundHelper, arg5, 0);
        try {
            int v0 = -1;
            if(v4.hasValue(R$styleable.ViewBackgroundHelper_android_background)) {
                this.mBackgroundResId = v4.getResourceId(R$styleable.ViewBackgroundHelper_android_background, v0);
            ...
            if(v4.hasValue(R$styleable.ViewBackgroundHelper_backgroundTint)) {
                ViewCompat.setBackgroundTintList(this.mView, v4.getColorStateList(R$styleable.ViewBackgroundHelper_backgroundTint));
            }

            if(v4.hasValue(R$styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(v4.getInt(R$styleable.ViewBackgroundHelper_backgroundTintMode, v0), null));
            }
        }
        catch(Throwable v5) {
            v4.recycle();
