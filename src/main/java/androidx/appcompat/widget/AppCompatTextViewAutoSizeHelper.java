...
class AppCompatTextViewAutoSizeHelper {
    ...
    @RequiresApi(value=23) private StaticLayout createStaticLayoutForMeasuring(CharSequence arg5, Layout$Alignment arg6, int arg7, int arg8) {
    ...
    private StaticLayout createStaticLayoutForMeasuringPre23(CharSequence arg12, Layout$Alignment arg13, int arg14) {
        boolean v2;
        float v1;
        float v0;
    ...
    private Object invokeAndReturnWithDefault(@NonNull Object arg5, @NonNull String arg6, @NonNull Object arg7) {
        try {
            arg5 = this.getTextViewMethod(arg6).invoke(arg5);
        }
        catch(Throwable v5) {
        }
    ...
    void loadFromAttributes(AttributeSet arg7, int arg8) {
        TypedArray v7 = this.mContext.obtainStyledAttributes(arg7, R$styleable.AppCompatTextView, arg8, 0);
        if(v7.hasValue(R$styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = v7.getInt(R$styleable.AppCompatTextView_autoSizeTextType, 0);
        }

        float v0 = -1f;
        float v8 = v7.hasValue(R$styleable.AppCompatTextView_autoSizeStepGranularity) ? v7.getDimension(R$styleable.AppCompatTextView_autoSizeStepGranularity, v0) : -1f;
        float v1 = v7.hasValue(R$styleable.AppCompatTextView_autoSizeMinTextSize) ? v7.getDimension(R$styleable.AppCompatTextView_autoSizeMinTextSize, v0) : -1f;
        float v3 = v7.hasValue(R$styleable.AppCompatTextView_autoSizeMaxTextSize) ? v7.getDimension(R$styleable.AppCompatTextView_autoSizeMaxTextSize, v0) : -1f;
        if(v7.hasValue(R$styleable.AppCompatTextView_autoSizePresetSizes)) {
            int v4 = v7.getResourceId(R$styleable.AppCompatTextView_autoSizePresetSizes, 0);
            if(v4 > 0) {
        ...
        if(!this.supportsAutoSizeText()) {
            ...
            if(!this.mHasPresetAutoSizeValues) {
                ...
                int v2 = 2;
                if(v1 == v0) {
                    v1 = TypedValue.applyDimension(v2, 12f, v7_1);
                }

                if(v3 == v0) {
                    v3 = TypedValue.applyDimension(v2, 112f, v7_1);
                }
    ...
    private boolean suggestedSizeFitsInSpace(int arg6, RectF arg7) {
        ...
        TransformationMethod v1 = this.mTextView.getTransformationMethod();
        if(v1 != null) {
            CharSequence v1_1 = v1.getTransformation(v0, this.mTextView);
            if(v1_1 != null) {
                v0 = v1_1;
            }
        }
        ...
        int v3 = -1;
        int v1_2 = Build$VERSION.SDK_INT >= 16 ? this.mTextView.getMaxLines() : -1;
        ...
        StaticLayout v6_1 = Build$VERSION.SDK_INT >= 23 ? this.createStaticLayoutForMeasuring(v0, ((Layout$Alignment)v6), Math.round(arg7.right), v1_2) : this.createStaticLayoutForMeasuringPre23(v0, ((Layout$Alignment)v6), Math.round(arg7.right));
