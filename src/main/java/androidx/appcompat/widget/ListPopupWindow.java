...
public class ListPopupWindow implements ShowableListMenu {
    ...
    public ListPopupWindow(@NonNull Context arg3) {
        this(arg3, null, R$attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context arg2, @Nullable AttributeSet arg3) {
        this(arg2, arg3, R$attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context arg5, @Nullable AttributeSet arg6, @AttrRes int arg7, @StyleRes int arg8) {
        ...
        TypedArray v2 = arg5.obtainStyledAttributes(arg6, R$styleable.ListPopupWindow, arg7, arg8);
        this.mDropDownHorizontalOffset = v2.getDimensionPixelOffset(R$styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = v2.getDimensionPixelOffset(R$styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        if(this.mDropDownList == null) {
            ...
            this.mPopup.setContentView(((View)v5));
        }
        else {
