...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context arg2, AttributeSet arg3) {
        this(arg2, arg3, R$attr.actionModeStyle);
    }

    public ActionBarContextView(Context arg3, AttributeSet arg4, int arg5) {
        super(arg3, arg4, arg5);
        TintTypedArray v3 = TintTypedArray.obtainStyledAttributes(arg3, arg4, R$styleable.ActionMode, arg5, 0);
        ViewCompat.setBackground(((View)this), v3.getDrawable(R$styleable.ActionMode_background));
        this.mTitleStyleRes = v3.getResourceId(R$styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = v3.getResourceId(R$styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = v3.getLayoutDimension(R$styleable.ActionMode_height, 0);
        this.mCloseItemLayout = v3.getResourceId(R$styleable.ActionMode_closeItemLayout, R$layout.abc_action_mode_close_item_material);
        v3.recycle();
    }
    ...
    public void initForMode(ActionMode arg4) {
        ...
        this.mClose.findViewById(R$id.action_mode_close_button).setOnClickListener(new View$OnClickListener(arg4) {
    ...
    private void initTitle() {
        if(this.mTitleLayout == null) {
            ...
            this.mTitleView = this.mTitleLayout.findViewById(R$id.action_bar_title);
