...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context arg3, AttributeSet arg4) {
        ...
        TypedArray v3 = arg3.obtainStyledAttributes(arg4, R$styleable.ActionBar);
        this.mBackground = v3.getDrawable(R$styleable.ActionBar_background);
        this.mStackedBackground = v3.getDrawable(R$styleable.ActionBar_backgroundStacked);
        this.mHeight = v3.getDimensionPixelSize(R$styleable.ActionBar_height, -1);
        if(this.getId() == R$id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = v3.getDrawable(R$styleable.ActionBar_backgroundSplit);
        }
