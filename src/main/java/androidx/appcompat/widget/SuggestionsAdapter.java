...
class SuggestionsAdapter extends ResourceCursorAdapter implements View$OnClickListener {
    final class ChildViewCache {
        ...
        public ChildViewCache(View arg2) {
            ...
            this.mIconRefine = arg2.findViewById(R$id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence arg9) {
        if(this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(R$attr.textColorSearchUrl, v0, true);
    ...
    Drawable getDrawableFromResourceUri(Uri arg8) throws FileNotFoundException {
        ...
        try {
            v1 = this.mContext.getPackageManager().getResourcesForApplication(v0);
        }
    ...
    public View newView(Context arg1, Cursor arg2, ViewGroup arg3) {
        ...
        v1.findViewById(R$id.edit_query).setImageResource(this.mCommitIconResId);
        return v1;
    }
