...
class AppCompatCompoundButtonHelper {
    ...
    void loadFromAttributes(AttributeSet arg4, int arg5) {
        TypedArray v4 = this.mView.getContext().obtainStyledAttributes(arg4, R$styleable.CompoundButton, arg5, 0);
        try {
            if(v4.hasValue(R$styleable.CompoundButton_android_button)) {
                arg5 = v4.getResourceId(R$styleable.CompoundButton_android_button, 0);
                if(arg5 != 0) {
                    this.mView.setButtonDrawable(AppCompatResources.getDrawable(this.mView.getContext(), arg5));
                }
            }

            if(v4.hasValue(R$styleable.CompoundButton_buttonTint)) {
                CompoundButtonCompat.setButtonTintList(this.mView, v4.getColorStateList(R$styleable.CompoundButton_buttonTint));
            }

            if(v4.hasValue(R$styleable.CompoundButton_buttonTintMode)) {
                CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(v4.getInt(R$styleable.CompoundButton_buttonTintMode, -1), null));
            }
        }
        catch(Throwable v5) {
            v4.recycle();
