...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView$OnItemSelectedListener {
    ...
    class TabView extends LinearLayout {
        ...
        public TabView(ScrollingTabContainerView arg4, Context arg5, Tab arg6, boolean arg7) {
            ...
            super(arg5, null, R$attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{0x10100D4};
            this.mTab = arg6;
            TintTypedArray v4 = TintTypedArray.obtainStyledAttributes(arg5, null, this.BG_ATTRS, R$attr.actionBarTabStyle, 0);
            if(v4.hasValue(0)) {
        ...
        public void update() {
            ...
            label_55:
                ...
                if(v1_2 != 0) {
                    if(this.mTextView == null) {
                        AppCompatTextView v2_1 = new AppCompatTextView(this.getContext(), ((AttributeSet)v3), R$attr.actionBarTabTextStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner v0 = new AppCompatSpinner(this.getContext(), null, R$attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat v0 = new LinearLayoutCompat(this.getContext(), null, R$attr.actionBarTabBarStyle);
