...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context arg3, AttributeSet arg4, int arg5) {
        ...
        this.mPopupContext = !arg3.getTheme().resolveAttribute(R$attr.actionBarPopupTheme, v4, true) || v4.resourceId == 0 ? arg3 : new ContextThemeWrapper(arg3, v4.resourceId);
    }
    ...
    protected void onConfigurationChanged(Configuration arg6) {
        ...
        TypedArray v0 = this.getContext().obtainStyledAttributes(null, R$styleable.ActionBar, R$attr.actionBarStyle, 0);
        this.setContentHeight(v0.getLayoutDimension(R$styleable.ActionBar_height, 0));
        v0.recycle();
        if(this.mActionMenuPresenter != null) {
