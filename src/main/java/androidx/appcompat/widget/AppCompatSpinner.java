...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(@Nullable SpinnerAdapter arg3, @Nullable Resources$Theme arg4) {
            ...
            if(arg4 != null) {
                ...
                if(!(arg3 instanceof androidx.appcompat.widget.ThemedSpinnerAdapter)) {
                    return;
                }

                if(((androidx.appcompat.widget.ThemedSpinnerAdapter)arg3).getDropDownViewTheme() != null) {
                    return;
                }

                ((androidx.appcompat.widget.ThemedSpinnerAdapter)arg3).setDropDownViewTheme(arg4);
            }
        }
    ...
    class DropdownPopup extends ListPopupWindow {
        ...
        static void access$001(DropdownPopup arg0) {
            super.show();
        }
        ...
        public void show() {
            ...
            if(v0_1 != null) {
                androidx.appcompat.widget.AppCompatSpinner$DropdownPopup$2 v1 = new ViewTreeObserver$OnGlobalLayoutListener() {
    ...
    public AppCompatSpinner(Context arg2, AttributeSet arg3) {
        this(arg2, arg3, R$attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context arg3, int arg4) {
        this(arg3, null, R$attr.spinnerStyle, arg4);
    }
    ...
    public AppCompatSpinner(Context arg8, AttributeSet arg9, int arg10, int arg11, Resources$Theme arg12) {
        ...
        TintTypedArray v0 = TintTypedArray.obtainStyledAttributes(arg8, arg9, R$styleable.Spinner, arg10, 0);
        ...
        if(arg12 != null) {
            ...
            int v12 = v0.getResourceId(R$styleable.Spinner_popupTheme, 0);
            if(v12 != 0) {
    ...
    label_60:
        if(arg11 == 1) {
            ...
            TintTypedArray v12_3 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, arg9, R$styleable.Spinner, arg10, 0);
            this.mDropDownWidth = v12_3.getLayoutDimension(R$styleable.Spinner_android_dropDownWidth, -2);
            v11.setBackgroundDrawable(v12_3.getDrawable(R$styleable.Spinner_android_popupBackground));
            v11.setPromptText(v0.getString(R$styleable.Spinner_android_prompt));
            v12_3.recycle();
            this.mPopup = v11;
    ...
    label_82:
        CharSequence[] v11_1 = v0.getTextArray(R$styleable.Spinner_android_entries);
        if(v11_1 != null) {
            ArrayAdapter v12_4 = new ArrayAdapter(arg8, 0x1090008, ((Object[])v11_1));
            v12_4.setDropDownViewResource(R$layout.support_simple_spinner_dropdown_item);
