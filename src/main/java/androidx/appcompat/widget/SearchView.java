...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    class androidx.appcompat.widget.SearchView$10 implements TextWatcher {
        androidx.appcompat.widget.SearchView$10(SearchView arg1) {
    ...
    class androidx.appcompat.widget.SearchView$1 implements Runnable {
        androidx.appcompat.widget.SearchView$1(SearchView arg1) {
            SearchView.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.widget.SearchView$2 implements Runnable {
        androidx.appcompat.widget.SearchView$2(SearchView arg1) {
            SearchView.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.widget.SearchView$5 implements View$OnClickListener {
        androidx.appcompat.widget.SearchView$5(SearchView arg1) {
            SearchView.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.widget.SearchView$6 implements View$OnKeyListener {
        androidx.appcompat.widget.SearchView$6(SearchView arg1) {
            SearchView.this = arg1;
            super();
        }
        ...
        public boolean onKey(View arg4, int arg5, KeyEvent arg6) {
            ...
            if(!SearchView.this.mSearchSrcTextView.isEmpty() && (arg6.hasNoModifiers()) && arg6.getAction() == 1 && arg5 == 66) {
    ...
    class androidx.appcompat.widget.SearchView$7 implements TextView$OnEditorActionListener {
        androidx.appcompat.widget.SearchView$7(SearchView arg1) {
            SearchView.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.widget.SearchView$8 implements AdapterView$OnItemClickListener {
        androidx.appcompat.widget.SearchView$8(SearchView arg1) {
            SearchView.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.widget.SearchView$9 implements AdapterView$OnItemSelectedListener {
        androidx.appcompat.widget.SearchView$9(SearchView arg1) {
            SearchView.this = arg1;
            super();
        }
    ...
    class SavedState extends AbsSavedState {
        final class androidx.appcompat.widget.SearchView$SavedState$1 implements Parcelable$ClassLoaderCreator {
        ...
        static {
            SavedState.CREATOR = new androidx.appcompat.widget.SearchView$SavedState$1();
        }
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        class androidx.appcompat.widget.SearchView$SearchAutoComplete$1 implements Runnable {
            androidx.appcompat.widget.SearchView$SearchAutoComplete$1(SearchAutoComplete arg1) {
        ...
        public SearchAutoComplete(Context arg1, AttributeSet arg2, int arg3) {
            ...
            this.mRunShowSoftInputIfNecessary = new androidx.appcompat.widget.SearchView$SearchAutoComplete$1(this);
    ...
    public SearchView(Context arg2, AttributeSet arg3) {
        this(arg2, arg3, R$attr.searchViewStyle);
    }
    ...
    public SearchView(Context arg4, AttributeSet arg5, int arg6) {
        ...
        this.mUpdateDrawableStateRunnable = new androidx.appcompat.widget.SearchView$1(this);
        this.mReleaseCursorRunnable = new androidx.appcompat.widget.SearchView$2(this);
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new androidx.appcompat.widget.SearchView$5(this);
        this.mTextKeyListener = new androidx.appcompat.widget.SearchView$6(this);
        this.mOnEditorActionListener = new androidx.appcompat.widget.SearchView$7(this);
        this.mOnItemClickListener = new androidx.appcompat.widget.SearchView$8(this);
        this.mOnItemSelectedListener = new androidx.appcompat.widget.SearchView$9(this);
        this.mTextWatcher = new androidx.appcompat.widget.SearchView$10(this);
        TintTypedArray v5 = TintTypedArray.obtainStyledAttributes(arg4, arg5, R$styleable.SearchView, arg6, 0);
        LayoutInflater.from(arg4).inflate(v5.getResourceId(R$styleable.SearchView_layout, R$layout.abc_search_view), ((ViewGroup)this), true);
        this.mSearchSrcTextView = this.findViewById(R$id.search_src_text);
        ...
        this.mGoButton = this.findViewById(R$id.search_go_btn);
        this.mCloseButton = this.findViewById(R$id.search_close_btn);
        this.mVoiceButton = this.findViewById(R$id.search_voice_btn);
        this.mCollapsedIcon = this.findViewById(R$id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, v5.getDrawable(R$styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, v5.getDrawable(R$styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(v5.getDrawable(R$styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(v5.getDrawable(R$styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(v5.getDrawable(R$styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(v5.getDrawable(R$styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(v5.getDrawable(R$styleable.SearchView_searchIcon));
        this.mSearchHintIcon = v5.getDrawable(R$styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, this.getResources().getString(R$string.abc_searchview_description_search));
        this.mSuggestionRowLayout = v5.getResourceId(R$styleable.SearchView_suggestionRowLayout, R$layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = v5.getResourceId(R$styleable.SearchView_commitIcon, 0);
        ...
        this.setIconifiedByDefault(v5.getBoolean(R$styleable.SearchView_iconifiedByDefault, true));
        arg6 = -1;
        int v4 = v5.getDimensionPixelSize(R$styleable.SearchView_android_maxWidth, arg6);
        if(v4 != arg6) {
            this.setMaxWidth(v4);
        }

        this.mDefaultQueryHint = v5.getText(R$styleable.SearchView_defaultQueryHint);
        this.mQueryHint = v5.getText(R$styleable.SearchView_queryHint);
        v4 = v5.getInt(R$styleable.SearchView_android_imeOptions, arg6);
        if(v4 != arg6) {
            this.setImeOptions(v4);
        }

        v4 = v5.getInt(R$styleable.SearchView_android_inputType, arg6);
        if(v4 != arg6) {
            this.setInputType(v4);
        }

        this.setFocusable(v5.getBoolean(R$styleable.SearchView_android_focusable, true));
        v5.recycle();
    ...
    void adjustDropDownSizeAndPosition() {
        if(this.mDropDownAnchor.getWidth() > 1) {
            ...
            int v4 = this.mIconifiedByDefault ? v0.getDimensionPixelSize(R$dimen.abc_dropdownitem_icon_width) + v0.getDimensionPixelSize(R$dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private void updateQueryHint() {
        ...
        v1.setHint(this.getDecoratedHint(v0));
    }
