...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    public androidx.appcompat.widget.LinearLayoutCompat$LayoutParams generateLayoutParams(AttributeSet arg1) {
        return this.generateLayoutParams(arg1);
    }

    protected androidx.appcompat.widget.LinearLayoutCompat$LayoutParams generateLayoutParams(ViewGroup$LayoutParams arg1) {
        return this.generateLayoutParams(arg1);
    }
                ...
                while(v2 < v7) {
                    ...
                    if((v26 & v6_1) != 0) {
                        if(v3 == 0 || !((LayoutParams)v5_1).preventEdgeOffset) {
                            ...
                            v6 = 1;
                            if(v14 == 1) {
                                v4_1.setPadding(v0.mGeneratedItemPadding + v9, 0, v0.mGeneratedItemPadding, 0);
                            }
                        }
    ...
    label_146:
        ...
        label_300:
            ...
            float v2_3 = ((float)Long.bitCount(v19));
            if(v3 == 0) {
                float v5_2 = 0.5f;
                if((v19 & v24_1) != 0) {
                    v3 = 0;
        ...
        label_238:
            ...
            for(v4 = 0; v4 < v2; ++v4) {
                if((v19 & (((long)(1 << v4)))) == 0) {
                    ...
                    v5_3 = v0.getChildAt(v4);
                    v6_2 = v5_3.getLayoutParams();
                    if((v5_3 instanceof ActionMenuItemView)) {
                        ((LayoutParams)v6_2).extraPixels = v8_1;
                        ((LayoutParams)v6_2).expanded = true;
                        if(v4 == 0 && !((LayoutParams)v6_2).preventEdgeOffset) {
                            ((LayoutParams)v6_2).leftMargin = -v8_1 / 2;
                        }
                    }
                    else {
                        v7 = 2;
                        if(((LayoutParams)v6_2).isOverflowButton) {
                            ((LayoutParams)v6_2).extraPixels = v8_1;
                            ((LayoutParams)v6_2).expanded = true;
                            ((LayoutParams)v6_2).rightMargin = -v8_1 / v7;
                        }
                        else {
                            goto label_288;
                        }
                ...
                label_288:
                    ...
                    ((LayoutParams)v6_2).rightMargin = v8_1 / 2;
                }
        ...
        if(v28 != 0) {
            while(v3 < v2) {
                v5_3 = v0.getChildAt(v3);
                v6_2 = v5_3.getLayoutParams();
                if(!((LayoutParams)v6_2).expanded) {
                    v7 = v32;
                }
                else {
                    v7 = v32;
                    v5_3.measure(View$MeasureSpec.makeMeasureSpec(((LayoutParams)v6_2).cellsUsed * v9 + ((LayoutParams)v6_2).extraPixels, v4), v7);
                }
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public void setMenuCallbacks(Callback arg1, androidx.appcompat.view.menu.MenuBuilder$Callback arg2) {
