...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context arg2, AttributeSet arg3) {
        ...
        TypedArray v2 = arg2.obtainStyledAttributes(arg3, R$styleable.ButtonBarLayout);
        this.mAllowStacking = v2.getBoolean(R$styleable.ButtonBarLayout_allowStacking, true);
        v2.recycle();
    }
    ...
    private void setStacked(boolean arg2) {
        ...
        int v0 = arg2 ? 5 : 80;
        this.setGravity(v0);
        View v0_1 = this.findViewById(R$id.spacer);
        if(v0_1 != null) {
            v2 = arg2 ? 8 : 4;
