...
public class Toolbar extends ViewGroup {
    class androidx.appcompat.widget.Toolbar$1 implements OnMenuItemClickListener {
        androidx.appcompat.widget.Toolbar$1(Toolbar arg1) {
            Toolbar.this = arg1;
            super();
        }
    ...
    class androidx.appcompat.widget.Toolbar$2 implements Runnable {
        androidx.appcompat.widget.Toolbar$2(Toolbar arg1) {
            Toolbar.this = arg1;
            super();
        }
    ...
    class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder arg3, MenuItemImpl arg4) {
            ...
            ViewParent v3 = Toolbar.this.mCollapseButtonView.getParent();
            if(v3 != Toolbar.this) {
                if((v3 instanceof ViewGroup)) {
                    ((ViewGroup)v3).removeView(Toolbar.this.mCollapseButtonView);
                }
            ...
            v3 = Toolbar.this.mExpandedActionView.getParent();
            if(v3 != Toolbar.this) {
                if((v3 instanceof ViewGroup)) {
                    ((ViewGroup)v3).removeView(Toolbar.this.mExpandedActionView);
                }

                LayoutParams v3_1 = Toolbar.this.generateDefaultLayoutParams();
                v3_1.gravity = 0x800003 | Toolbar.this.mButtonGravity & 0x70;
                v3_1.mViewType = 2;
                Toolbar.this.mExpandedActionView.setLayoutParams(((ViewGroup$LayoutParams)v3_1));
    ...
    public class LayoutParams extends androidx.appcompat.app.ActionBar$LayoutParams {
        ...
        public LayoutParams(LayoutParams arg2) {
            super(((androidx.appcompat.app.ActionBar$LayoutParams)arg2));
            this.mViewType = 0;
            this.mViewType = arg2.mViewType;
        }

        public LayoutParams(androidx.appcompat.app.ActionBar$LayoutParams arg1) {
            super(arg1);
            this.mViewType = 0;
        }
    ...
    public interface androidx.appcompat.widget.Toolbar$OnMenuItemClickListener {
        boolean onMenuItemClick(MenuItem arg1);
    }

    public class SavedState extends AbsSavedState {
        final class androidx.appcompat.widget.Toolbar$SavedState$1 implements Parcelable$ClassLoaderCreator {
        ...
        static {
            SavedState.CREATOR = new androidx.appcompat.widget.Toolbar$SavedState$1();
        }
    ...
    public Toolbar(Context arg2, @Nullable AttributeSet arg3) {
        this(arg2, arg3, R$attr.toolbarStyle);
    }
    ...
    public Toolbar(Context arg7, @Nullable AttributeSet arg8, int arg9) {
        ...
        this.mMenuViewItemClickListener = new androidx.appcompat.widget.Toolbar$1(this);
        this.mShowOverflowMenuRunnable = new androidx.appcompat.widget.Toolbar$2(this);
        TintTypedArray v7 = TintTypedArray.obtainStyledAttributes(this.getContext(), arg8, R$styleable.Toolbar, arg9, 0);
        this.mTitleTextAppearance = v7.getResourceId(R$styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = v7.getResourceId(R$styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = v7.getInteger(R$styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = v7.getInteger(R$styleable.Toolbar_buttonGravity, 0x30);
        int v8 = v7.getDimensionPixelOffset(R$styleable.Toolbar_titleMargin, 0);
        if(v7.hasValue(R$styleable.Toolbar_titleMargins)) {
            v8 = v7.getDimensionPixelOffset(R$styleable.Toolbar_titleMargins, v8);
        }
        ...
        arg9 = -1;
        v8 = v7.getDimensionPixelOffset(R$styleable.Toolbar_titleMarginStart, arg9);
        if(v8 >= 0) {
            this.mTitleMarginStart = v8;
        }

        v8 = v7.getDimensionPixelOffset(R$styleable.Toolbar_titleMarginEnd, arg9);
        if(v8 >= 0) {
            this.mTitleMarginEnd = v8;
        }

        v8 = v7.getDimensionPixelOffset(R$styleable.Toolbar_titleMarginTop, arg9);
        if(v8 >= 0) {
            this.mTitleMarginTop = v8;
        }

        v8 = v7.getDimensionPixelOffset(R$styleable.Toolbar_titleMarginBottom, arg9);
        if(v8 >= 0) {
            this.mTitleMarginBottom = v8;
        }

        this.mMaxButtonHeight = v7.getDimensionPixelSize(R$styleable.Toolbar_maxButtonHeight, arg9);
        int v0 = 0x80000000;
        v8 = v7.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetStart, v0);
        int v2 = v7.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetEnd, v0);
        int v3 = v7.getDimensionPixelSize(R$styleable.Toolbar_contentInsetLeft, 0);
        int v4 = v7.getDimensionPixelSize(R$styleable.Toolbar_contentInsetRight, 0);
        ...
        this.mContentInsetStartWithNavigation = v7.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetStartWithNavigation, v0);
        this.mContentInsetEndWithActions = v7.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetEndWithActions, v0);
        this.mCollapseIcon = v7.getDrawable(R$styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = v7.getText(R$styleable.Toolbar_collapseContentDescription);
        CharSequence v8_1 = v7.getText(R$styleable.Toolbar_title);
        if(!TextUtils.isEmpty(v8_1)) {
            this.setTitle(v8_1);
        }

        v8_1 = v7.getText(R$styleable.Toolbar_subtitle);
        if(!TextUtils.isEmpty(v8_1)) {
            this.setSubtitle(v8_1);
        }

        this.mPopupContext = this.getContext();
        this.setPopupTheme(v7.getResourceId(R$styleable.Toolbar_popupTheme, 0));
        Drawable v8_2 = v7.getDrawable(R$styleable.Toolbar_navigationIcon);
        if(v8_2 != null) {
            this.setNavigationIcon(v8_2);
        }

        v8_1 = v7.getText(R$styleable.Toolbar_navigationContentDescription);
        if(!TextUtils.isEmpty(v8_1)) {
            this.setNavigationContentDescription(v8_1);
        }

        v8_2 = v7.getDrawable(R$styleable.Toolbar_logo);
        if(v8_2 != null) {
            this.setLogo(v8_2);
        }

        v8_1 = v7.getText(R$styleable.Toolbar_logoDescription);
        if(!TextUtils.isEmpty(v8_1)) {
            this.setLogoDescription(v8_1);
        }

        if(v7.hasValue(R$styleable.Toolbar_titleTextColor)) {
            this.setTitleTextColor(v7.getColor(R$styleable.Toolbar_titleTextColor, arg9));
        }

        if(v7.hasValue(R$styleable.Toolbar_subtitleTextColor)) {
            this.setSubtitleTextColor(v7.getColor(R$styleable.Toolbar_subtitleTextColor, arg9));
        }
    ...
    protected LayoutParams generateLayoutParams(ViewGroup$LayoutParams arg2) {
        ...
        if((arg2 instanceof androidx.appcompat.app.ActionBar$LayoutParams)) {
            return new LayoutParams(((androidx.appcompat.app.ActionBar$LayoutParams)arg2));
        }
    ...
    protected void onMeasure(int arg17, int arg18) {
        ...
        if(v7.shouldLayout(v7.mNavButtonView)) {
            this.measureChildConstrained(v7.mNavButtonView, arg17, 0, arg18, 0, v7.mMaxButtonHeight);
        ...
        if(v7.shouldLayout(v7.mCollapseButtonView)) {
            this.measureChildConstrained(v7.mCollapseButtonView, arg17, 0, arg18, 0, v7.mMaxButtonHeight);
        ...
        if(v7.shouldLayout(v7.mMenuView)) {
            this.measureChildConstrained(v7.mMenuView, arg17, v14, arg18, 0, v7.mMaxButtonHeight);
        ...
        if(v7.shouldLayout(v7.mExpandedActionView)) {
            v10 += this.measureChildCollapseMargins(v7.mExpandedActionView, arg17, v10, arg18, 0, v8);
        ...
        if(v7.shouldLayout(v7.mLogoView)) {
            v10 += this.measureChildCollapseMargins(v7.mLogoView, arg17, v10, arg18, 0, v8);
        ...
        for(v10 = 0; v10 < v11; ++v10) {
            ...
            if(v15.getLayoutParams().mViewType == 0) {
                if(!v7.shouldLayout(v15)) {
                    ...
                    v12 += this.measureChildCollapseMargins(v15, arg17, v12, arg18, 0, v8);
        ...
        if(v7.shouldLayout(v7.mTitleTextView)) {
            this.measureChildCollapseMargins(v7.mTitleTextView, arg17, v12 + v11, arg18, v10, v8);
        ...
        if(v7.shouldLayout(v7.mSubtitleTextView)) {
            v13 = Math.max(v13, this.measureChildCollapseMargins(v7.mSubtitleTextView, arg17, v12 + v11, arg18, v15_1 + v10, v8));
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public void setMenuCallbacks(Callback arg2, androidx.appcompat.view.menu.MenuBuilder$Callback arg3) {
    ...
    public void setOnMenuItemClickListener(androidx.appcompat.widget.Toolbar$OnMenuItemClickListener arg1) {
