...
class AppCompatProgressBarHelper {
    ...
    private Drawable tileify(Drawable arg8, boolean arg9) {
        ClipDrawable v8;
        if((arg8 instanceof WrappedDrawable)) {
            Drawable v0 = arg8;
            Drawable v1 = ((WrappedDrawable)v0).getWrappedDrawable();
            if(v1 != null) {
                ((WrappedDrawable)v0).setWrappedDrawable(this.tileify(v1, arg9));
            }
        }
            ...
            if(arg9) {
                v8 = new ClipDrawable(((Drawable)v2_1), 3, 1);
            }
            else {
                ShapeDrawable v8_1 = v2_1;
            }
