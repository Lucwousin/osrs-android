...
public class SwitchCompat extends CompoundButton {
    final class androidx.appcompat.widget.SwitchCompat$1 extends Property {
        androidx.appcompat.widget.SwitchCompat$1(Class arg1, String arg2) {
            super(arg1, arg2);
        }
    ...
    static {
        SwitchCompat.THUMB_POS = new androidx.appcompat.widget.SwitchCompat$1(Float.class, "thumbPos");
    ...
    public SwitchCompat(Context arg2, AttributeSet arg3) {
        this(arg2, arg3, R$attr.switchStyle);
    }
    ...
    public SwitchCompat(Context arg6, AttributeSet arg7, int arg8) {
        ...
        TintTypedArray v7 = TintTypedArray.obtainStyledAttributes(arg6, arg7, R$styleable.SwitchCompat, arg8, 0);
        this.mThumbDrawable = v7.getDrawable(R$styleable.SwitchCompat_android_thumb);
        if(this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(((Drawable$Callback)this));
        }

        this.mTrackDrawable = v7.getDrawable(R$styleable.SwitchCompat_track);
        if(this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(((Drawable$Callback)this));
        }

        this.mTextOn = v7.getText(R$styleable.SwitchCompat_android_textOn);
        this.mTextOff = v7.getText(R$styleable.SwitchCompat_android_textOff);
        this.mShowText = v7.getBoolean(R$styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = v7.getDimensionPixelSize(R$styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = v7.getDimensionPixelSize(R$styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = v7.getDimensionPixelSize(R$styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = v7.getBoolean(R$styleable.SwitchCompat_splitTrack, false);
        ColorStateList v8 = v7.getColorStateList(R$styleable.SwitchCompat_thumbTint);
        if(v8 != null) {
        ...
        int v2 = -1;
        PorterDuff$Mode v8_1 = DrawableUtils.parseTintMode(v7.getInt(R$styleable.SwitchCompat_thumbTintMode, v2), ((PorterDuff$Mode)v0));
        ...
        v8 = v7.getColorStateList(R$styleable.SwitchCompat_trackTint);
        if(v8 != null) {
            this.mTrackTintList = v8;
            this.mHasTrackTint = true;
        }

        v8_1 = DrawableUtils.parseTintMode(v7.getInt(R$styleable.SwitchCompat_trackTintMode, v2), ((PorterDuff$Mode)v0));
        ...
        arg8 = v7.getResourceId(R$styleable.SwitchCompat_switchTextAppearance, 0);
        if(arg8 != 0) {
    ...
    public void setSwitchTextAppearance(Context arg4, int arg5) {
        TintTypedArray v4 = TintTypedArray.obtainStyledAttributes(arg4, arg5, R$styleable.TextAppearance);
        ColorStateList v5 = v4.getColorStateList(R$styleable.TextAppearance_android_textColor);
        this.mTextColors = v5 != null ? v5 : this.getTextColors();
        arg5 = v4.getDimensionPixelSize(R$styleable.TextAppearance_android_textSize, 0);
        if(arg5 != 0) {
        ...
        this.setSwitchTypefaceByIndex(v4.getInt(R$styleable.TextAppearance_android_typeface, -1), v4.getInt(R$styleable.TextAppearance_android_textStyle, -1));
        this.mSwitchTransformationMethod = v4.getBoolean(R$styleable.TextAppearance_textAllCaps, false) ? new AllCapsTransformationMethod(this.getContext()) : null;
        v4.recycle();
    }
