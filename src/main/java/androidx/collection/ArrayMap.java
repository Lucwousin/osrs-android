...
public class ArrayMap extends SimpleArrayMap implements Map {
    @Nullable MapCollections mCollections;
    ...
    public boolean containsAll(@NonNull Collection arg1) {
    ...
    public boolean removeAll(@NonNull Collection arg1) {
        return MapCollections.removeAllHelper(((Map)this), arg1);
    }

    public boolean retainAll(@NonNull Collection arg1) {
