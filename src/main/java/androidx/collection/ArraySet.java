...
public final class ArraySet implements Collection, Set {
    ...
    private int[] mHashes;
    int mSize;
    @Nullable private static Object[] sBaseCache;
    private static int sBaseCacheSize;
    @Nullable private static Object[] sTwiceBaseCache;
    ...
    public ArraySet(@Nullable ArraySet arg1) {
        this();
        if(arg1 != null) {
            this.addAll(arg1);
        }
    ...
    public ArraySet(@Nullable Collection arg1) {
        this();
        if(arg1 != null) {
            this.addAll(arg1);
        }
    ...
    public boolean add(@Nullable Object arg10) {
        int v4;
        int v2;
        int v1;
        if(arg10 == null) {
    ...
    public void addAll(@NonNull ArraySet arg5) {
        int v0 = arg5.mSize;
    ...
    public boolean addAll(@NonNull Collection arg3) {
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public void append(Object arg5) {
        int v0 = this.mSize;
        int v1 = arg5 == null ? 0 : arg5.hashCode();
    ...
    public boolean contains(@Nullable Object arg1) {
        boolean v1 = this.indexOf(arg1) >= 0 ? true : false;
        return v1;
    }

    public boolean containsAll(@NonNull Collection arg2) {
    ...
    public int indexOf(@Nullable Object arg2) {
    ...
    private int indexOf(Object arg5, int arg6) {
        ...
        int v1 = ContainerHelpers.binarySearch(this.mHashes, v0, arg6);
        if(v1 < 0) {
            return v1;
        }
        ...
        int v2 = v1 + 1;
        while(v2 < v0) {
            if(this.mHashes[v2] != arg6) {
                break;
            }

            if(arg5.equals(this.mArray[v2])) {
                return v2;
            }
            else {
                ++v2;
    ...
    private int indexOfNull() {
        ...
        int v1 = ContainerHelpers.binarySearch(this.mHashes, v0, 0);
        if(v1 < 0) {
            return v1;
        }
    ...
    public boolean remove(@Nullable Object arg1) {
    ...
    public boolean removeAll(@NonNull ArraySet arg6) {
        int v0 = arg6.mSize;
        int v1 = this.mSize;
        boolean v2 = false;
        int v3;
    ...
    public boolean removeAll(@NonNull Collection arg3) {
        Iterator v3 = arg3.iterator();
        int v0;
    ...
    public boolean retainAll(@NonNull Collection arg5) {
        int v0 = this.mSize - 1;
        boolean v2 = false;
        while(v0 >= 0) {
    ...
    @NonNull public Object[] toArray(@NonNull Object[] arg4) {
        Object v4;
    ...
    @Nullable public Object valueAt(int arg2) {
