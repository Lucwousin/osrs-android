...
public class SimpleArrayMap {
    ...
    Object[] mArray;
    @Nullable static Object[] mBaseCache;
    static int mBaseCacheSize;
    int[] mHashes;
    int mSize;
    @Nullable static Object[] mTwiceBaseCache;
    ...
    public boolean containsKey(@Nullable Object arg1) {
    ...
    @Nullable public Object get(Object arg2) {
    ...
    int indexOf(Object arg6, int arg7) {
        ...
        int v1 = SimpleArrayMap.binarySearchHashes(this.mHashes, v0, arg7);
        if(v1 < 0) {
            return v1;
        }
        ...
        while(v2 < v0) {
            ...
            if(arg6.equals(this.mArray[v2 << 1])) {
                return v2;
            }
            else {
                ++v2;
    ...
    public int indexOfKey(@Nullable Object arg2) {
    ...
    int indexOfNull() {
        ...
        int v1 = SimpleArrayMap.binarySearchHashes(this.mHashes, v0, 0);
        if(v1 < 0) {
            return v1;
        }
    ...
    @Nullable public Object put(Object arg10, Object arg11) {
        int v3;
        int v2;
        int v0 = this.mSize;
        if(arg10 == null) {
    ...
    label_50:
        ...
        if(v0 == this.mSize && v2 < this.mHashes.length) {
            this.mHashes[v2] = v3;
            int v1 = v2 << 1;
    ...
    public void putAll(@NonNull SimpleArrayMap arg5) {
        int v0 = arg5.mSize;
    ...
    @Nullable public Object remove(Object arg1) {
