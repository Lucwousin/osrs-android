...
@Deprecated public class ActionBarDrawerToggle implements DrawerListener {
    ...
    private Drawable getThemeUpIndicator() {
        ...
        if(Build$VERSION.SDK_INT >= 18) {
            ...
            v0_3 = ((Context)v0_2).obtainStyledAttributes(null, ActionBarDrawerToggle.THEME_ATTRS, 0x10102CE, 0);
    ...
    public void onDrawerSlide(View arg4, float arg5) {
        ...
        float v0 = 2f;
        float v1 = 0.5f;
        v4 = arg5 > v1 ? Math.max(v4, Math.max(0f, arg5 - v1) * v0) : Math.min(v4, arg5 * v0);
