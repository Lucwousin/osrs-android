...
public class DrawerLayout extends ViewGroup {
    ...
    public class LayoutParams extends ViewGroup$MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context arg3, @Nullable AttributeSet arg4) {
            super(arg3, arg4);
            this.gravity = 0;
        ...
        public LayoutParams(@NonNull LayoutParams arg2) {
            super(((ViewGroup$MarginLayoutParams)arg2));
            this.gravity = 0;
            this.gravity = arg2.gravity;
        }

        public LayoutParams(@NonNull ViewGroup$MarginLayoutParams arg1) {
            super(arg1);
            this.gravity = 0;
        }

        public LayoutParams(@NonNull ViewGroup$LayoutParams arg1) {
            super(arg1);
            this.gravity = 0;
        }
    ...
    public class SavedState extends AbsSavedState {
        final class androidx.drawerlayout.widget.DrawerLayout$SavedState$1 implements Parcelable$ClassLoaderCreator {
        ...
        static {
            SavedState.CREATOR = new androidx.drawerlayout.widget.DrawerLayout$SavedState$1();
        }

        public SavedState(@NonNull Parcelable arg1) {
            super(arg1);
            this.openDrawerGravity = 0;
        }

        public SavedState(@NonNull Parcel arg1, @Nullable ClassLoader arg2) {
            super(arg1, arg2);
            this.openDrawerGravity = 0;
    ...
    class ViewDragCallback extends Callback {
        class androidx.drawerlayout.widget.DrawerLayout$ViewDragCallback$1 implements Runnable {
            androidx.drawerlayout.widget.DrawerLayout$ViewDragCallback$1(ViewDragCallback arg1) {
                this.this$1 = arg1;
                super();
            }
        ...
        ViewDragCallback(DrawerLayout arg1, int arg2) {
            DrawerLayout.this = arg1;
            super();
            this.mPeekRunnable = new androidx.drawerlayout.widget.DrawerLayout$ViewDragCallback$1(this);
        ...
        public void onViewReleased(View arg6, float arg7, float arg8) {
            ...
            if(DrawerLayout.this.checkDrawerViewAbsoluteGravity(arg6, 3)) {
                v7 = Float.compare(arg7, 0f);
                if(v7 <= 0 && (v7 != 0 || arg8 <= v2)) {
                    v7 = -v0;
                    goto label_25;
                }
    ...
    public DrawerLayout(@NonNull Context arg2) {
        this(arg2, null);
    }

    public DrawerLayout(@NonNull Context arg2, @Nullable AttributeSet arg3) {
        this(arg2, arg3, 0);
    }

    public DrawerLayout(@NonNull Context arg6, @Nullable AttributeSet arg7, int arg8) {
    ...
    public void closeDrawer(@NonNull View arg5, boolean arg6) {
        ...
        v0_1.append("View ");
        v0_1.append(arg5);
        v0_1.append(" is not a sliding drawer");
        throw new IllegalArgumentException(v0_1.toString());
    }

    public void closeDrawer(@NonNull View arg2) {
        this.closeDrawer(arg2, true);
    }
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent arg7) {
        if((arg7.getSource() & 2) != 0 && arg7.getAction() != 10) {
            if(this.mScrimOpacity <= 0f) {
                ...
                if(v0 != 0) {
                    ...
                    while(v0 >= 0) {
                        ...
                        if(this.isInBoundsOfChild(v1, v2, v4)) {
                            if(this.isContentView(v4)) {
                            }
                            else if(this.dispatchTransformedGenericPointerEvent(arg7, v4)) {
                                return 1;
                            }
                        }
        ...
        return super.dispatchGenericMotionEvent(arg7);
    }
    ...
    private boolean dispatchTransformedGenericPointerEvent(MotionEvent arg4, View arg5) {
        boolean v5;
        if(!arg5.getMatrix().isIdentity()) {
            arg4 = this.getTransformedMotionEvent(arg4, arg5);
            v5 = arg5.dispatchGenericMotionEvent(arg4);
            arg4.recycle();
        }
        else {
            float v0 = ((float)(this.getScrollX() - arg5.getLeft()));
            float v1 = ((float)(this.getScrollY() - arg5.getTop()));
            arg4.offsetLocation(v0, v1);
            v5 = arg5.dispatchGenericMotionEvent(arg4);
            arg4.offsetLocation(-v0, -v1);
        }
    ...
    protected boolean drawChild(Canvas arg15, View arg16, long arg17) {
        ...
        boolean v4 = this.isContentView(v2);
        ...
        if(v4) {
            ...
            int v10 = 0;
            while(v5 < v9) {
                View v12 = this.getChildAt(v5);
                if(v12 != v2 && v12.getVisibility() == 0 && (DrawerLayout.hasOpaqueBackground(v12)) && (this.isDrawerView(v12))) {
                    if(v12.getHeight() < v3) {
                    }
                    else if(this.checkDrawerViewAbsoluteGravity(v12, v7)) {
                        v12_1 = v12.getRight();
                        if(v12_1 > v10) {
                            v10 = v12_1;
                        }
            ...
            arg15.clipRect(v10, 0, v11, this.getHeight());
            v8 = v10;
        }
        else {
            v11 = v5;
        ...
        boolean v9_1 = super.drawChild(arg15, arg16, arg17);
        arg15.restoreToCount(v6);
        if(v0.mScrimOpacity <= 0f || !v4) {
            float v4_1 = 255f;
            float v6_1 = 1f;
            if(v0.mShadowLeftResolved != null && (this.checkDrawerViewAbsoluteGravity(v2, v7))) {
                ...
                v0.mShadowLeftResolved.draw(arg15);
                return v9_1;
            }
    ...
    public int getDrawerLockMode(@NonNull View arg4) {
    ...
    @Nullable public Drawable getStatusBarBackgroundDrawable() {
        return this.mStatusBarBackground;
    }

    private MotionEvent getTransformedMotionEvent(MotionEvent arg4, View arg5) {
        float v0 = ((float)(this.getScrollX() - arg5.getLeft()));
        float v1 = ((float)(this.getScrollY() - arg5.getTop()));
        arg4 = MotionEvent.obtain(arg4);
        arg4.offsetLocation(v0, v1);
        Matrix v5 = arg5.getMatrix();
        if(!v5.isIdentity()) {
            if(this.mChildInvertedMatrix == null) {
                this.mChildInvertedMatrix = new Matrix();
            }

            v5.invert(this.mChildInvertedMatrix);
            arg4.transform(this.mChildInvertedMatrix);
        }
    ...
    public boolean isDrawerOpen(@NonNull View arg4) {
        if(this.isDrawerView(arg4)) {
            boolean v0 = true;
    ...
    public boolean isDrawerVisible(@NonNull View arg4) {
        if(this.isDrawerView(arg4)) {
    ...
    private boolean isInBoundsOfChild(float arg2, float arg3, View arg4) {
        if(this.mChildHitRect == null) {
            this.mChildHitRect = new Rect();
        }

        arg4.getHitRect(this.mChildHitRect);
        return this.mChildHitRect.contains(((int)arg2), ((int)arg3));
    }
        ...
        for(v6 = 0; v6 < v4; ++v6) {
            ...
            if(v7.getVisibility() == 8) {
                ...
                if(this.isContentView(v7)) {
                    ...
                    if(this.checkDrawerViewAbsoluteGravity(v7, 3)) {
                        float v12 = ((float)v9);
                    ...
                    if(v12_1 != 0) {
                        this.setDrawerViewOffset(v7, v13);
                    }
    ...
    @SuppressLint(value={"WrongConstant"}) protected void onMeasure(int arg18, int arg19) {
        WindowInsets v2_2;
        Object v2_1;
        View v12;
        int v7;
        DrawerLayout v0 = this;
        int v1 = View$MeasureSpec.getMode(arg18);
        int v2 = View$MeasureSpec.getMode(arg19);
        int v3 = View$MeasureSpec.getSize(arg18);
        int v4 = View$MeasureSpec.getSize(arg19);
        int v6 = 0x40000000;
        if(v1 != v6 || v2 != v6) {
    ...
    label_20:
        ...
        while(true) {
            ...
            if(v12.getVisibility() == 8) {
                ...
                if(v1 != 0) {
                    ...
                    if(!ViewCompat.getFitsSystemWindows(v12)) {
                        ...
                        ((LayoutParams)v13).leftMargin = v2_2.getSystemWindowInsetLeft();
                        ((LayoutParams)v13).topMargin = v2_2.getSystemWindowInsetTop();
                        ((LayoutParams)v13).rightMargin = v2_2.getSystemWindowInsetRight();
                        ((LayoutParams)v13).bottomMargin = v2_2.getSystemWindowInsetBottom();
                    }
                        ...
                        v12.dispatchApplyWindowInsets(v2_2);
                    }
                }
            ...
            label_89:
                ...
                v12.measure(DrawerLayout.getChildMeasureSpec(arg18, v0.mMinDrawerMargin + ((LayoutParams)v13).leftMargin + ((LayoutParams)v13).rightMargin, ((LayoutParams)v13).width), DrawerLayout.getChildMeasureSpec(arg19, ((LayoutParams)v13).topMargin + ((LayoutParams)v13).bottomMargin, ((LayoutParams)v13).height));
            }
    ...
    public void openDrawer(@NonNull View arg2) {
    ...
    public void openDrawer(@NonNull View arg4, boolean arg5) {
        if(this.isDrawerView(arg4)) {
            ViewGroup$LayoutParams v0 = arg4.getLayoutParams();
            float v2 = 1f;
            if(this.mFirstLayout) {
                ((LayoutParams)v0).onScreen = v2;
                ((LayoutParams)v0).openState = 1;
                this.updateChildrenImportantForAccessibility(arg4, true);
            }
            else if(arg5) {
                ...
                this.updateDrawerState(((LayoutParams)v0).gravity, 0, arg4);
    ...
    public void setDrawerLockMode(int arg3, @NonNull View arg4) {
        if(this.isDrawerView(arg4)) {
    ...
    public void setDrawerTitle(int arg2, @Nullable CharSequence arg3) {
        arg2 = GravityCompat.getAbsoluteGravity(arg2, ViewCompat.getLayoutDirection(((View)this)));
        if(arg2 == 3) {
    ...
    public void setStatusBarBackground(@Nullable Drawable arg1) {
