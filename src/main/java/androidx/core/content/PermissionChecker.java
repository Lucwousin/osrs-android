...
public final class PermissionChecker {
    ...
    public static int checkCallingPermission(@NonNull Context arg2, @NonNull String arg3, @Nullable String arg4) {
    ...
    public static int checkPermission(@NonNull Context arg1, @NonNull String arg2, int arg3, int arg4, @Nullable String arg5) {
        int v0 = -1;
    ...
    label_18:
        if(AppOpsManagerCompat.noteProxyOpNoThrow(arg1, arg2, arg5) != 0) {
            return -2;
        }
