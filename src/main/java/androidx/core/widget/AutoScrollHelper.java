...
public abstract class AutoScrollHelper implements View$OnTouchListener {
        ...
        private float getValueAt(long arg7) {
            ...
            if(this.mStopTime >= 0) {
                if(arg7 < this.mStopTime) {
                    ...
                    return v5 - this.mStopValue + this.mStopValue * AutoScrollHelper.constrain((((float)(arg7 - this.mStopTime))) / (((float)this.mEffectiveRampDown)), 0f, v5);
                }
            }

            return AutoScrollHelper.constrain((((float)(arg7 - this.mStartTime))) / (((float)this.mRampUpDuration)), 0f, v5) * 0.5f;
        }
    ...
    public AutoScrollHelper(@NonNull View arg4) {
        super();
    ...
    private float computeTargetVelocity(int arg4, float arg5, float arg6, float arg7) {
        ...
        int v0 = Float.compare(arg5, 0f);
        if(v0 == 0) {
            return 0;
        }

        arg6 = this.mRelativeVelocity[arg4];
        float v1 = this.mMinimumVelocity[arg4];
        float v4 = this.mMaximumVelocity[arg4];
        arg6 *= arg7;
        if(v0 > 0) {
            return AutoScrollHelper.constrain(arg5 * arg6, v1, v4);
        }
    ...
    @NonNull public AutoScrollHelper setActivationDelay(int arg1) {
        this.mActivationDelay = arg1;
        return this;
    }

    @NonNull public AutoScrollHelper setEdgeType(int arg1) {
        this.mEdgeType = arg1;
        return this;
    }
    ...
    @NonNull public AutoScrollHelper setMaximumEdges(float arg3, float arg4) {
        this.mMaximumEdges[0] = arg3;
        this.mMaximumEdges[1] = arg4;
        return this;
    }

    @NonNull public AutoScrollHelper setMaximumVelocity(float arg4, float arg5) {
        this.mMaximumVelocity[0] = arg4 / 1000f;
        this.mMaximumVelocity[1] = arg5 / 1000f;
        return this;
    }

    @NonNull public AutoScrollHelper setMinimumVelocity(float arg4, float arg5) {
        this.mMinimumVelocity[0] = arg4 / 1000f;
        this.mMinimumVelocity[1] = arg5 / 1000f;
        return this;
    }

    @NonNull public AutoScrollHelper setRampDownDuration(int arg2) {
        this.mScroller.setRampDownDuration(arg2);
        return this;
    }

    @NonNull public AutoScrollHelper setRampUpDuration(int arg2) {
        this.mScroller.setRampUpDuration(arg2);
        return this;
    }

    @NonNull public AutoScrollHelper setRelativeEdges(float arg3, float arg4) {
        this.mRelativeEdges[0] = arg3;
        this.mRelativeEdges[1] = arg4;
        return this;
    }

    @NonNull public AutoScrollHelper setRelativeVelocity(float arg4, float arg5) {
