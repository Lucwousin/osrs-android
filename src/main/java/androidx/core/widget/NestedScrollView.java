...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView {
    ...
    class SavedState extends View$BaseSavedState {
        final class androidx.core.widget.NestedScrollView$SavedState$1 implements Parcelable$Creator {
        ...
        static {
            SavedState.CREATOR = new androidx.core.widget.NestedScrollView$SavedState$1();
        }
    ...
    public NestedScrollView(@NonNull Context arg2) {
        this(arg2, null);
    }

    public NestedScrollView(@NonNull Context arg2, @Nullable AttributeSet arg3) {
        this(arg2, arg3, 0);
    }

    public NestedScrollView(@NonNull Context arg5, @Nullable AttributeSet arg6, int arg7) {
    ...
    public void computeScroll() {
        ...
        if(v10.mScroller.computeScrollOffset()) {
            ...
            if(this.dispatchNestedPreScroll(0, v6, v10.mScrollConsumed, null, 1)) {
            ...
            if(v14 != 0) {
                ...
                int v11 = v9;
                this.overScrollByCompat(0, v14, this.getScrollX(), v9, 0, v15, 0, 0, false);
                int v2 = this.getScrollY() - v11;
                if(!this.dispatchNestedScroll(0, v2, 0, v14 - v2, null, 1)) {
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect arg11) {
        int v1 = 0;
        if(this.getChildCount() == 0) {
            return 0;
        }
    ...
    public void draw(Canvas arg11) {
        ...
        if(this.mEdgeGlowTop != null) {
            ...
            if(!this.mEdgeGlowTop.isFinished()) {
                ...
                this.mEdgeGlowTop.setSize(v4, v5);
                if(this.mEdgeGlowTop.draw(arg11)) {
                    ViewCompat.postInvalidateOnAnimation(((View)this));
                }
            ...
            this.mEdgeGlowBottom.setSize(v4, v5);
            if(this.mEdgeGlowBottom.draw(arg11)) {
                ViewCompat.postInvalidateOnAnimation(((View)this));
            }
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent arg6) {
    ...
    public boolean fullScroll(int arg6) {
        ...
        if(v2 != 0) {
            ...
            if(v0 > 0) {
                ...
                this.mTempRect.bottom = v0_1.getBottom() + v0_1.getLayoutParams().bottomMargin + this.getPaddingBottom();
    ...
    protected void onLayout(boolean arg2, int arg3, int arg4, int arg5, int arg6) {
        ...
        if(!this.mIsLaidOut) {
            ...
            v2 = NestedScrollView.clamp(arg3, arg6, v2);
            if(v2 == arg3) {
                goto label_40;
            }
    ...
    protected void onMeasure(int arg5, int arg6) {
        ...
        if(this.getChildCount() > 0) {
            ...
            if(v1 < v2) {
                v6.measure(NestedScrollView.getChildMeasureSpec(arg5, this.getPaddingLeft() + this.getPaddingRight() + ((FrameLayout$LayoutParams)v0).leftMargin + ((FrameLayout$LayoutParams)v0).rightMargin, ((FrameLayout$LayoutParams)v0).width), View$MeasureSpec.makeMeasureSpec(v2, 0x40000000));
            }
        }
    }
    ...
    public void onNestedPreScroll(@NonNull View arg7, int arg8, int arg9, @NonNull int[] arg10, int arg11) {
        this.dispatchNestedPreScroll(arg8, arg9, arg10, null, arg11);
    }
    ...
    public void onNestedScroll(View arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        int v8 = this.getScrollY();
        this.scrollBy(0, arg12);
        int v2 = this.getScrollY() - v8;
        this.dispatchNestedScroll(0, v2, 0, arg12 - v2, null, arg13);
    }
    ...
    public void onNestedScrollAccepted(@NonNull View arg2, @NonNull View arg3, int arg4, int arg5) {
        this.mParentHelper.onNestedScrollAccepted(arg2, arg3, arg4, arg5);
        this.startNestedScroll(2, arg5);
    }
    ...
    public boolean onStartNestedScroll(@NonNull View arg1, @NonNull View arg2, int arg3, int arg4) {
    ...
    public void onStopNestedScroll(@NonNull View arg2, int arg3) {
        this.mParentHelper.onStopNestedScroll(arg2, arg3);
    ...
    public boolean onTouchEvent(MotionEvent arg24) {
        ...
        switch(v0) {
            ...
            case 2: {
                ...
                if(this.dispatchNestedPreScroll(0, v7, v10.mScrollConsumed, v10.mScrollOffset, 0)) {
            ...
            label_101:
                ...
                int v14 = v8;
                int v22 = v9;
                if((this.overScrollByCompat(0, v8, 0, this.getScrollY(), 0, v7, 0, 0, true)) && !v10.hasNestedScrollingParent(0)) {
                    v10.mVelocityTracker.clear();
                }

                int v2 = this.getScrollY() - v16;
                if(this.dispatchNestedScroll(0, v2, 0, v14 - v2, v10.mScrollOffset, 0)) {
    ...
    boolean overScrollByCompat(int arg13, int arg14, int arg15, int arg16, int arg17, int arg18, int arg19, int arg20, boolean arg21) {
        boolean v2_1;
        boolean v1_1;
        int v6;
        ...
        if((v2_1) && !this.hasNestedScrollingParent(1)) {
    ...
    public boolean pageScroll(int arg5) {
        ...
        if(v2 != 0) {
            ...
            if(v0 > 0) {
                ...
                if(this.mTempRect.top + v3 > v0) {
                    this.mTempRect.top = v0 - v3;
                }
            }
        }
        else {
    ...
    public void scrollTo(int arg7, int arg8) {
        if(this.getChildCount() > 0) {
            ...
            arg7 = NestedScrollView.clamp(arg7, v2, v3);
            arg8 = NestedScrollView.clamp(arg8, v4, v0_1);
    ...
    public void setOnScrollChangeListener(@Nullable OnScrollChangeListener arg1) {
    ...
    public final void smoothScrollBy(int arg5, int arg6) {
        if(this.getChildCount() == 0) {
            return;
        }
        ...
        if(AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 0xFA) {
            ...
            int v2 = this.getScrollY();
            arg6 = Math.max(0, Math.min(arg6 + v2, Math.max(0, v0_1 - v1_1))) - v2;
            this.mLastScrollerY = this.getScrollY();
            this.mScroller.startScroll(this.getScrollX(), v2, 0, arg6);
            ViewCompat.postInvalidateOnAnimation(((View)this));
        }
        else {
