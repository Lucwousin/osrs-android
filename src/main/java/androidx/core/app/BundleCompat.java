...
public final class BundleCompat {
    ...
    @Nullable public static IBinder getBinder(@NonNull Bundle arg2, @Nullable String arg3) {
    ...
    public static void putBinder(@NonNull Bundle arg2, @Nullable String arg3, @Nullable IBinder arg4) {
        if(Build$VERSION.SDK_INT >= 18) {
