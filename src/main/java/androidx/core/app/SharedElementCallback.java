...
public abstract class SharedElementCallback {
    ...
    private static Bitmap createDrawableBitmap(Drawable arg9) {
        ...
        if(v0 > 0) {
            if(v1 <= 0) {
                ...
                float v3 = 1f;
                float v2 = Math.min(v3, 1048576f / (((float)(v0 * v1))));
    ...
    public Parcelable onCaptureSharedElementSnapshot(View arg6, Matrix arg7, RectF arg8) {
        ...
        if(v0_1 > 0 && v1_2 > 0) {
            float v2_2 = Math.min(1f, 1048576f / (((float)(v0_1 * v1_2))));
            ...
            Bitmap v2_3 = Bitmap.createBitmap(v0_1, v1_2, Bitmap$Config.ARGB_8888);
