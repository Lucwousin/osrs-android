...
public final class NavUtils {
    ...
    @Nullable public static Intent getParentActivityIntent(@NonNull Activity arg4) {
        Intent v4;
    ...
    @Nullable public static Intent getParentActivityIntent(@NonNull Context arg2, @NonNull ComponentName arg3) throws PackageManager$NameNotFoundException {
    ...
    @Nullable public static Intent getParentActivityIntent(@NonNull Context arg1, @NonNull Class arg2) throws PackageManager$NameNotFoundException {
    ...
    @Nullable public static String getParentActivityName(@NonNull Activity arg1) {
        try {
    ...
    @Nullable public static String getParentActivityName(@NonNull Context arg2, @NonNull ComponentName arg3) throws PackageManager$NameNotFoundException {
    ...
    public static void navigateUpFromSameTask(@NonNull Activity arg3) {
    ...
    public static void navigateUpTo(@NonNull Activity arg2, @NonNull Intent arg3) {
        if(Build$VERSION.SDK_INT >= 16) {
    ...
    public static boolean shouldUpRecreateTask(@NonNull Activity arg2, @NonNull Intent arg3) {
        if(Build$VERSION.SDK_INT >= 16) {
