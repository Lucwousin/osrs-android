...
public final class ShareCompat {
    public class IntentBuilder {
        ...
        private IntentBuilder(Activity arg4) {
            ...
            this.mIntent.putExtra("androidx.core.app.EXTRA_CALLING_PACKAGE", arg4.getPackageName());
            this.mIntent.putExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY", arg4.getComponentName());
    ...
    public static ComponentName getCallingActivity(Activity arg1) {
        ...
        if(v0 == null) {
            v0_1 = arg1.getIntent().getParcelableExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY");
        }

        return ((ComponentName)v0_1);
    }

    public static String getCallingPackage(Activity arg1) {
        String v0 = arg1.getCallingPackage();
        if(v0 == null) {
            v0 = arg1.getIntent().getStringExtra("androidx.core.app.EXTRA_CALLING_PACKAGE");
        }
