...
public final class NotificationManagerCompat {
    ...
    class SideChannelManager implements ServiceConnection, Handler$Callback {
        class ListenerRecord {
            ...
            ListenerRecord(ComponentName arg3) {
                super();
                this.bound = false;
        ...
        SideChannelManager(Context arg2) {
            super();
    ...
    public void cancel(@Nullable String arg3, int arg4) {
    ...
    @NonNull public static NotificationManagerCompat from(@NonNull Context arg1) {
        return new NotificationManagerCompat(arg1);
    }

    @NonNull public static Set getEnabledListenerPackages(@NonNull Context arg6) {
    ...
    public void notify(int arg2, @NonNull Notification arg3) {
        this.notify(null, arg2, arg3);
    }

    public void notify(@Nullable String arg3, int arg4, @NonNull Notification arg5) {
