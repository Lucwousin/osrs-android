...
public abstract class JobIntentService extends Service {
    ...
    static WorkEnqueuer getWorkEnqueuer(Context arg2, ComponentName arg3, boolean arg4, int arg5) {
        JobWorkEnqueuer v0_1;
        CompatWorkEnqueuer v4_1;
        Object v0 = JobIntentService.sClassWorkEnqueuer.get(arg3);
        if(v0 == null) {
            if(Build$VERSION.SDK_INT < 26) {
                v4_1 = new CompatWorkEnqueuer(arg2, arg3);
            }
            else if(arg4) {
                JobWorkEnqueuer v4 = new JobWorkEnqueuer(arg2, arg3, arg5);
            }
            else {
                throw new IllegalArgumentException("Can\'t be here without a job id");
            }

            v0_1 = ((JobWorkEnqueuer)v4_1);
            JobIntentService.sClassWorkEnqueuer.put(arg3, v0_1);
        }

        return ((WorkEnqueuer)v0_1);
    }
