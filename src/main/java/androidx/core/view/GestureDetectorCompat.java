...
public final class GestureDetectorCompat {
    ...
    class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        GestureDetectorCompatImplBase(Context arg2, GestureDetector$OnGestureListener arg3, Handler arg4) {
            super();
        ...
        private boolean isConsideredDoubleTap(MotionEvent arg7, MotionEvent arg8, MotionEvent arg9) {
            ...
            if(arg9.getEventTime() - arg8.getEventTime() > (((long)GestureDetectorCompatImplBase.DOUBLE_TAP_TIMEOUT))) {
                return 0;
            }

            int v8 = (((int)arg7.getX())) - (((int)arg9.getX()));
            int v7 = (((int)arg7.getY())) - (((int)arg9.getY()));
            if(v8 * v8 + v7 * v7 < this.mDoubleTapSlopSquare) {
                v1 = true;
            }
    ...
    class GestureDetectorCompatImplJellybeanMr2 implements GestureDetectorCompatImpl {
        ...
        GestureDetectorCompatImplJellybeanMr2(Context arg2, GestureDetector$OnGestureListener arg3, Handler arg4) {
            super();
