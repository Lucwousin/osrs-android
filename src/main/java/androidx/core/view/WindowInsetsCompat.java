...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat(WindowInsetsCompat arg4) {
        ...
        if(Build$VERSION.SDK_INT >= 20) {
            if(arg4 == null) {
                ...
                v1_1 = new WindowInsets(arg4.mInsets);
            }
    ...
    public WindowInsetsCompat consumeDisplayCutout() {
        if(Build$VERSION.SDK_INT >= 28) {
            return new WindowInsetsCompat(this.mInsets.consumeDisplayCutout());
        }
    ...
    @Nullable public DisplayCutoutCompat getDisplayCutout() {
        if(Build$VERSION.SDK_INT >= 28) {
            return DisplayCutoutCompat.wrap(this.mInsets.getDisplayCutout());
        }
