...
class WrappedDrawableApi14 extends Drawable implements Drawable$Callback, TintAwareDrawable, WrappedDrawable {
    public abstract class DrawableWrapperState extends Drawable$ConstantState {
        ...
        @NonNull public abstract Drawable newDrawable(@Nullable Resources arg1);
    }
    ...
    class DrawableWrapperStateBase extends DrawableWrapperState {
        ...
        @NonNull public Drawable newDrawable(@Nullable Resources arg2) {
            return new WrappedDrawableApi14(((DrawableWrapperState)this), arg2);
        }
    }
    ...
    WrappedDrawableApi14(@Nullable Drawable arg2) {
        super();
        this.mState = this.mutateConstantState();
        this.setWrappedDrawable(arg2);
    }

    WrappedDrawableApi14(@NonNull DrawableWrapperState arg1, @Nullable Resources arg2) {
        super();
        this.mState = arg1;
    ...
    public boolean getPadding(@NonNull Rect arg2) {
    ...
    @RequiresApi(value=19) public boolean isAutoMirrored() {
    ...
    @RequiresApi(value=19) public void setAutoMirrored(boolean arg2) {
    ...
    public boolean setState(@NonNull int[] arg2) {
    ...
    private void updateLocalState(@Nullable Resources arg2) {
        if(this.mState != null && this.mState.mDrawableState != null) {
            this.setWrappedDrawable(this.mState.mDrawableState.newDrawable(arg2));
        }
    }
