...
public final class ColorUtils {
    ...
    public static void LABToXYZ(@FloatRange(from=0, to=100) double arg21, @FloatRange(from=-128, to=127) double arg23, @FloatRange(from=-128, to=127) double arg25, @NonNull double[] arg27) {
        ...
        double v0 = arg21 > 7.999625 ? Math.pow(v4, v12) : arg21 / v18;
        v4 = Math.pow(v10, v12);
        if(v4 > v16) {
        }
        else {
    ...
    public static void RGBToXYZ(@IntRange(from=0, to=0xFF) int arg19, @IntRange(from=0, to=0xFF) int arg20, @IntRange(from=0, to=0xFF) int arg21, @NonNull double[] arg22) {
        double[] v0 = arg22;
        if(v0.length == 3) {
            double v3 = 255;
            double v1 = (((double)arg19)) / v3;
            double v5 = 2.4;
            double v7 = 1.055;
            double v9 = 0.055;
            double v11 = 12.92;
            ...
            v0[0] = (0.4124 * v15 + 0.3576 * v17 + 0.1805 * v1) * 100;
            v0[1] = (0.2126 * v15 + 0.7152 * v17 + 0.0722 * v1) * 100;
            v0[2] = (v15 * 0.0193 + v17 * 0.1192 + v1 * 0.9505) * 100;
            return;
        }
    ...
    @ColorInt public static int XYZToColor(@FloatRange(from=0, to=95.047) double arg17, @FloatRange(from=0, to=100) double arg19, @FloatRange(from=0, to=108.883) double arg21) {
        double v6 = (3.2406 * arg17 + -1.5372 * arg19 + -0.4986 * arg21) / 100;
        double v10 = (-0.9689 * arg17 + 1.8758 * arg19 + 0.0415 * arg21) / 100;
        double v0 = (arg17 * 0.0557 + arg19 * -0.204 + 1.057 * arg21) / 100;
        double v2 = 12.92;
        double v4 = 0.055;
        double v8 = 0.416667;
        double v12 = 1.055;
        ...
        if(v0 > v14) {
            v0 = Math.pow(v0, v8) * v12 - v4;
        }
        else {
            v0 *= v2;
        }

        return Color.rgb(ColorUtils.constrain(((int)Math.round(v6 * 255)), 0, 0xFF), ColorUtils.constrain(((int)Math.round(v10 * 255)), 0, 0xFF), ColorUtils.constrain(((int)Math.round(v0 * 255)), 0, 0xFF));
    }
    ...
    public static double calculateContrast(@ColorInt int arg4, @ColorInt int arg5) {
        ...
        if(Color.alpha(arg5) == v1) {
            ...
            double v0 = ColorUtils.calculateLuminance(arg4) + 0.05;
    ...
    @NonNull @RequiresApi(value=26) public static Color compositeColors(@NonNull Color arg7, @NonNull Color arg8) {
        if(Objects.equals(arg7.getModel(), arg8.getModel())) {
            if(Objects.equals(arg8.getColorSpace(), arg7.getColorSpace())) {
            }
            else {
                arg7 = arg7.convert(arg8.getColorSpace());
            }

            float[] v0 = arg7.getComponents();
            float[] v1 = arg8.getComponents();
            float v7 = arg7.alpha();
            float v2 = arg8.alpha() * (1f - v7);
            int v3 = arg8.getComponentCount() - 1;
            v1[v3] = v7 + v2;
            if(v1[v3] > 0f) {
                v7 /= v1[v3];
                v2 /= v1[v3];
            ...
            int v4;
            for(v4 = 0; v4 < v3; ++v4) {
                v1[v4] = v0[v4] * v7 + v1[v4] * v2;
            }

            return Color.valueOf(v1, arg8.getColorSpace());
        }

        StringBuilder v1_1 = new StringBuilder();
        v1_1.append("Color models must match (");
        v1_1.append(arg7.getModel());
        v1_1.append(" vs. ");
        v1_1.append(arg8.getModel());
        v1_1.append(")");
    ...
    private static double pivotXyzComponent(double arg2) {
        return arg2 > 0.008856 ? Math.pow(arg2, 0.333333) : (arg2 * 903.3 + 16) / 116;
    }
