...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public final class TimeUtils {
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) public static void formatDuration(long arg2, long arg4, PrintWriter arg6) {
        if(arg2 == 0) {
            arg6.print("--");
            return;
        }

        TimeUtils.formatDuration(arg2 - arg4, arg6, 0);
    }
    ...
    private static int formatDurationLocked(long arg17, int arg19) {
        int v8_1;
        boolean v8;
        int v13;
        int v7;
        ...
        int v15 = 2;
        if(v2 != 0) {
            v7 = TimeUtils.accumField(v5, 1, false, 0);
            v8 = v7 > 0 ? true : false;
            v7 += TimeUtils.accumField(v1, 1, v8, v15);
            v8 = v7 > 0 ? true : false;
            v7 += TimeUtils.accumField(v0_1, 1, v8, v15);
            v8 = v7 > 0 ? true : false;
            v7 += TimeUtils.accumField(v13, 1, v8, v15);
            v8_1 = v7 > 0 ? 3 : 0;
            v7 += TimeUtils.accumField(v12, v15, true, v8_1) + 1;
            v8_1 = 0;
            while(v7 < v2) {
                v3[v8_1] = v6;
                ++v8_1;
        ...
        v2 = v2 != 0 ? 1 : 0;
        int v11 = v9;
        v7 = TimeUtils.printField(v3, v5, 'd', v9, false, 0);
        v6 = 'h';
        v8 = v7 != v11 ? true : false;
        v9 = v2 != 0 ? 2 : 0;
        v7 = TimeUtils.printField(v3, v1, v6, v7, v8, v9);
        v6 = 'm';
        v8 = v7 != v11 ? true : false;
        v9 = v2 != 0 ? 2 : 0;
        v7 = TimeUtils.printField(v3, v0_1, v6, v7, v8, v9);
        v6 = 's';
        v8 = v7 != v11 ? true : false;
        v9 = v2 != 0 ? 2 : 0;
        v7 = TimeUtils.printField(v3, v13, v6, v7, v8, v9);
        v6 = 'm';
        v9 = v2 == 0 || v7 == v11 ? 0 : 3;
        v0_1 = TimeUtils.printField(v3, v12, v6, v7, true, v9);
        v3[v0_1] = 's';
        return v0_1 + 1;
    }
