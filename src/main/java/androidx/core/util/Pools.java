...
public final class Pools {
    public interface Pool {
        @Nullable Object acquire();

        boolean release(@NonNull Object arg1);
    }
    ...
    public class SimplePool implements Pool {
        ...
        private boolean isInPool(@NonNull Object arg4) {
            int v1;
        ...
        public boolean release(@NonNull Object arg3) {
    ...
    public class SynchronizedPool extends SimplePool {
        ...
        public boolean release(@NonNull Object arg2) {
            Object v0 = this.mLock;
            __monitor_enter(v0);
            try {
                __monitor_exit(v0);
