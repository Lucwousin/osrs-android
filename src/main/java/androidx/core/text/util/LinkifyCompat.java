...
public final class LinkifyCompat {
    final class androidx.core.text.util.LinkifyCompat$1 implements Comparator {
        androidx.core.text.util.LinkifyCompat$1() {
            super();
        }

        public int compare(LinkSpec arg5, LinkSpec arg6) {
            int v2 = -1;
    ...
    static {
        ...
        LinkifyCompat.COMPARATOR = new androidx.core.text.util.LinkifyCompat$1();
    }
    ...
    public static void addLinks(@NonNull TextView arg7, @NonNull Pattern arg8, @Nullable String arg9) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
            Linkify.addLinks(arg7, arg8, arg9);
            return;
        }

        LinkifyCompat.addLinks(arg7, arg8, arg9, null, null, null);
    }

    @SuppressLint(value={"NewApi"}) public static void addLinks(@NonNull TextView arg7, @NonNull Pattern arg8, @Nullable String arg9, @Nullable String[] arg10, @Nullable Linkify$MatchFilter arg11, @Nullable Linkify$TransformFilter arg12) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static void addLinks(@NonNull TextView arg7, @NonNull Pattern arg8, @Nullable String arg9, @Nullable Linkify$MatchFilter arg10, @Nullable Linkify$TransformFilter arg11) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
            Linkify.addLinks(arg7, arg8, arg9, arg10, arg11);
            return;
        }

        LinkifyCompat.addLinks(arg7, arg8, arg9, null, arg10, arg11);
    }

    @SuppressLint(value={"NewApi"}) public static boolean addLinks(@NonNull Spannable arg5, @NonNull Pattern arg6, @Nullable String arg7, @Nullable String[] arg8, @Nullable Linkify$MatchFilter arg9, @Nullable Linkify$TransformFilter arg10) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static boolean addLinks(@NonNull Spannable arg10, int arg11) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static boolean addLinks(@NonNull Spannable arg6, @NonNull Pattern arg7, @Nullable String arg8) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static boolean addLinks(@NonNull Spannable arg6, @NonNull Pattern arg7, @Nullable String arg8, @Nullable Linkify$MatchFilter arg9, @Nullable Linkify$TransformFilter arg10) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    public static boolean addLinks(@NonNull TextView arg4, int arg5) {
        if(LinkifyCompat.shouldAddLinksFallbackToFramework()) {
    ...
    private static String findAddress(String arg2) {
        if(Build$VERSION.SDK_INT >= 28) {
            return WebView.findAddress(arg2);
        }

        return FindAddress.findAddress(arg2);
    }
    ...
    private static void gatherMapLinks(ArrayList arg5, Spannable arg6) {
        String v6 = arg6.toString();
        int v0 = 0;
        try {
            while(true) {
                String v1 = LinkifyCompat.findAddress(v6);
                if(v1 != null) {
    ...
    private static void pruneOverlaps(ArrayList arg9, Spannable arg10) {
        int v2 = 0;
