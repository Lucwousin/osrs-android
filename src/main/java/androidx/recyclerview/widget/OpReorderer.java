...
class OpReorderer {
    ...
    label_30:
        ...
        if(arg11.positionStart <= arg13.positionStart) {
            ...
            UpdateOp v6_1 = this.mCallback.obtainUpdateOp(v5, arg11.positionStart + 1, arg13.positionStart + arg13.itemCount - arg11.positionStart, v6);
        ...
        if(v0 != 0) {
            if((((UpdateOp)v6)) != null) {
                if(arg11.positionStart > ((UpdateOp)v6).positionStart) {
                    arg11.positionStart -= ((UpdateOp)v6).itemCount;
                }

                if(arg11.itemCount <= ((UpdateOp)v6).positionStart) {
                    goto label_102;
                }

                arg11.itemCount -= ((UpdateOp)v6).itemCount;
            }
