...
public class SortedList {
    public class BatchedCallback extends Callback {
        ...
        @Nullable public Object getChangePayload(Object arg2, Object arg3) {
    ...
    public abstract class Callback implements ListUpdateCallback, Comparator {
        public Callback() {
            super();
        }
        ...
        @Nullable public Object getChangePayload(Object arg1, Object arg2) {
            return null;
        }
    ...
    public SortedList(@NonNull Class arg2, @NonNull Callback arg3) {
        this(arg2, arg3, 10);
    }

    public SortedList(@NonNull Class arg1, @NonNull Callback arg2, int arg3) {
        super();
        this.mTClass = arg1;
    ...
    public void addAll(@NonNull Collection arg3) {
        this.addAll(arg3.toArray(Array.newInstance(this.mTClass, arg3.size())), true);
    }

    public void addAll(@NonNull Object[] arg2, boolean arg3) {
        this.throwIfInMutationOperation();
        if(arg2.length == 0) {
            return;
        }
        ...
        if(arg3) {
            ...
            this.addAllInternal(this.copyArray(arg2));
        }
    }

    public void addAll(@NonNull Object[] arg2) {
    ...
    public Object get(int arg4) throws IndexOutOfBoundsException {
    ...
    public void replaceAll(@NonNull Collection arg3) {
        this.replaceAll(arg3.toArray(Array.newInstance(this.mTClass, arg3.size())), true);
    }

    public void replaceAll(@NonNull Object[] arg1, boolean arg2) {
        this.throwIfInMutationOperation();
        if(arg2) {
            this.replaceAllInternal(arg1);
        }
        else {
            this.replaceAllInternal(this.copyArray(arg1));
        }
    }

    public void replaceAll(@NonNull Object[] arg2) {
    ...
    private void replaceAllInternal(@NonNull Object[] arg9) {
        int v0 = !(this.mCallback instanceof BatchedCallback) ? 1 : 0;
        if(v0 != 0) {
            this.beginBatchedUpdates();
        }
    ...
    private int sortAndDedup(@NonNull Object[] arg8) {
        int v1 = 0;
        if(arg8.length == 0) {
            return 0;
        }
