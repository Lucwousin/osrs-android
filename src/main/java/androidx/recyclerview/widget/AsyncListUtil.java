...
public class AsyncListUtil {
    class androidx.recyclerview.widget.AsyncListUtil$1 implements MainThreadCallback {
        androidx.recyclerview.widget.AsyncListUtil$1(AsyncListUtil arg1) {
    ...
    class androidx.recyclerview.widget.AsyncListUtil$2 implements BackgroundCallback {
        ...
        androidx.recyclerview.widget.AsyncListUtil$2(AsyncListUtil arg1) {
            AsyncListUtil.this = arg1;
            super();
    ...
    public abstract class DataCallback {
        ...
        @WorkerThread public abstract void fillData(@NonNull Object[] arg1, int arg2, int arg3);

        @WorkerThread public int getMaxCachedTiles() {
            return 10;
        }

        @WorkerThread public void recycleData(@NonNull Object[] arg1, int arg2) {
        }
    ...
    public abstract class ViewCallback {
        ...
        @UiThread public void extendRangeInto(@NonNull int[] arg7, @NonNull int[] arg8, int arg9) {
        ...
        @UiThread public abstract void getItemRangeInto(@NonNull int[] arg1);

        @UiThread public abstract void onDataRefresh();

        @UiThread public abstract void onItemLoaded(int arg1);
    }
    ...
    public AsyncListUtil(@NonNull Class arg3, int arg4, @NonNull DataCallback arg5, @NonNull ViewCallback arg6) {
        super();
        ...
        this.mMainThreadCallback = new androidx.recyclerview.widget.AsyncListUtil$1(this);
        this.mBackgroundCallback = new androidx.recyclerview.widget.AsyncListUtil$2(this);
        this.mTClass = arg3;
        this.mTileSize = arg4;
    ...
    @Nullable public Object getItem(int arg4) {
