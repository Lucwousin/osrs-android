...
public class DiffUtil {
    final class androidx.recyclerview.widget.DiffUtil$1 implements Comparator {
    ...
    public abstract class Callback {
        ...
        @Nullable public Object getChangePayload(int arg1, int arg2) {
            return null;
        }
    ...
    public class DiffResult {
        ...
        private static final int FLAG_MASK = 0x1F;
        ...
        public int convertNewPositionToOld(@IntRange(from=0) int arg4) {
            if(arg4 >= 0 && arg4 < this.mNewItemStatuses.length) {
                arg4 = this.mNewItemStatuses[arg4];
                if((arg4 & 0x1F) == 0) {
                    return -1;
                }
                else {
            ...
            v1.append("Index out of bounds - passed position = ");
            v1.append(arg4);
            v1.append(", new list size = ");
            v1.append(this.mNewItemStatuses.length);
            throw new IndexOutOfBoundsException(v1.toString());
        }

        public int convertOldPositionToNew(@IntRange(from=0) int arg4) {
            if(arg4 >= 0 && arg4 < this.mOldItemStatuses.length) {
                arg4 = this.mOldItemStatuses[arg4];
                if((arg4 & 0x1F) == 0) {
                    return -1;
                }
                else {
            ...
            v1.append("Index out of bounds - passed position = ");
            v1.append(arg4);
            v1.append(", old list size = ");
            v1.append(this.mOldItemStatuses.length);
            throw new IndexOutOfBoundsException(v1.toString());
        }
        ...
        private void dispatchAdditions(List arg7, ListUpdateCallback arg8, int arg9, int arg10, int arg11) {
            ...
            while(arg10 >= 0) {
                int v2 = arg11 + arg10;
                int v1 = this.mNewItemStatuses[v2] & 0x1F;
                if(v1 != 0) {
                    int v3 = 4;
                    if(v1 != v3 && v1 != 8) {
                        if(v1 == 16) {
        ...
        private void dispatchRemovals(List arg9, ListUpdateCallback arg10, int arg11, int arg12, int arg13) {
            ...
            while(arg12 >= 0) {
                int v2 = arg13 + arg12;
                int v1 = this.mOldItemStatuses[v2] & 0x1F;
                if(v1 != 0) {
                    int v3 = 4;
                    if(v1 != v3 && v1 != 8) {
                        if(v1 == 16) {
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback arg15) {
            ...
            for(v8 = this.mSnakes.size() - 1; v8 >= 0; --v8) {
                ...
                --v11;
                while(v11 >= 0) {
                    if((this.mOldItemStatuses[((Snake)v10).x + v11] & 0x1F) == 2) {
        ...
        public void dispatchUpdatesTo(@NonNull Adapter arg2) {
        ...
        @VisibleForTesting List getSnakes() {
            return this.mSnakes;
        }
    ...
    public abstract class ItemCallback {
        ...
        @Nullable public Object getChangePayload(@NonNull Object arg1, @NonNull Object arg2) {
            return null;
        }
    }
    ...
    static {
        DiffUtil.SNAKE_COMPARATOR = new androidx.recyclerview.widget.DiffUtil$1();
    }
    ...
    @NonNull public static DiffResult calculateDiff(@NonNull Callback arg1) {
        return DiffUtil.calculateDiff(arg1, true);
    }

    @NonNull public static DiffResult calculateDiff(@NonNull Callback arg15, boolean arg16) {
        Object v6_1;
        ...
        while(!((List)v2).isEmpty()) {
            ...
            if(v5 != null) {
                ...
                if(v5.reverse) {
                    ...
                    ((Range)v6_1).newListEnd = v5.y;
                }
                else if(v5.removal) {
                    ((Range)v6_1).oldListEnd = v5.x - 1;
                    ((Range)v6_1).newListEnd = v5.y;
                }
                else {
                    ((Range)v6_1).oldListEnd = v5.x;
                    ((Range)v6_1).newListEnd = v5.y - 1;
                }

                ((List)v2).add(v6_1);
                if(!v5.reverse) {
                    ((Range)v14).oldListStart = v5.x + v5.size;
                    ((Range)v14).newListStart = v5.y + v5.size;
                }
                else if(v5.removal) {
                    ((Range)v14).oldListStart = v5.x + v5.size + 1;
                    ((Range)v14).newListStart = v5.y + v5.size;
                }
                else {
                    ((Range)v14).oldListStart = v5.x + v5.size;
                    ((Range)v14).newListStart = v5.y + v5.size + 1;
                }
