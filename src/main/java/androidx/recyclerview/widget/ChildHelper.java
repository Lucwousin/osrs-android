...
class ChildHelper {
    class Bucket {
        ...
        void insert(int arg11, boolean arg12) {
            int v0 = 0x40;
            if(arg11 >= v0) {
                this.ensureNext();
                this.mNext.insert(arg11 - v0, arg12);
            }
            else {
                boolean v0_1 = (this.mData & -9223372036854775808L) != 0 ? true : false;
                long v6 = (1 << arg11) - 1;
                this.mData = this.mData & v6 | (~v6 & this.mData) << 1;
                if(arg12) {
                    this.set(arg11);
                }
                else {
                ...
                if(!v0_1 && this.mNext == null) {
                    return;
                }

                this.ensureNext();
                this.mNext.insert(0, v0_1);
            }
        }

        boolean remove(int arg12) {
            int v0 = 0x40;
            if(arg12 >= v0) {
                this.ensureNext();
                return this.mNext.remove(arg12 - v0);
            }

            long v0_1 = 1;
            long v2 = v0_1 << arg12;
            boolean v4 = (this.mData & v2) != 0 ? true : false;
            this.mData &= ~v2;
            v2 -= v0_1;
            this.mData = this.mData & v2 | Long.rotateRight(~v2 & this.mData, 1);
            if(this.mNext != null) {
                if(this.mNext.get(0)) {
                    this.set(0x3F);
                }
