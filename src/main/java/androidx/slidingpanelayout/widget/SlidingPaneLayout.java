...
public class SlidingPaneLayout extends ViewGroup {
    ...
    class SavedState extends AbsSavedState {
        final class androidx.slidingpanelayout.widget.SlidingPaneLayout$SavedState$1 implements Parcelable$ClassLoaderCreator {
        ...
        static {
            SavedState.CREATOR = new androidx.slidingpanelayout.widget.SlidingPaneLayout$SavedState$1();
        }
    ...
    public SlidingPaneLayout(@NonNull Context arg2) {
        this(arg2, null);
    }

    public SlidingPaneLayout(@NonNull Context arg2, @Nullable AttributeSet arg3) {
        this(arg2, arg3, 0);
    }

    public SlidingPaneLayout(@NonNull Context arg2, @Nullable AttributeSet arg3, int arg4) {
    ...
    protected boolean canScroll(View arg13, boolean arg14, int arg15, int arg16, int arg17) {
        ...
        if(arg14) {
            int v1_1 = this.isLayoutRtlSupport() ? arg15 : -arg15;
            if(!arg13.canScrollHorizontally(v1_1)) {
                goto label_44;
            }
        }
        else {
    ...
    void invalidateChildRegion(View arg6) {
        if(Build$VERSION.SDK_INT >= 17) {
            ViewCompat.setLayerPaint(arg6, arg6.getLayoutParams().dimPaint);
            return;
        }
        ...
        if(Build$VERSION.SDK_INT >= 16) {
            ...
            if(!this.mDisplayListReflectionLoaded) {
                try {
                    this.mGetDisplayList = View.class.getDeclaredMethod("getDisplayList", ((Class[])v1));
                }
            ...
            if(this.mGetDisplayList != null) {
                if(this.mRecreateDisplayList == null) {
                    ...
                    try {
                        this.mRecreateDisplayList.setBoolean(arg6, true);
                        this.mGetDisplayList.invoke(arg6, v1);
                    }
                    catch(Exception v0_2) {
                        Log.e("SlidingPaneLayout", "Error refreshing display list state", ((Throwable)v0_2));
                    }
    ...
    label_53:
        ViewCompat.postInvalidateOnAnimation(((View)this), arg6.getLeft(), arg6.getTop(), arg6.getRight(), arg6.getBottom());
    }
        ...
        for(v4 = 0; v4 < v7; ++v4) {
            ...
            if(v13.getVisibility() == 8) {
                ...
                if(((LayoutParams)v14).slideable) {
                    int v8_1 = v3 - v5;
                    v10 = Math.min(v11, v8_1 - v0.mOverhangSize) - v12 - (((LayoutParams)v14).leftMargin + ((LayoutParams)v14).rightMargin);
                    v0.mSlideRange = v10;
                    v2 = v1 ? ((LayoutParams)v14).rightMargin : ((LayoutParams)v14).leftMargin;
                    boolean v8_2 = v12 + v2 + v10 + v15 / 2 > v8_1 ? true : false;
                    ((LayoutParams)v14).dimWhenOffset = v8_2;
                    v8_1 = ((int)((((float)v10)) * v0.mSlideOffset));
                    v2 = v2 + v8_1 + v12;
    ...
    public void setPanelSlideListener(@Nullable PanelSlideListener arg1) {
        this.mPanelSlideListener = arg1;
    }

    public void setParallaxDistance(@Px int arg1) {
    ...
    public void setShadowDrawableLeft(@Nullable Drawable arg1) {
        this.mShadowDrawableLeft = arg1;
    }

    public void setShadowDrawableRight(@Nullable Drawable arg1) {
