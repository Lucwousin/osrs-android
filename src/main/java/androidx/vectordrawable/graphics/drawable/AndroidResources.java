...
class AndroidResources {
    ...
    @StyleableRes static final int STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET_ANIMATION = 1;
    @StyleableRes static final int STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET_NAME = 0;
    ...
    static {
        ...
        AndroidResources.STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = new int[]{0x1010003, 0x1010405};
