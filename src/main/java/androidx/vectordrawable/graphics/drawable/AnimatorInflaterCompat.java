...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class AnimatorInflaterCompat {
            ...
            if((v1 != 3 || arg21.getDepth() > v12) && v1 != 1) {
                if(v1 != 2) {
                    ...
                    if(v1_1.equals("objectAnimator")) {
                        v0 = AnimatorInflaterCompat.loadObjectAnimator(arg18, arg19, arg20, arg22, arg25, arg21);
                    }
                    else if(v1_1.equals("animator")) {
                        v0_1 = AnimatorInflaterCompat.loadAnimator(arg18, arg19, arg20, arg22, null, arg25, arg21);
                    }
                        ...
                        AnimatorInflaterCompat.createAnimatorFromXml(arg18, arg19, arg20, arg21, arg22, v15, TypedArrayUtils.getNamedInt(v6, v10, "ordering", 0, 0), arg25);
                        v6.recycle();
            ...
            if(arg6.length == 0) {
                ...
                for(v0 = 0; v0 < v7; ++v0) {
                    ...
                    if(((Keyframe)v1).getFraction() < 0f) {
                        ...
                        Float v4_1 = Float.valueOf(((Keyframe)v1).getFraction());
                    }
    ...
    label_32:
        ...
        if(arg12 == v9) {
            ...
            v8 = PropertyValuesHolder.ofObject(arg15, new PathDataEvaluator(), new Object[]{v14});
        }
        else {
            ArgbEvaluator v12_1 = arg12 == v7 ? ArgbEvaluator.getInstance() : ((ArgbEvaluator)v8);
            v7 = 5;
            if(v6 != 0) {
                if(v3 != 0) {
            ...
            if(v0 != v1 && v0 != 1) {
                ...
                if(v0 != v2) {
                    ...
                    if(arg20.getName().equals("propertyValuesHolder")) {
                        ...
                        int v16 = v5;
                        PropertyValuesHolder v0_1 = AnimatorInflaterCompat.loadPvh(arg17, arg18, arg19, arg20, v15, v5);
                        if(v0_1 == null) {
