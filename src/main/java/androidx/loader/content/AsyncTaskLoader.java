...
public abstract class AsyncTaskLoader extends Loader {
    ...
    public AsyncTaskLoader(@NonNull Context arg2) {
        this(arg2, ModernAsyncTask.THREAD_POOL_EXECUTOR);
    }

    private AsyncTaskLoader(@NonNull Context arg3, @NonNull Executor arg4) {
        super(arg3);
    ...
    @Deprecated public void dump(String arg5, FileDescriptor arg6, PrintWriter arg7, String[] arg8) {
    ...
    @Nullable public abstract Object loadInBackground();
    ...
    public void onCanceled(@Nullable Object arg1) {
    }
    ...
    @Nullable protected Object onLoadInBackground() {
        return this.loadInBackground();
    }

    public void setUpdateThrottle(long arg3) {
        this.mUpdateThrottle = arg3;
        if(arg3 != 0) {
