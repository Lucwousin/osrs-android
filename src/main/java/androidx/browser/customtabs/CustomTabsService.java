...
public abstract class CustomTabsService extends Service {
    class androidx.browser.customtabs.CustomTabsService$1 extends Stub {
        androidx.browser.customtabs.CustomTabsService$1(CustomTabsService arg1) {
        ...
        public boolean newSession(ICustomTabsCallback arg6) {
            Map v3;
            androidx.browser.customtabs.CustomTabsService$1$1 v2;
        ...
        public boolean validateRelationship(ICustomTabsCallback arg3, int arg4, Uri arg5, Bundle arg6) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(arg3), arg4, arg5, arg6);
        }
    ...
    @Retention(value=RetentionPolicy.SOURCE) @public interface Relation {
    }
    ...
    public CustomTabsService() {
        ...
        this.mBinder = new androidx.browser.customtabs.CustomTabsService$1(this);
    }
