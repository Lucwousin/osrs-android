...
public class CustomTabsClient {
    ...
    @RestrictTo(value={Scope.LIBRARY_GROUP}) CustomTabsClient(ICustomTabsService arg1, ComponentName arg2) {
        super();
        this.mService = arg1;
    ...
    public static boolean connectAndInitialize(Context arg2, String arg3) {
        ...
        androidx.browser.customtabs.CustomTabsClient$1 v1 = new CustomTabsServiceConnection(arg2) {
    ...
    public static String getPackageName(Context arg1, @Nullable List arg2) {
        return CustomTabsClient.getPackageName(arg1, arg2, false);
    }

    public static String getPackageName(Context arg4, @Nullable List arg5, boolean arg6) {
        Object v0_2;
        ArrayList v0;
        ...
        if(!arg6) {
            ...
            if(v6 != null) {
                ...
                ArrayList v1_1 = new ArrayList(((List)v0).size() + 1);
                ((List)v1_1).add(v6_1);
                if(arg5 != null) {
        ...
        Iterator v6_2 = ((List)v0).iterator();
        do {
            if(!v6_2.hasNext()) {
                return null;
            }
    ...
    public CustomTabsSession newSession(CustomTabsCallback arg4) {
        androidx.browser.customtabs.CustomTabsClient$2 v0 = new Stub(arg4) {
            private Handler mHandler;

            public void extraCallback(String arg3, Bundle arg4) throws RemoteException {
            ...
            public void onMessageChannelReady(Bundle arg3) throws RemoteException {
                if(this.val$callback == null) {
                    return;
                }
            ...
            public void onPostMessage(String arg3, Bundle arg4) throws RemoteException {
                if(this.val$callback == null) {
                    return;
                }
            ...
            public void onRelationshipValidationResult(int arg9, Uri arg10, boolean arg11, @Nullable Bundle arg12) throws RemoteException {
                if(this.val$callback == null) {
                    return;
                }

                this.mHandler.post(new Runnable(arg9, arg10, arg11, arg12) {
                    public void run() {
