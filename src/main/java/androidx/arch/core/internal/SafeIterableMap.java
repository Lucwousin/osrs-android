...
@RestrictTo(value={Scope.LIBRARY_GROUP}) public class SafeIterableMap implements Iterable {
    ...
    class IteratorWithAdditions implements SupportRemove, Iterator {
        ...
        IteratorWithAdditions(SafeIterableMap arg1) {
    ...
    public int hashCode() {
        Iterator v0 = this.iterator();
        int v1;
        for(v1 = 0; v0.hasNext(); v1 += v0.next().hashCode()) {
        }
    ...
    public IteratorWithAdditions iteratorWithAdditions() {
        IteratorWithAdditions v0 = new IteratorWithAdditions(this);
        this.mIterators.put(v0, Boolean.valueOf(false));
        return v0;
    }
