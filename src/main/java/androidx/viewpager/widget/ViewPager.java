...
public class ViewPager extends ViewGroup {
    final class androidx.viewpager.widget.ViewPager$1 implements Comparator {
    ...
    final class androidx.viewpager.widget.ViewPager$2 implements Interpolator {
    ...
    class androidx.viewpager.widget.ViewPager$3 implements Runnable {
        androidx.viewpager.widget.ViewPager$3(ViewPager arg1) {
            ViewPager.this = arg1;
            super();
        }
    ...
    public class SavedState extends AbsSavedState {
        final class androidx.viewpager.widget.ViewPager$SavedState$1 implements Parcelable$ClassLoaderCreator {
        ...
        static {
            SavedState.CREATOR = new androidx.viewpager.widget.ViewPager$SavedState$1();
        }
    ...
    static {
        ...
        ViewPager.COMPARATOR = new androidx.viewpager.widget.ViewPager$1();
        ViewPager.sInterpolator = new androidx.viewpager.widget.ViewPager$2();
        ViewPager.sPositionComparator = new ViewPositionComparator();
    }

    public ViewPager(@NonNull Context arg2) {
        super(arg2);
        ...
        this.mEndScrollRunnable = new androidx.viewpager.widget.ViewPager$3(this);
        this.mScrollState = 0;
        this.initViewPager();
    }

    public ViewPager(@NonNull Context arg1, @Nullable AttributeSet arg2) {
        super(arg1, arg2);
        this.mItems = new ArrayList();
        this.mTempItem = new ItemInfo();
        this.mTempRect = new Rect();
    ...
    public void addOnPageChangeListener(@NonNull OnPageChangeListener arg2) {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent arg4) {
        boolean v4;
        if(arg4.getAction() == 0) {
        ...
        if(v0.mPageMargin > 0 && v0.mMarginDrawable != null && v0.mItems.size() > 0 && v0.mAdapter != null) {
            ...
            while(v9 < v10) {
                ...
                if(v9 == ((ItemInfo)v5).position) {
                    v7 = (((ItemInfo)v5).offset + ((ItemInfo)v5).widthFactor) * v4;
                    v11 = ((ItemInfo)v5).offset + ((ItemInfo)v5).widthFactor + v3;
                }
                else {
    ...
    public boolean onInterceptTouchEvent(MotionEvent arg16) {
        float v0_1;
        ViewPager v6 = this;
        MotionEvent v7 = arg16;
        int v0 = arg16.getAction() & 0xFF;
        if(v0 != 3) {
            if(v0 == 1) {
            }
            else {
                ...
                if(v0 == 0) {
                    ...
                    if(v0 == -1) {
                        ...
                        float v1_1 = v10 - v6.mLastMotionX;
                        float v11 = Math.abs(v1_1);
                        float v12 = v7.getY(v0);
                        float v13 = Math.abs(v12 - v6.mInitialMotionY);
                        int v14 = Float.compare(v1_1, 0f);
                        if(v14 != 0 && !this.isGutterDrag(v6.mLastMotionX, v1_1) && (this.canScroll(this, false, ((int)v1_1), ((int)v10), ((int)v12)))) {
                            v6.mLastMotionX = v10;
                            v6.mLastMotionY = v12;
                        ...
                        if(v11 <= (((float)v6.mTouchSlop)) || v11 * 0.5f <= v13) {
                            if(v13 <= (((float)v6.mTouchSlop))) {
                                goto label_83;
                            }
                            ...
                            this.requestParentDisallowInterceptTouchEvent(true);
                            this.setScrollState(1);
                            v0_1 = v14 > 0 ? v6.mInitialMotionX + (((float)v6.mTouchSlop)) : v6.mInitialMotionX - (((float)v6.mTouchSlop));
                            v6.mLastMotionX = v0_1;
                            v6.mLastMotionY = v12;
                    ...
                    this.onSecondaryPointerUp(arg16);
                }
    ...
    void populate(int arg18) {
        ...
        label_51:
            if(v8 == null && v6 > 0) {
                ItemInfo v8_1 = v0.addNewItem(v0.mCurItem, v7);
            }
            ...
            if(v8 != null) {
                ...
                float v13 = 2f;
                float v3 = v12 <= 0 ? 0f : v13 - ((ItemInfo)v8).widthFactor + (((float)this.getPaddingLeft())) / (((float)v12));
                ...
                v0.calculatePageOffsets(((ItemInfo)v8), v15, v2);
                v0.mAdapter.setPrimaryItem(((ViewGroup)v0), v0.mCurItem, ((ItemInfo)v8).object);
            }
            ...
            for(v2_1 = 0; v2_1 < v1; ++v2_1) {
                ...
                if(!((LayoutParams)v4_1).isDecor && ((LayoutParams)v4_1).widthFactor == 0f) {
                    ...
                    if(v3_2 != null) {
                        ((LayoutParams)v4_1).widthFactor = v3_2.widthFactor;
                        ((LayoutParams)v4_1).position = v3_2.position;
                    }
                }
            }
            ...
            if(this.hasFocus()) {
                ...
                if(v3_2 != null && v3_2.position == v0.mCurItem) {
                    return;
                }
                ...
                for(v1 = 0; v1 < this.getChildCount(); ++v1) {
                    ...
                    if(v3_2 != null && v3_2.position == v0.mCurItem && (v2_2.requestFocus(2))) {
                        return;
                    }
                }
            }
    ...
    public void removeOnPageChangeListener(@NonNull OnPageChangeListener arg2) {
        if(this.mOnPageChangeListeners != null) {
    ...
    public void setAdapter(@Nullable PagerAdapter arg8) {
    ...
    public void setPageMarginDrawable(@Nullable Drawable arg1) {
    ...
    public void setPageTransformer(boolean arg2, @Nullable PageTransformer arg3) {
        this.setPageTransformer(arg2, arg3, 2);
    }

    public void setPageTransformer(boolean arg5, @Nullable PageTransformer arg6, int arg7) {
        int v1 = 1;
