...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    class androidx.swiperefreshlayout.widget.SwipeRefreshLayout$1 implements Animation$AnimationListener {
        androidx.swiperefreshlayout.widget.SwipeRefreshLayout$1(SwipeRefreshLayout arg1) {
    ...
    class androidx.swiperefreshlayout.widget.SwipeRefreshLayout$6 extends Animation {
        androidx.swiperefreshlayout.widget.SwipeRefreshLayout$6(SwipeRefreshLayout arg1) {
            SwipeRefreshLayout.this = arg1;
            super();
        }
    ...
    class androidx.swiperefreshlayout.widget.SwipeRefreshLayout$7 extends Animation {
        androidx.swiperefreshlayout.widget.SwipeRefreshLayout$7(SwipeRefreshLayout arg1) {
            SwipeRefreshLayout.this = arg1;
            super();
        }
    ...
    public SwipeRefreshLayout(@NonNull Context arg2) {
        this(arg2, null);
    }

    public SwipeRefreshLayout(@NonNull Context arg5, @Nullable AttributeSet arg6) {
        super(arg5, arg6);
    ...
    private void finishSpinner(float arg3) {
        if(arg3 > this.mTotalDragDistance) {
            ...
            if(!this.mScale) {
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout$5 v0_1 = new Animation$AnimationListener() {
                    public void onAnimationEnd(Animation arg2) {
    ...
    private void moveSpinner(float arg12) {
        ...
        if(this.mCustomSlingshotDistance > 0) {
            v4 = this.mCustomSlingshotDistance;
        }
        else if(this.mUsingCustomStart) {
            v4 = this.mSpinnerOffsetEnd - this.mOriginalOffsetTop;
        }
        else {
            v4 = this.mSpinnerOffsetEnd;
        }
    ...
    public void setOnRefreshListener(@Nullable OnRefreshListener arg1) {
        this.mListener = arg1;
    }
    ...
    public void setSlingshotDistance(@Px int arg1) {
        this.mCustomSlingshotDistance = arg1;
    }
    ...
    private Animation startAlphaAnimation(int arg2, int arg3) {
        androidx.swiperefreshlayout.widget.SwipeRefreshLayout$4 v0 = new Animation(arg2, arg3) {
