...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public CircularProgressDrawable(@NonNull Context arg2) {
        super();
    ...
    void applyTransformation(float arg8, Ring arg9, boolean arg10) {
        if(this.mFinishing) {
            ...
            if(arg8 < v3) {
                v0 = arg8 / v3;
                v3 = arg9.getStartingStartTrim();
                float v6 = v3;
                v3 = CircularProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(v0) * v2 + v1 + v3;
                v0 = v6;
            }
            else {
                float v4 = (arg8 - v3) / v3;
                v3 = arg9.getStartingStartTrim() + v2;
                v0 = v3 - ((v0 - CircularProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(v4)) * v2 + v1);
            }
    ...
    @NonNull public int[] getColorSchemeColors() {
    ...
    @NonNull public Paint$Cap getStrokeCap() {
    ...
    public void setColorSchemeColors(@NonNull int[] arg2) {
    ...
    public void setStrokeCap(@NonNull Paint$Cap arg2) {
    ...
    void updateRingColor(float arg3, Ring arg4) {
        float v0 = 0.75f;
        if(arg3 > v0) {
